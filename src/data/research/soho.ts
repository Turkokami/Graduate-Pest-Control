...
export const soho: MarketResearch = {
  ...
  structuralNotes: [
    ...
    'Sidewalks throughout the district are vaulted: the cellar extends out beneath the sidewalk, and daylight reached the workers below through vault lights, small circular glass prisms set into iron panels, an idea patented by Thaddeus Hyatt in 1854. Electric light made them redundant and many were filled with concrete or stone or covered over with diamond-plate steel; since the 1973 designation the Landmarks Preservation Commission reviews exterior repairs and requires preservation or restoration where possible.',
    'The E. V. Haughwout Building is five stories and 79 feet tall, and on 23 March 1857 it received the world\'s first successful passenger elevator, a hydraulic lift by Elisha Graves Otis driven from a steam engine in the basement. Vertical service cores in this district are that old in concept, and every one of them is a shaft through a masonry building.',
    'Streets in the historic district retain Belgian block paving, which is a joint pattern rather than a continuous surface at curb and doorway level.',
