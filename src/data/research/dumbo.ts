...
export const dumbo: MarketResearch = {
  ...
  structuralNotes: [
    ...
    'The neighbourhood stands on made land. Water Street marks the former waterline; for most of its history the area was salt marsh, and the city sold underwater water lots from 1686 to private owners who filled them to build wharves. The Empire Stores site was filled in three episodes between about 1796 and 1850. Buildings north of Water Street therefore sit on fill over former tidal ground, which behaves differently from glacial till under a load and drains differently around a foundation.',
    ...
    'The streetscape is unusual in a way that matters at ground level. Original granite Belgian block paving survives on many streets; some streets have no sidewalks at all, which the designation report suggests may be unique in New York City, and Belgian block sidewalk paving is not known to appear in any other New York neighbourhood. Belgian block is a jointed surface over bedding material, not a monolithic one. A $108 million rehabilitation of the cobblestone streets was completed in 2025.',
