...
export const dumbo: MarketResearch = {
  verified: true,
  housing:
    'NeighborhoodScout classifies 97.2 percent of Dumbo residential real estate as large apartment buildings — complexes or high-rise — with 91.8 percent of units at studio to two bedrooms, a vacancy rate of 10.9 percent and a density of 29,256 people per square mile. Point2Homes counts 2,375 housing units and 4,497 residents at a median construction year of 1956, with 40.2 percent of units in pre-1940 buildings and 57.5 percent of all units in buildings of fifty units or more, against 1.3 percent single-family detached; 35.9 percent owner-occupied, 64.1 percent rented, 8.8 percent vacant. The pre-1940 share and the fifty-plus-unit share describe the same buildings: nineteenth- and early twentieth-century factories and warehouses now holding dozens of households each.',
  structuralNotes: [
