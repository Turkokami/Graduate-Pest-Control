...
export const huntingtonStation: MarketResearch = {
  ...
  waterways: [
    'No harbour or tidal water inside the census area — the hamlet sits inland at about 217 feet',
    'Surface drainage runs to the harbour heads north and the outwash plain south',
  ],
  neighborhoods: [
