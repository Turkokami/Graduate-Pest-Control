 ...
 * 42.9 percent of the housing is a detached one-family house and 77.6 percent
 * of it is owner-occupied, at a median construction year of 1957 — and until
 * December 2023 the whole neighborhood drained into a combined sewer, which
...
export const whitestone: MarketResearch = {
  ...
  structuralNotes: [
    ...
    'The waterfront co-op complexes are the exception to everything above. Le Havre on the Water in Beechhurst was built in 1958 as 32 nine-story buildings across 28 acres, four apartments to a floor, all corner layouts, designed by George J. Miller and built by Alfred Levitt, and converted from rental to cooperative on 12 September 1984. Those buildings have designed service cores, shared risers and communal refuse handling, which is a different job from the detached house two streets away.',
    'The recorded history explains the lot pattern. Dutch farmers took the north shore from the Matinecock in 1645 and the settlement was named for a large white boulder that broke the tides along the shore. John Powell bought David Roe\'s 87-acre parcel in 1786; William Ziegler of the Royal Baking Powder Company consolidated holdings into the Ziegler Tract in 1883; Whitestone Landing at 154th Street was a summer resort into the early twentieth century; and the Whitestone Branch railroad station closed in 1932. Large private estates subdivided late, which is why so much of the neighborhood is 1950s houses on generous ground.',
    'Waste rules now catch almost the entire neighborhood in one band. Official NYC Bins have been required for residential properties of one to nine units since 1 June, with a warning period to 7 September and full enforcement from Tuesday 8 September 2026. With 82.6 percent of Whitestone housing in one- and two-unit buildings, this is not a rule for some other kind of street; it applies house by house along nearly every block. The Empire Bin program for buildings of 31 or more units has been deployed in Manhattan Community District 9 and Brooklyn Community District 2, with expansion named for Queens Community Board 2 among others — not District 7.',
  ...
  landmarks: [
    ...
    'Le Havre on the Water, 32 nine-story buildings on 28 acres, built 1958',
  ...
  neighborhoods: [
    'Whitestone Village and the old center',
    'Beechhurst',
    'Robinwood',
    'Malba',
