...
export const greenwichVillage: MarketResearch = {
  verified: true,
  housing:
    'NeighborhoodScout records 77.9 percent of Greenwich Village residential real estate as built in 1939 or earlier, 97.8 percent of it classified as apartment complexes or high-rise apartments and 95.6 percent of units studios or one- to two-bedroom, at 86,549 people per square mile with 87.4 percent renter occupancy and a 20.5 percent vacancy rate. Behind those apartment classifications is a very low-rise fabric: the Landmarks Preservation Commission district reports describe Federal and Greek Revival rowhouses of the 1810s to 1850s standing two and a half to three stories over basements, twenty-five to thirty feet tall on lots twenty to twenty-five feet wide, alongside pre-law tenements of the 1860s and 1870s at five stories and twenty-five feet wide, old-law dumbbell tenements after 1879, and new-law tenements after 1901 on footprints of thirty-five feet and more. The NYU Furman Center records Manhattan Community District 2 at 146,667 residents, 97,721 housing units, a 34.6 percent homeownership rate and 39.1 serious housing code violations per 1,000 privately owned rental units in 2022.',
  structuralNotes: [
  ...
  pestPressures: [
    ...
    },
    {
      pest: 'Bed bugs',
      driver:
        'An 87.4 percent renter share and near-total concentration of small units means high turnover in buildings whose walls, shafts and conduit runs are structurally continuous between apartments.',
      season: 'Year-round',
    },
    {
