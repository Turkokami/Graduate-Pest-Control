 ...
 * Greek Revival rowhouses of two and a half to three storeys standing beside
 * five- and six-storey pre-law, old-law and new-law tenements on twenty- to
...
export const greenwichVillage: MarketResearch = {
  verified: true,
  housing:
    'NeighborhoodScout records 77.9 per cent of Greenwich Village residential real estate as built in 1939 or earlier, 97.8 per cent of it classified as apartment complexes or high-rise apartments and 95.6 per cent of units studios or one- to two-bedroom, at 86,549 people per square mile with 87.4 per cent renter occupancy and a 20.5 per cent vacancy rate. Behind those apartment classifications is a very low-rise fabric: the Landmarks Preservation Commission district reports describe Federal and Greek Revival rowhouses of the 1810s to 1850s standing two and a half to three storeys over basements, twenty-five to thirty feet tall on lots twenty to twenty-five feet wide, alongside pre-law tenements of the 1860s and 1870s at five storeys and twenty-five feet wide, old-law dumbbell tenements after 1879, and new-law tenements after 1901 on footprints of thirty-five feet and more. The NYU Furman Center records Manhattan Community District 2 at 146,667 residents, 97,721 housing units, a 34.6 per cent homeownership rate and 39.1 serious housing code violations per 1,000 privately owned rental units in 2022.',
  structuralNotes: [
    ...
    'Pre-law tenements of the 1860s and 1870s stand five storeys on a twenty-five-foot lot, held ten to twenty families, and had minimal light and ventilation; some had a single water line with a tap in the hall on each floor, with water and toilets in the shallow backyard.',
    'The 1879 Tenement House Act required every habitable room to have a window opening to plain air. James E. Ware\'s dumbbell plan answered it by indenting the sides of the building about three feet to form an air shaft between adjoining structures. Standard lots were 25 feet by 100 feet, with four apartments per floor in railroad layout; a six-storey dumbbell could hold 300 people in 84 units, and by 1900 roughly 82,000 old-law tenement buildings stood citywide, over half of them in Manhattan.',
