...
export const parkSlope: MarketResearch = {
  verified: true,
  housing:
    'About 60 percent of Park Slope\'s residential stock was built in 1939 or earlier, and roughly 35.2 percent of it sits in small two-, three- or four-unit apartment buildings — which is the statistical fingerprint of a rowhouse neighborhood whose houses have been subdivided. The National Register listing counts 1,802 contributing buildings put up between 1862 and about 1920, and the city historic district and its extensions now cover some 2,575 buildings across roughly 40 blocks. Vacancy runs around 8.4 percent.',
  structuralNotes: [
