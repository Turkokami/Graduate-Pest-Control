...
export const williamsburg: MarketResearch = {
  ...
  pestPressures: [
    ...
    },
    {
      ...
      driver:
        'In older small buildings, stacked kitchens on a single wet line; in the new towers, the compactor chute and chute rooms that section 25-211 requires be kept free of vermin and treated on a program. Both are building-wide routes, not unit problems.',
