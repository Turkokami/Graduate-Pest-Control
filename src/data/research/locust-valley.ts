...
export const locustValley: MarketResearch = {
  ...
  structuralNotes: [
    ...
    'The CDP covers only 0.9 square miles, of which 0.04 square miles, 2.13 per cent, is water. But the name is used far more widely than the boundary: as the commercial centre, with the railroad station serving the surrounding Gold Coast communities, the geographically small Locust Valley became the name of reference for all the surrounding areas between Glen Cove and Oyster Bay. The Locust Valley Central School District covers the incorporated villages of Lattingtown, Matinecock and Bayville, portions of Mill Neck, Muttontown and Brookville, and unincorporated Locust Valley.',
    ...
    'The Matinecock Friends Meeting House was built by the Society of Friends in 1725 at the north-west corner of Piping Rock and Duck Pond Roads in the incorporated Village of Matinecock. It is a two-storey rectangular building, two bays wide and four bays long, sheathed in shingles under a steeply pitched gable roof, and it was listed on the National Register of Historic Places in 1976. Three NRHP properties carry the Locust Valley name: the Cock-Cornelius House, the Matinecock Friends Meetinghouse and the George Underhill House.',
    ...
    'The parcels are large and the canopy is old. Estate-scale lots mean detached garages, stables, gate lodges, potting sheds, pool houses and greenhouses, all of them buildings that harbour populations long before the residence does, and almost none of them on anybody’s inspection list.',
  ],
  pestPressures: [
    {
      pest: 'Carpenter ants',
      driver:
        'Forty-three per cent of the stock predates 1940 in shingled frame construction under closed mature canopy, where roofs and walls dry slowly. The Northeastern IPM Center notes carpenter ants prefer hollow, decaying wood because it is easier to excavate and the moisture helps larvae survive, favour an entryway through a damp wooden window or door sill, and forage as far as 300 feet from the nest — on an estate lot the parent colony is routinely in a stump or woodpile entirely off the building.',
      season: 'April through September',
    },
    {
      pest: 'Eastern subterranean termites',
      driver:
        'Century-old plantings, retaining walls, landscape timbers and terraces built up against rubble and early masonry foundations. Cornell Cooperative Extension asks for a minimum of 3 inches of clearance between wood siding or skirting and soil and 8 inches of clean concrete between skirting and soil, and advises removing wooden debris including buried stumps and directing downspouts farther from the house.',
