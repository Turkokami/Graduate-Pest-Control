 ...
 *
 * The stand-out fact: 94.4 percent of the residential real estate is
 * classified as apartment complexes or high-rise apartments and 76 percent of
...
export const upperWestSide: MarketResearch = {
  ...
  pestPressures: [
    ...
    },
    {
      pest: 'Bed bugs',
      driver:
        'Buildings holding hundreds of units, a 6.6 percent rental vacancy rate and continuous structural connections between apartments. Owners of multiple dwellings, cooperatives and condominiums included, must file a bedbug annual report with HPD each December covering units infested, treated and reinfested.',
      season: 'Year-round',
    },
    {
      pest: 'Norway rats',
