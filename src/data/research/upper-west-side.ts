...
export const upperWestSide: MarketResearch = {
  ...
  structuralNotes: [
    'The neighbourhood runs from Central Park on the east to the Hudson River on the west and from West 59th Street to West 110th Street, crossed north to south by Riverside Drive, West End Avenue, Broadway, Amsterdam Avenue, Columbus Avenue and Central Park West.',
    ...
    'The scale of a single pre-war apartment house here is worth stating concretely. The Ansonia, built 1899–1903 and opened 16 April 1904 on Broadway between West 73rd and West 74th Streets, is seventeen storeys and roughly 200 feet square, arranged around light courts on each side that give it an irregular H plan, with masonry walls between one and three feet thick. It originally held about 2,500 rooms in 340 apartments, later reconfigured to 425, and converted to condominium in 1992.',
