...
export const melville: MarketResearch = {
  ...
  pestPressures: [
    ...
    },
    {
      pest: 'Mosquitoes',
      driver:
        'No natural surface water in the hamlet at all, so the sources are the built ones: Suffolk County\'s long-term plan calls for enhanced catch basin larviciding and records stormwater management expansion from about 15,000 to roughly 50,000 sites. Office-park drainage basins, kerb inlets and the containers on a residential lot do the rest.',
