 ...
 * Town of Huntington).
 *
 * The stand-out fact: 27.4 percent of Melville's housing was built between
 * 2000 and 2009 and 22.8 percent of the stock is attached rather than
...
export const melville: MarketResearch = {
  verified: true,
  housing:
    'Melville holds roughly 7,489 housing units at a median construction year of 1983, and it is the only hamlet in this part of the town where the newest decade is also the biggest: about 2,054 units — 27.4 percent — were built between 2000 and 2009, with 556 more from 2010 to 2019. Behind that sits the original suburb, 1,153 units in the 1950s and 1,103 in the 1960s, plus 279 units, 3.7 percent, from 1939 or earlier. Only 59 percent of the stock is detached single-family housing. Some 1,710 units, 22.8 percent, are attached — townhouse and condominium construction — and 960 sit in buildings of five units or more. Around 6,395 units are owner-occupied and 860, 11.8 percent, rented.',
  structuralNotes: [
    ...
    'The 22.8 percent attached share is the single most useful number on this page. Attached housing means party walls, shared foundations, continuous soffit runs across several dwellings and common utility trenches. A mouse entering the end unit of a townhouse row is inside the row, not inside a house, and the work has to be scoped across the row rather than the address that called.',
    'The 27.4 percent built between 2000 and 2009 is newer construction than anything else nearby, and new construction is not pest-proof construction. It is tighter, which changes the failure mode: fewer, larger, more concentrated penetrations, weep holes in masonry veneer, garage door corners, dryer and range vents, and the gap at the sill of an attached garage.',
