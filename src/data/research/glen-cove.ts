 ...
 * owners and renters — 49.3 percent owner-occupied against 47.5 percent
 * renter-occupied, with 12.8 percent of all units in buildings of 50 or more.
...
export const glenCove: MarketResearch = {
  verified: true,
  housing:
    'Glen Cove records a median construction year of 1960 across roughly 11,462 housing units, but the tenure split is what separates it from everything around it: about 5,656 units are owner-occupied and 5,439 are renter-occupied, 49.3 percent against 47.5 percent, with 3.2 percent vacant. Only 48.8 percent of units are detached single-family houses. The remainder is genuine multifamily — 1,513 units in two-family buildings, 990 in three- and four-unit buildings, 820 in buildings of 20 to 49 units and 1,461 units, 12.8 percent of the city, in buildings of 50 or more. By era, 2,155 units — 18.8 percent — predate 1940, 2,842 went up in the 1950s, and 1,152 have been added since 2010.',
  structuralNotes: [
