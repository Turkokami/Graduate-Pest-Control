...
export const upperEastSide: MarketResearch = {
  ...
  structuralNotes: [
    ...
    'The Second Avenue Subway stations at 86th and 96th Streets were built between 2007 and 2017 beneath the eastern side of the neighborhood, which meant sustained deep excavation and utility relocation under streets lined with occupied buildings.',
  ],
  pestPressures: [
    {
      pest: 'Norway rats',
      driver:
        'Dense refuse handling on a compressed street grid, older cellar drainage, and the sidewalk vaults, areaways and cellar hatches that give harborage at and below street level. The city Health Department carries out over 150,000 rat inspections a year and notes that exposed garbage attracts rats and that property owners are legally required to keep them out of buildings.',
    ...
    },
    {
      ...
      driver:
        'Shared kitchen and bathroom stacks in apartment stock, and gaps measured in millimeters around pipe penetrations, escutcheons and behind cabinetry. Research on multi-unit housing finds that pests disperse from high-density units into units next to or otherwise structurally continuous with them, which is why complaint-driven treatment does not clear a building.',
