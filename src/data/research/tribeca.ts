...
export const tribeca: MarketResearch = {
  verified: true,
  housing:
    'NeighborhoodScout puts 67.3 per cent of Tribeca residential real estate at 1939 or earlier and classifies 90.7 per cent of it as apartment complexes or high-rise apartments, at a density of 48,953 people per square mile and a vacancy rate of 20.4 per cent. Almost none of that stock began life as housing. The area was the center of the dry goods and textile trades from the 1840s, and its warehouses and store-and-loft buildings were converted to living space by artists from the late 1960s onward, a model borrowed from SoHo and later formalised by the 1982 Loft Law. The four historic districts covering the neighborhood hold buildings mostly dating from about 1860 to 1910.',
  structuralNotes: [
