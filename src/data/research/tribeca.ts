...
export const tribeca: MarketResearch = {
  verified: true,
  housing:
    'NeighborhoodScout puts 67.3 percent of Tribeca residential real estate at 1939 or earlier and classifies 90.7 percent of it as apartment complexes or high-rise apartments, at a density of 48,953 people per square mile and a vacancy rate of 20.4 percent. Almost none of that stock began life as housing. The area was the center of the dry goods and textile trades from the 1840s, and its warehouses and store-and-loft buildings were converted to living space by artists from the late 1960s onward, a model borrowed from SoHo and later formalised by the 1982 Loft Law. The four historic districts covering the neighborhood hold buildings mostly dating from about 1860 to 1910.',
  structuralNotes: [
    'Four Landmarks Preservation Commission historic districts cover the neighborhood: Tribeca West, designated 7 May 1991 with approximately 220 buildings between Hubert and Reade Streets from Greenwich Street to West Broadway; Tribeca North, Tribeca East and Tribeca South, all designated 8 December 1992, the North district holding sixty-seven buildings and three undeveloped lots and the South district seventy buildings across just over four blocks.',
    'Store-and-loft buildings in the West district run typically five stories and twenty-five or fifty feet wide; warehouses are larger, with facades at least eighty feet long and heights of six to ten stories. Tribeca North warehouses are at least fifty feet wide and five to seven stories, mostly built between 1880 and 1910.',
    ...
    'The 1982 Loft Law, Article 7-C of the New York State Multiple Dwelling Law, created the NYC Loft Board to oversee conversion of interim multiple dwellings from commercial and manufacturing space to rent-stabilized residences. Qualifying units must be at least 400 square feet and cannot be in cellars — which is why the cellar and vault level of a converted loft building is almost always service space rather than living space.',
    'NYC rule section 25-211 requires refuse chutes and refuse rooms in buildings that have them to be maintained free of vermin, and puts the owner under a duty to establish a treatment program and keep records of it.',
  ],
  pestPressures: [
    {
      pest: 'Norway rats',
      driver:
        'Sidewalk vaults extending under the sidewalk, loading-bay thresholds, and cellar drainage laid under a nineteenth-century commercial street grid. The Health Department states plainly that property owners are legally required to keep rats out of homes and that any exposed garbage will attract them.',
