...
export const halesite: MarketResearch = {
  ...
  pestPressures: [
    ...
    },
    {
      ...
      driver:
        'Grade build-up against low, old foundations at the head of a harbor. Cornell Cooperative Extension asks for a minimum of 3 inches of clearance between wood siding or baseboard and soil and 8 inches of clean concrete between baseboard and soil, and notes that leaking pipes and dripping faucets sustain the soil moisture a colony needs. Mud tubes vary from the diameter of a wheat straw to wider than a thumb.',
  ...
  landmarks: [
    ...
    'The site of the nineteenth-century pottery works on the harbor\'s east shore',
  ],
  waterways: [
    'Huntington Harbor',
  ...
  neighborhoods: [
    ...
    'Mill Dam Road and the harbor head',
    ...
    'Nathan Hale Drive and the streets above the harbor',
  ],
  sources: [
