 ...
 * three-and-a-half-storey Federal house of 1830 shares a party line with a
 * twelve-storey steel-frame loft of 1899. And because the zoning that governed
...
export const noho: MarketResearch = {
  ...
  structuralNotes: [
    ...
    'The oldest layer is genuinely residential and genuinely intact. 26 Bond Street is a Federal house of about 1830, three and a half storeys with a peaked roof and a Gibbs surround at the door, built for James Roosevelt and sold to Alfred De Forest in 1831. 52 Bond Street is Greek Revival of about 1836-38. The Merchant\'s House Museum at 29 East Fourth Street, built 1831-32 with a Federal exterior and a Greek Revival interior, is the only nineteenth-century residence in Manhattan with both its exterior and its interior intact — a four-storey rowhouse with a raised basement, party walls shared with the houses beside it, the family room and kitchen in the basement, a rear wood-frame annex added in 1850, and a cistern in the yard with a 4,000-gallon capacity.',
    'Bond Street was originally a single uninterrupted block running one thousand feet from Broadway to the Bowery, lined with Federal-era marble rowhouses. By the 1840s and 1850s those residences were being subdivided into apartments and boarding rooms and converted commercially. The pattern of the whole neighbourhood is in that sentence: subdivision first, commerce second, manufacturing third, lofts fourth.',
    ...
    'The tallest and the shortest buildings in the district are attached to each other. The Bayard-Condict Building at 65 Bleecker Street, Louis Sullivan\'s only New York building, was built 1897-99 to twelve storeys and 162 feet on a steel skeleton, faced in white glazed terracotta at the front and red brick on the other three sides, and designed for offices or light manufactures. It stands in a street of buildings a quarter of its height.',
  ...
  landmarks: [
    ...
    'The former Bond Street Savings Bank of 1873-74, later the Bouwerie Lane Theatre',
