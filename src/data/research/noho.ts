...
export const noho: MarketResearch = {
  ...
  pestPressures: [
    ...
    },
    {
      pest: 'Bed bugs',
      driver:
        'Renter-majority occupancy with 86.8 percent of units at studio to two-bedroom size and a vacancy rate of 18.8 percent, in buildings where the partitions dividing former loft floorplates rarely reach the structure above. Multiple dwellings, cooperatives and condominiums included, file a bedbug annual report with HPD each December.',
      season: 'Year-round',
    },
    {
