...
The same logic runs down the facade. Sills and the tops of lintels were meant to be slightly pitched so water runs off rather than collecting. On a house repaired repeatedly over a century, sills get replaced apartment and lintels get parged, and each of those changes converts a component that shed water into one that holds it. Brownstone compounds it: because veneer was commonly set with the stone's grain running vertically rather than horizontally, water entering between the bedding layers freezes and forces the stone apart layer by layer, and a spalled front stops shedding water and starts holding it against whatever is behind.
...
**Coordination outperforms individual effort,** exactly as it does with the rear yards at ground level. Where several houses on a row have their cornices and parapets repaired in the same season, the difference is noticeable. Where one does it alone, the house is protected and the row is not.

The approach routes are worth naming because they are cheap to address. Mature street trees on these blocks put limbs within jumping distance of a thirty- or forty-foot roofline; any limb bearing on or overhanging a roof is a bridge, and cutting it back is usually the least expensive single intervention available on the property. The block interior of rear yards is a continuous corridor of mature planting, trellis, sheds and fencing that carries animals the length of a block at low level and up the rear elevations. Scaffolding and sidewalk sheds during facade work are temporary and extremely effective ladders — a house under scaffold is a house with a new route to its roof for the duration.
...
## What happens at ground level and in the rear yards?
...
**The recurring findings** are structural rather than exotic. A shed or a deck with an open void beneath it. A raised bed against a rear wall. A compost arrangement with no lid. Waste containers with lids that do not close. A rear extension with a flat roof reachable from a fence line. A yard regraded upward over the decades so that soil now sits against timber that was never meant to be in ground contact.

**What actually helps** is unglamorous and mostly collective. Close the void under a shed or a deck with a barrier taken below grade. Set planting and raised beds off the wall. Put lids on containers. And accept that a yard dealt with in isolation, on a block where the other twenty-nine are unchanged, produces a limited result — the same arithmetic that governs rats in the block interior, which is set out under [rodent control in Brooklyn Heights](/pest-control/brooklyn-heights/rodent-control/).
