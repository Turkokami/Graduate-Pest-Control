---
slug: park-slope-rodent-control
title: Rodent Control in Park Slope
metaTitleCore: Park Slope Rodent Control
quickAnswer: >-
  Roughly a third of Park Slope's homes sit in two-, three- or four-unit buildings with no super and
  no managing agent, so the two things that decide a rodent outcome — refuse handling and cellar
  sealing — have no obvious owner. The slope compounds it, moving water and animals downhill toward
  the Gowanus lowland.
metaDescription: >-
  Rodent control in Park Slope, where small owner-occupied multifamily houses have no staff to run
  refuse, sealing or access on a draining hillside.
faqs:
  ...
  - question: Why do the houses at the bottom of the slope have a different problem?
    answer: >-
      Because the ground falls continuously from Prospect Park West toward Fourth Avenue and the
      Gowanus lowland, which sits at sea level. Water and the drainage that carries it arrive at the
      lower blocks, and the combined system there has fourteen overflow points on a waterway that
      floods streets in heavy rain. Below-grade routes matter more down there.
  - question: Can we just seal the cellar and be done with it?
    answer: >-
      Not in that order, and not on its own. Closing a building that still holds an active population
      shuts the animals in rather than out, and they end up in wall voids where nothing can reach
      them. Reduction runs first. Sealing also does nothing about the block interior, which is where
      the rats supporting the pressure actually live.
  ...
  - question: Does landmark designation stop us doing the work?
    answer: >-
      Almost none of the productive work is on the protected streetscape. The cellar line, the
      areaway floor and drain, the rear elevation and the roof carry the traffic, and none of those
      is the front of the house. Where a scope does touch the visible exterior, review changes the
      timetable rather than the answer.
  - question: How do we get into a tenant's apartment to place monitors?
    answer: >-
  ...
  - question: What should we not do before someone surveys the cellar?
    answer: >-
      Do not clean it. Droppings, rub marks and gnawing are the only record of where animals actually
      travel, and a swept floor has destroyed it. Pulling stored goods a foot away from the walls so
      the perimeter can be seen is genuinely useful. Scrubbing the morning of the visit is not.
city: park-slope
...
The owner does, and in this housing band the owner is usually also a resident, which changes the psychology of the conversation more than people expect.
...
**Containment before timing.** Rigid, hard-sided containers with lids that actually close, sized for what the building generates, stored somewhere an animal cannot work at them uninterrupted overnight. Bags on a step are a feeding station whatever hour they went out.

**A named person per task.** Who brings the containers out. Who brings them back in. Who washes them when something splits. Who checks the lids still seat. In a house with three households, an unassigned task is an unperformed task.

**A conversation with the tenants that is about the building rather than about blame.** Most people cooperate immediately once they understand that the loose bag on the steps is what is producing the animal they saw on the stairs. Very few cooperate with a notice taped to a door.

**The areaway.** The front areaway of a Park Slope house is a sheltered, low, partly enclosed space with a drain in it, and it is where bins usually live. It is also directly against the cellar wall and its openings. Refuse stored badly in an areaway is refuse stored against the single most important surface on the building.
...
Through the plumbing that was cut in when the house was converted, and through the framing it was cut through.

This is the part that surprises owners most, because the top-floor tenant's report and the cellar's condition seem unrelated. They are not. A subdivided rowhouse has a kitchen and a bathroom on every floor, and in almost every case they are stacked so they can share a waste stack and supply risers. That vertical run passes through every floor structure in the building.

It was made by somebody working in an occupied nineteenth-century house, cutting through original joists and plates to get a pipe from the cellar to the roof, at a time when nothing required the penetrations to be closed and no material was to hand for closing them properly. So each floor now has an opening around the stack, usually concealed inside a boxed chase, a cabinet base, or the void behind a bath panel. Stacked one above another, those openings are a continuous shaft from the cellar to the roof with a door on every level.
...
The order in which these matter is not the order in which they get inspected. Most homeowners look at the front door and the windows. The productive work is in the cellar, in the chase, and inside the party wall.
...
What tells you about distribution is monitoring, run across the whole building at once. Devices in each flat, in the cellar, at the base of the stack and along the party walls, left long enough to accumulate a meaningful record, and read as a pattern rather than as individual results. Recording *where* something was found, not merely that it was found, is what converts a set of anecdotes into a map.
...
## In what order does this actually get done?
...
**Close, comprehensively rather than conveniently.** The cellar line and its service entries, the openings around the stack at every floor, the areaway, the rear elevation, the roof and bulkhead, and party-wall pockets wherever a ceiling or wall is genuinely open. Materials have to be things an animal cannot bite through: mesh, hardware cloth, sheet metal, mortar or hydraulic cement. Cured expanding foam fails twice — the animal chews through it, and it looks like completed work, so a live opening gets recorded as closed. Openings that cannot be reached are written up as inaccessible rather than left off the list. A perimeter that is ninety percent closed is not ninety percent effective.
...
A house can decide whether it is infested. Only the block can decide how much pressure it is deciding against.
