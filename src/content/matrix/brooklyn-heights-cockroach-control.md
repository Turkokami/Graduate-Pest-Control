---
slug: brooklyn-heights-cockroach-control
title: Cockroach Control in Brooklyn Heights
metaTitleCore: Brooklyn Heights Cockroach Control
quickAnswer: >-
...
faqs:
  - question: Why does a converted brownstone spread cockroaches so easily?
    answer: >-
      Because the plumbing was retrofitted rather than designed. When a house built before modern
  ...
  - question: My apartment is clean. Why do I have them?
    answer: >-
      ...
      toe kick. A meticulous kitchen two floors above a heavily infested one is on the same line and
      subject to the same traffic.
  - question: Are the cellar cockroaches the same as the kitchen ones?
    answer: >-
      Usually not, and the difference changes the work entirely. German cockroaches are small, live
  ...
  - question: Our house holds four apartments. What does the law expect of us?
    answer: >-
      ...
      The Housing Maintenance Code places the duty to keep it free of pests on the owner, and Local
      Law 55 requires periodic investigation of units and common areas plus remediation by integrated
      pest management. Confirm current detail with HPD.
  - question: How long does it take to clear a converted house?
    answer: >-
      Longer than a single visit and shorter than most residents fear, provided every unit gives
      access. Monitoring establishes where the population actually is, treatment follows the finding,
      and a return visit meets the nymphs that hatched afterwards. A whole house usually resolves
      over a defined series of visits rather than an open-ended schedule.
...
It is the improvised vertical run serving the stacked kitchens and bathrooms, and finding it is a matter of reading where the plumbing had to go rather than where a drawing says it went.

There are no drawings. That is the starting point. What there is instead is evidence in the fabric:

**Boxing and furring.** Where a pipe run could not be concealed inside an original wall, it was boxed in. A boxed corner in a bathroom, a furred-out section of wall behind a kitchen, or a bulkhead across a ceiling is a chase with a finish on it, and it is open at whichever joint the carpenter did not close.
...
**The party wall.** Where a conversion needed to get a line past a floor structure, the shortest route was sometimes through or alongside the shared masonry. Joist pockets — the recesses where floor framing bears into the party wall — were rarely closed on nineteenth-century construction, and once a plumber has cut into that wall the pockets connect to the chase.

The reason to establish all of this before treating anything is that the treatment targets differ completely. Applied material on a kitchen surface is aimed at where the insects walk. Applied material in the chase and behind the cabinetry is aimed at where they live. Only one of those changes the count in a fortnight's time.

## Why does treating one flat make the building worse?
...
What changes the outcome is a different unit of work:
...
**Waste staging with no hard-sided containers,** which is a food supply directly beneath everyone's flat.
...
## How is a whole house actually cleared, step by step?

In four stages, with access as the variable that decides all of it.
...
A duty on ownership, a periodic investigation cycle, and notification rules when material is applied.

A building arranged for occupancy by three or more independent households is generally a multiple dwelling, and that classification carries obligations a single-family house does not.

**The Housing Maintenance Code** places the duty to keep the dwelling free from insects, rodents and other pests on the owner, and requires extermination where infestation is present. That duty does not depend on who reported the problem or on how costs are allocated privately between an owner and a tenant. The detail is at [the NYC Housing Maintenance Code and pests](/compliance/nyc-housing-maintenance-code-pests/).

**Local Law 55 of 2018** adds the scheduled obligation. Owners must investigate dwelling units and common areas periodically and whenever a complaint arises, and must remediate using integrated pest management — physically removing pest nests and debris, sealing openings so gaps are reduced, and eliminating the water sources pests depend on. The statute states plainly that pesticide use does not substitute for those measures, and it treats cockroach infestation as an indoor allergen hazard rather than as a nuisance. In a converted rowhouse the sealing requirement is unusually well aimed, because closing the chase penetrations honestly means closing the very openings that carry the traffic. Read it at [NYC Local Law 55](/compliance/nyc-local-law-55/).

**Notification** applies where material is applied in a multiple dwelling: see [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/) and [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/), with the applicator side at [New York State pesticide applicator requirements](/compliance/nys-pesticide-applicator-requirements/).

For an owner-occupier who lets the other flats, the split of responsibility is set out at [landlord and tenant pest responsibilities](/compliance/landlord-tenant-pest-responsibilities/); for buildings under board governance, [co-op and condo board obligations](/compliance/coop-condo-board-obligations/). Small self-managed buildings often have neither an agent nor a written procedure, and that absence is itself the problem — see below.

## Who runs this in a building with no managing agent?

Somebody has to, and in a self-managed four-unit house it is usually nobody — which is the real reason these problems persist here.

A large apartment house on the other side of the river has a superintendent, a managing agent, a board, a written access procedure and a budget line. A converted brownstone in the Heights frequently has an owner who lives on one floor, tenants or shareholders on the others, no staff, and no procedure at all. When a cockroach problem appears, the practical questions — who inspects, who gives access, who pays, who instructs the contractor, who follows up — have no default answer.

Four things make the difference, and none of them are technical:
...
## What does the resident have to do, and what is not required?

Less than most preparation lists demand, and the items that matter are short.

**Report early and say what you have already used.** Retail sprays and foggers change where the population is, and disclosing that is diagnostic information rather than a confession.

**Give access, including for the follow-up.** The follow-up is the visit people cancel because the kitchen looked clear, and it is the one that meets the next generation.

**Clear the cabinetry that will be treated,** rather than emptying the flat. Preparation lists that demand a total clear-out produce households that decline the service instead.
