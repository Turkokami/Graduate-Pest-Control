---
slug: upper-west-side-rodent-control
title: Rodent Control on the Upper West Side
metaTitleCore: Upper West Side Rodent Control in Pre-War Buildings
quickAnswer: >-
  Mice in an Upper West Side apartment house travel the steam risers. Every riser passes through
  every floor slab it serves, and the chase around it carries a century of later plumbing, wiring and
  cabling. Rats belong to the light courts, areaways and refuse rooms. The two problems share a
  building and nothing else.
metaDescription: >-
  Upper West Side rodent control for pre-war apartment houses: steam riser chases, dumbwaiter
  shafts, light courts and refuse room thresholds.
faqs:
  - question: Why is our mouse problem confined to one line of apartments?
    answer: >-
      Because it is a stack rather than a coincidence. A riser serves one vertical line of apartments
      and passes through every floor slab between the cellar and the top floor. The chase around it is
      warm, dark, continuous and almost never opened, so a population in it reaches the top of the
      building without crossing a corridor or an apartment.
  - question: What is behind the cupboard on the landing?
    answer: >-
      In many buildings of this era, a disused dumbwaiter shaft. Dumbwaiters carried food, laundry,
      coal and firewood between service levels, and where they were taken out of use the shaft
      frequently remains as a continuous vertical cavity with the old door openings panelled or built
  ...
  - question: Where do rats live in a building with no garden?
    answer: >-
      In the light courts, areaways, service entries and refuse room thresholds. A pre-war house built
      around interior courts has enclosed outdoor space that is sheltered from wind, invisible from
      the street and rarely entered, often with drainage, service doors and stored equipment opening
      onto it. It performs the function a rear yard performs in a rowhouse.
  - question: Do the parks explain the rat pressure?
    answer: >-
      They contribute, and they are not the whole story. Large planted open space on both the eastern
      and western boundaries is a permanent source of food, water and cover next to dense residential
      blocks. What decides whether that pressure gets indoors is the building's own boundary — the
      service side, the areaway and the refuse room.
  - question: Can sealing be done without opening walls throughout the building?
    answer: >-
      Largely yes. The work is done from the accessible side — a riser closet, a chase opened during a
      renovation, a cellar ceiling, a refuse room. That is why an alteration agreement requiring
      penetrations to be sealed when a wall is open gets most of a building's risers closed over a
      decade at almost no cost to the corporation.
  - question: What material actually works?
    answer: >-
      Anything an animal cannot bite: mesh, hardware cloth, sheet metal, mortar, hydraulic cement.
      Cured expanding foam is none of those and fails twice, because it is gnawed through and it
      looks like completed work, so a live opening gets recorded as closed. We do not use it in any
      role on any job.
  - question: What should a board expect from a proposal here?
    answer: >-
      Specifics. Which lines are monitored and for how long, how riser closets and the refuse room are
      covered, what the reduction phase is before anything is sealed, which penetrations are in scope
      and which are excluded, the return schedule, and what record the building holds at the end. A
      price for monthly visits does not answer any of that.
...
## Why does a mouse problem here follow a vertical line?

Because the building distributes heat vertically, and the mice are using the same route the heat takes.

About three quarters of New York multifamily buildings run on steam, and the proportion is higher among older stock. On the avenues here that means a riser for every line of radiators, running from the cellar to the top floor, passing through every floor slab in between. Each of those passages is a hole in a structural floor, filled at construction with whatever was standard at the time and reopened by every repair, replacement and renovation on that line since.

Around the pipe sits a chase: a boxed-out void containing the riser and, very often, everything else that has been run vertically in the century since — waste and supply plumbing, electrical, telephone, cable, sometimes a redundant gas line.

That chase has four properties that together make it the best [house mouse](/pest-library/house-mouse/) route in the building.

**It is warm**, continuously, through a New York winter, because it contains the heating distribution.

**It is dry and dark.**

**It is continuous** from the cellar to the roof.
...
Dumbwaiter shafts and service stairs — features that were essential when the building opened and are now closed, forgotten or repurposed.
...
And then there is the accumulated work of a century. Every one of these buildings has been rewired, replumbed, air-conditioned, cabled and wired for internet, each round done by a different trade taking the shortest route it could cut through masonry. Nobody recorded those penetrations. Finding them is a large part of what a survey actually does, and it is why a survey that consists of walking the cellar and the corridors is not a survey.

## Where do rats live in a building with no garden?
...
**The refuse room threshold and door**, and whether the floor drain holds water rather than having dried out.

**The service entry and loading threshold**, which is held open for part of every day.

**Cellar penetrations** — abandoned sleeves, old coal chutes, service entries, the point where every incoming utility crosses the wall.

**The house drain and its cleanouts.** A deteriorated house trap, a cracked line under the cellar slab, a missing cleanout cover or a floor drain that has lost its seal makes the inside of the building continuous with the sewer. That route is invisible from outside and unaffected by anything placed in the areaway.

**The court itself** — drainage that discharges rather than ponds, no stored equipment providing cover, no waste held there.

## What do the brownstone side streets change?

They put a completely different failure mode on the same block, with a different owner and a different budget.

The rowhouses between the avenues are attached, so the floor joists of each house bear into the party walls it shares. Those bearing recesses were rarely closed on nineteenth-century construction, which leaves horizontal voids at every floor level linking adjoining buildings inside the wall. Where a house has been cut into apartments — common here — that horizontal connection sits alongside a retrofitted vertical wet stack, and the building has both problems at once.
...
Reduce, then close, then correct the water, then verify. In a building of several hundred households the order matters more, not less.

**Reduce first.** Sealing a building that already holds an established interior population takes away the animals' exit. They concentrate in wall voids and chases, and anything that dies inside a masonry wall between one and three feet thick is not going to be reached. In a building with hundreds of apartments that is a serious and lasting problem, not an inconvenience.

**Read the evidence rather than the sightings.** Rub marks along a wall base at a constant height, droppings graded by size and age, gnawing at a particular corner, and the polished appearance of a route in use. In a cellar or a refuse room that has been cleaned before the survey, that map has been erased. Moving stored goods a foot clear of the perimeter helps; cleaning the floor does not.

**Close from the accessible side.** Riser penetrations sealed at a riser closet, at a chase opened during somebody's renovation, or from a cellar ceiling. Dumbwaiter shafts closed properly. Cellar penetrations, service thresholds and refuse room door lines. Materials that cannot be bitten — mesh, hardware cloth, sheet metal, mortar, hydraulic cement — and no foam at any layer of the detail, in front of it or behind it.

**Correct the water.** A refuse room drain that holds its seal, a court drain that discharges, a repaired house drain.
...
**Rats** are the below-grade, boundary and drainage question — light courts, areaways, service entries, refuse rooms, the house drain, waste handling. Evidence is large droppings, burrow entrances two to four inches across with a fan of loose earth outside, worn runs in soft ground and gnawing at the base of doors. The work is exterior boundary, drainage and waste.

**Mice** are an internal, vertical question — riser chases, dumbwaiter shafts, service corridors, penetrations cut for a century of upgrades. Evidence is much smaller droppings concentrated along wall bases and inside cabinetry, gnawing at packaging rather than at structure, and grease marks on a route used repeatedly. The work is internal sealing at penetrations and shafts, and trapping inside the affected line.

A proposal that lists "rodent control" as one item, prices it monthly and describes stations has not distinguished between two problems that share only a word. Ask which one the building has, on what evidence, and what the scope is for each. If the answer is the same for both, the survey has not happened.

## What does the range of ownership on these blocks change?
...
Timing, mostly — and specifically whether the sealing happens while somebody else already has the wall open.

The single largest lever a board on these avenues has is its alteration agreement. Apartments in this stock are renovated constantly, and every renovation opens chases, ceilings, riser closets and floor penetrations that will not be accessible again for twenty years. A clause requiring penetrations through floors and party structures to be closed in durable, non-gnawable material, inspected before the ceiling goes back, converts every one of those jobs into a piece of exclusion work paid for by the shareholder doing the work.

Over a decade in a building of two hundred apartments that closes a very large proportion of the risers for the cost of writing the clause and enforcing it. Buildings that have done this notice the difference; buildings that have not are still paying somebody to attend monthly.

The seasonal points are secondary but real. Autumn is the window for boundary work, because populations move toward buildings as the weather cools and a boundary closed in September never acquires a winter population. Winter is when a building shows you its air paths — on a cold morning, the places where warm air escapes into a chase or a shaft are the places the traffic runs, and a riser closet survey in January produces a better opening inventory than the same survey in June. Spring belongs to the roof, the parapet, the court drainage and anything that has been holding water. Summer is for the refuse room, the service entry and the drainage repair that nobody wants done in February.

## Who is responsible in a co-op or condominium?

The corporation or the board, and the obligations are ongoing rather than reactive.
...
If your building has activity on one line and silence everywhere else, that line is a stack and the silence is worth investigating. [Get in touch](/contact/) and describe the pattern you are seeing rather than the tally.
