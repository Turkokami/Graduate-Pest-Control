---
slug: greenwich-village-rodent-control
title: Rodent Control in Greenwich Village
metaTitleCore: Greenwich Village Rodent Control for Rowhouses
quickAnswer: >-
  Rodent work in Greenwich Village runs through the rear yard and the party wall. Yards that once held
  privies and cisterns sit over buried voids and abandoned drainage, and attached buildings on
  twenty-five-foot lots share joist pockets at every floor. The problem belongs to the block interior
  and the wall, not to one address.
metaDescription: >-
  Greenwich Village rodent control for rowhouses and tenements: buried yard drainage, block
  interiors, party-wall joist pockets and closed air shafts.
faqs:
  - question: What is likely to be buried in a Village rear yard?
    answer: >-
      On the older rowhouse lots, the ground that once held a cistern and a privy. Those were masonry
  ...
  - question: The neighbours had work done and now we have mice. Connected?
    answer: >-
      ...
      construction, so the wall holds horizontal voids linking the two buildings at every floor.
      Pressure applied on one side moves the survivors through to the other.
  - question: What happened to the old air shafts, and does it matter?
    answer: >-
      In old-law tenements the sides of the building were indented to form a narrow shaft between
      adjoining structures. Many were later roofed, floored across or built against. That converts an
      open, foul, awkward void into a warm, hidden, undisturbed one shared between two buildings, with
      window and pipe openings into it at every floor.
  - question: Does the historic district stop us sealing the building?
    answer: >-
      It shapes where the work happens rather than whether it happens. This is the largest historic
      district in the city, so alterations to the visible streetfront can require review. Almost all
      rodent sealing is at the cellar, the areaway, the rear elevation, the roof and inside the party
      wall, none of which is the protected streetscape.
  - question: We own a house with three tenants. Are we a multiple dwelling?
    answer: >-
      Generally yes — a building arranged for three or more independent households ordinarily is, and
      that brings the Housing Maintenance Code duty on the owner along with the Local Law 55
      investigation and integrated pest management requirements. Many small Village owners have
  ...
  - question: Why does trapping have to come before sealing?
    answer: >-
      ...
      masonry wall is very hard to reach. Reduce first, close second, verify third. In occupied houses
...
## What is buried in a Village rear yard, and why does a rat care?

Old sanitary infrastructure, generally abandoned in place, with drainage running away from it that nobody has traced.

The Landmarks reports for this district note something about the Federal and Greek Revival rowhouses that most owners have never had cause to think about: their rear yards originally held cisterns and privies. That is not decoration. A cistern is a masonry tank in the ground. A privy is a masonry vault in the ground with a connection. Both were built to last, both were superseded when the building got indoor plumbing, and almost none of them was properly decommissioned. They were capped, paved, planted over or built against.

What that leaves under a Village garden is a void, or a partly collapsed void, with a pipe leaving it that goes somewhere. Somewhere is often a house drain that is still live, or a connection that was cut and left open, or a run that has broken under a century of settlement and tree roots.

For a rat this is close to ideal. It is below grade, it is dry enough, it is structurally stable, and it connects to a drainage network. It also sits under a surface that has been relandscaped three or four times since, which means nobody has ever looked at it and nobody is going to.

Two practical points follow.

**Find out what the yard was before you plan the exterior work.** A rowhouse rear yard with a suspiciously firm rectangle in the paving, a settled area that always ponds, or a drain that does not obviously go anywhere is worth investigating before anybody puts a bait station in a flower bed.

**Burrow evidence in a yard like this reads differently.** An active burrow is a hole roughly two to four inches across at the base of a wall, under a slab or in planted ground, with a fan of loose earth outside, clean edges and no webbing across the mouth. Where the ground beneath is a buried structure rather than soil, the entrance can be a long way from the void it serves, and closing the visible hole achieves very little.

For the general method see [rodent control](/pest-control/rodent-control/); for the wider building stock here, [pest control in Greenwich Village](/locations/greenwich-village/).

## Why is the block interior the wrong shape here?
...
For a rodent survey that dismantles the standard rowhouse assumptions.
...
**You cannot assume the block interior is a rectangle.** Here it can be interrupted by a building running through from one street to another, or open into a mews or a courtyard.

To a [Norway rat](/pest-library/norway-rat/) none of that irregularity is a problem. What matters is that the interior is continuous, soft, planted and quiet, and it is. What the irregularity does is defeat surveyors who arrive with a mental template of a Manhattan block and never see half of what is there.

## What does the closed air shaft do that an open one did not?

It gives a mouse a warm, hidden, undisturbed vertical route shared between two buildings.
...
**The drainage is old and shallow.** House drains under an irregular street plan, laid to serve buildings that have since been converted repeatedly. A deteriorated house trap, a cracked line under the cellar floor, a missing cleanout cover or a floor drain whose seal has dried out makes the inside of the building continuous with the sewer under the street. That route is invisible from outside and unaffected by anything done in the yard, and it is the answer to the question of how rats get into a house with no opening anybody can find.

**The cellar is also the storage room.** In a small building the cellar holds everything nobody wants upstairs, stacked against the perimeter walls — which is exactly where the evidence would be if anybody could see the walls. Moving stored goods a foot clear of the perimeter is genuinely useful before a survey. Sweeping the floor the morning of the visit is not: rub marks, droppings and gnawing are the map of where the animals travel, and cleaning erases it.

## What does the waste rule actually change on a Village stoop?
...
## In what order does this get done in an occupied house?

Reduce, then close, then correct the water, then verify — and in an attached building the order is not interchangeable.

**Reduce first.** Sealing a house that already holds an interior population removes the animals' way out, and they concentrate in wall voids and party-wall pockets. Anything that dies inside a masonry wall is very difficult to reach and impossible to ignore.

**Close in materials that cannot be bitten.** Mesh, hardware cloth, sheet metal, mortar, hydraulic cement. Cured expanding foam is not a barrier — it is chewed through, and it fails a second time by looking like completed work, so a live opening gets recorded as closed. Foam is not used at any stage of the detail, behind the barrier or across the face of it, which is a plainer rule than the one most of this trade works to and a good deal easier for a managing agent to check on a walk-through.

**Work the accessible list.** The cellar line and its penetrations, the areaway, the service entry, disused drain connections, the yard door threshold, the rear elevation, the roof and any shaft base or head that can be reached. Door sweeps closing gaps to no more than a quarter of an inch, which is both good practice and the standard [Local Law 55](/compliance/nyc-local-law-55/) sets.

**Take the party wall when it is open.** Joist pockets can only be closed when a ceiling or a wall face is open, which means the moment to do it is during somebody's renovation. Written into an alteration agreement or simply remembered at the right time, it is nearly free.

**Verify with monitoring rather than silence.** Absence of sightings is not evidence, particularly in a building where the population may simply have moved next door.

## What does a coordinated block achieve that one building cannot?

It removes the habitat rather than moving it, and in this fabric that is the difference between an expense and a result.
...
Getting there is a social problem rather than a technical one, and the Village has an advantage and a disadvantage in equal measure. The advantage is that these blocks have block associations, long-tenured residents and a strong culture of collective action about the physical fabric. The disadvantage is the ownership mix: an owner-occupied rowhouse, a small landlord with four flats, a converted co-op, a commercial building and an institution can all sit on the same block interior with entirely different budgets and entirely different levels of interest.

Three things make the conversation work when it works.

**Start with the yards rather than with the money.** Nobody argues about whether leaf litter and stored timber against a rear wall is cover.
...
More than most people who own one Village building expect, and the thresholds arrive earlier than they assume.

Once a building here is arranged for three or more independent households it is ordinarily a multiple dwelling, and at that point the Housing Maintenance Code duty to keep the premises free of rodents, insects and other pests sits with the owner — see [NYC Housing Maintenance Code — extermination and rodent eradication](/compliance/nyc-housing-maintenance-code-pests/). That catches a very large number of Village buildings whose owners think of themselves as homeowners with a tenant upstairs.

[Local Law 55](/compliance/nyc-local-law-55/) adds the scheduled duty: investigate at least periodically and more often where circumstances require, remediate by integrated pest management, repair and seal holes, gaps and cracks in durable materials, fit door sweeps. It states directly that pesticide use does not substitute for those measures, and that any pesticide must be applied by an applicator licensed by the state — [NYS pesticide applicator requirements](/compliance/nys-pesticide-applicator-requirements/). Applications in a multiple dwelling carry notification duties: [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/) and [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/).
