...
metaDescription: >-
  Tribeca rodent control for converted loft buildings: sidewalk vaults, freight hoistways, cellar
  drainage and the fire partitions that decide where a building ends.
faqs:
  ...
  - question: Why do we get mice on the top floor when the waste is in the cellar?
    answer: >-
      Because the building was built to move goods vertically. Freight hoistways and later elevator
      shafts run the full height of these structures, and where a shaft was decommissioned and boarded
      it usually survives as a continuous cavity. A mouse using it never crosses an apartment, a
      corridor or an outdoor space between the service level and the roof.
  - question: Does landmark designation stop us doing rodent exclusion?
    answer: >-
  ...
  - question: Is expanding foam around the pipe penetrations acceptable?
    answer: >-
      ...
      finished, so a live opening is recorded as closed and never revisited. Setting it behind or
      over a better material corrects neither fault, so we leave it out of the job entirely. Those
      penetrations get mesh, hardware cloth, sheet metal, mortar or hydraulic cement.
  - question: Our building is a loft co-op. Whose job is this?
    answer: >-
      Once a building is a multiple dwelling the duty to keep it free of pests sits with the owner,
      and in a cooperative that means the corporation rather than the shareholder. Since the cellar
      and vault level cannot be residential under the loft rules, the whole of the level that matters
      most is common property by definition.
  - question: When is the best time of year to start?
    answer: >-
      Late summer and early autumn, because that is when populations move toward buildings and before
      the heating season makes every opening attractive. Closing a vault-to-cellar boundary in
      September prevents an interior population rather than removing one, and the same work done in
      January has to be preceded by trapping.
city: tribeca
...
**Still in service.** An operating elevator in a maintained shaft is the least troublesome version, because somebody looks at the pit and the machine room on a schedule and the enclosure is intact.

**Decommissioned and floored over.** The car is gone, the openings at one or two levels have been closed, and the rest of the shaft is a sealed vertical cavity running from cellar to roof, warm in winter, unlit, unvisited and connected to whatever the closures did not reach.

**Repurposed as a service riser.** This is the worst of the three and it is common. The enclosure survives, and every trade that has needed a vertical route since — plumbing, electrical, telephone, cable, sprinkler, data — has used it, cutting through at each floor. That produces a shaft with a hole at every level, which is precisely a distribution system.

[House mice](/pest-library/house-mouse/) in a converted loft building are almost always a shaft problem or a floor-cavity problem, and the distinction from the rat problem below is not academic. Rats are a below-grade, boundary and drainage question. Mice are an internal, vertical question, and they are the reason a well-run building with immaculate waste storage still finds droppings in a top-floor kitchen and cannot work out how.

The floor structure adds a second internal route. Mid-nineteenth-century lofts here used cast-iron columns in rows perpendicular to the facade carrying yellow pine girders and beams; later buildings moved to rolled iron and then steel, with reinforced concrete floors appearing in some of the later stock. Heavy timber framing gives deep joist bays and thick floor assemblies. When a loft was subdivided, the new ceiling generally went in below the old structure rather than into it, which leaves a horizontal void spanning the whole floorplate above every finished ceiling. A shaft feeds it at one end; the partitions between apartments frequently stop at the new ceiling rather than at the structure above it.

That combination — a vertical cavity and a floor-wide horizontal one — is why unit-by-unit work in this stock has such a poor record. A treated apartment is a compartment in a structure that is continuous above it.

## How do you find out where your building actually ends?

By walking the cellar, because neither the street number nor the facade will tell you.
...
**Whether the vault crosses them.** Very often it does, which means the below-grade boundary and the above-grade boundary are in different places.

**Who owns each side.** A shared cellar between two co-ops is a legal question before it is a technical one, and the answer determines whether the work can be specified at all.

A proposal for exclusion work in Tribeca that does not describe the boundary it is closing has not looked at the building. That is a fair question to put to anyone bidding, and the reasoning is set out further at [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/).

## Why does the cellar level get left out of nearly every scope?

Because nobody lives there, and because the loft rules made sure nobody ever would.

Under Article 7-C of the Multiple Dwelling Law — the 1982 Loft Law that legalised these conversions — a qualifying unit must meet a minimum floor area and cannot be in a cellar. That single clause has a large, unintended consequence for pest work. It ensures that the level with the vault, the old drainage, the service entries, the boiler and the waste storage is the one level of the building with no resident, no complaint, no monthly inspection by an occupant who cares, and no share value attached to it.
...
**Close in the right material.** Barriers have to be things an animal cannot bite: mesh, hardware cloth, sheet metal, mortar, hydraulic cement. On a converted warehouse the specific items are the vault-to-cellar boundary, the base and head of every shaft, the abandoned sleeves and chutes, the drainage connections, the service door thresholds and the roof bulkhead. Door sweeps bringing gaps to no more than a quarter of an inch are both good practice and the standard that [Local Law 55](/compliance/nyc-local-law-55/) sets.

**Fix the water while the wall is open.** Where a vault or cellar is holding water, drainage repair is part of the rodent scope rather than a separate trade, because a wet cellar will re-attract whatever the sealing excluded.

**Verify with monitors, not with silence.** Absence of complaints is not evidence. Monitors returned to the same locations and read again show whether the population collapsed or simply moved along the blockfront.

This is the sequence that [structural exclusion](/pest-control/structural-exclusion/) describes in general terms; what changes in Tribeca is the inventory of openings, not the principle.

## What can be sealed on an iron-and-glass vault covering?
...
**Do the concealed work first, because it needs no review and carries most of the traffic.** The inside face of the vault, the wall between vault and cellar, the shaft base, the drainage and the service penetrations are all invisible from the public way. That is where the value is.
...
A defined piece of work with an end, rather than a monthly visit with no trend.

A proposal worth comparing states what boundary it is closing, how the vault was surveyed, what the monitoring layout is, how long the reduction phase runs before anything is sealed, which openings are in scope and which are excluded, and what document the building holds at the end. A proposal offering visits at a price is not describing the same thing at all and should not be set beside it.
