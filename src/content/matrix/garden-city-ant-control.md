---
slug: garden-city-ant-control
title: Ant Control in Garden City
metaTitleCore: Garden City Ant Control
quickAnswer: >-
  One village produces two separate ant problems. Carpenter ants work the concealed volume inside
  the mansard roofs, cupolas and deep cornices of the 1870s Italianate stock. Pavement ants work the
  expansion joints of a post-war village built flat, where every driveway, walk and patio is a slab
  laid on sand.
metaDescription: >-
  Ant control in Garden City: carpenter ants in 1870s mansards and cupolas, pavement ants in the
  slab joints of the post-war streets.
faqs:
  ...
  - question: What is inside a mansard roof?
    answer: >-
      A steep, largely unventilated cavity behind the slope. A mansard is effectively a wall clad
      like a roof, framed with timber and covered in slate or shingle. When the covering fails at a
      dormer cheek or the curb, water enters a void nobody inspects, and the framing in there stays
      wet for years before anyone knows.
  - question: How would we know there is a nest in the roof?
    answer: >-
      Frass, usually. Coarse excavated material with insect fragments through it, accumulating on a
      floor, a windowsill or a horizontal surface below a concealed gallery. On these houses it is
      often noticed in a third-floor room that nobody uses, which is why it can sit there for a
      season.
  - question: Why does a flat lot produce so many pavement ants?
    answer: >-
      Because everything is a slab laid on sand and everything has joints. Driveways, aprons, walks,
      patios and garage floors on flat, fast-draining outwash all sit on granular bedding, and the
      colonies nest in that bedding and push their excavated grit up through the joints. The small
      craters at the joint lines are the identification.
  - question: What does automatic irrigation change?
    answer: >-
      It keeps the soil under and beside slabs damp on a schedule regardless of rainfall, which
      makes a marginal nesting site a good one. It also puts water against foundations and into beds
      that then hold it. Watching each zone run, once, tells you more about a property's insect
      pressure than any amount of inspection on a dry day.
  - question: Small ants appear in the kitchen after storms. What is that?
    answer: >-
      Usually odorous house ants moving indoors when their outdoor site is saturated. On flat ground
      with no natural outlet, water sits where it falls until it soaks in, so a heavy storm floods
      shallow nest sites across a whole lot at once. It is a drainage signal more than an ant
      problem.
  - question: Should we spray the trail?
    answer: >-
      No, and with the small species it makes things last longer. Odorous house ants bud when
      stressed, so a disturbed colony splits into satellites in new parts of the building. Following
      the trail tells you where the nest is; erasing it removes the only information you had.
  - question: What has to be repaired before treatment is worth buying?
    answer: >-
      On the old stock, whatever is wetting concealed timber — mansard and dormer flashing, cupola
      base flashing, gutters behind deep cornices, porch roofs. On the post-war stock, the leader
      discharges, the irrigation heads, and any slab joint that has opened enough to take water.
city: garden-city
service: ant-control
sources: []
gatePassed: false
...
It is also a wildlife entry, which is worth flagging because the two problems arrive together: a cupola with a failed louvre or an open hatch is a route into a roof space for [eastern gray squirrels](/pest-library/eastern-gray-squirrel/) and birds, and nesting material in a roof void adds its own moisture and its own insect population. That side of the work is [wildlife management](/pest-control/wildlife-management/).
...
**A slab against a house is a slab against a house.** Where a patio or a walk meets the building, the joint runs right up to the wall. From there it is a short step to a weep, a gap at a threshold, a sleeved utility penetration, a garage door seal or a hose bib annulus. The post-war entry list is short and repeatable — the same one used by everything else, and it is covered under [structural exclusion in Garden City](/pest-control/garden-city/structural-exclusion/).
...
Both lists are building repairs rather than pest treatments, which is why this work is normally specified alongside [structural exclusion in Garden City](/pest-control/garden-city/structural-exclusion/), and why the moisture findings usually turn out to be the whole explanation. Wet timber is a shared resource: decay fungi reach it first, a carpenter ant colony follows into wood already softened, and the failed flashing that started the sequence feeds more than one problem at a time.
