---
slug: greenwich-village-bed-bug-treatment
title: Bed Bug Treatment in Greenwich Village
metaTitleCore: Greenwich Village Bed Bug Treatment in Small Buildings
quickAnswer: >-
  Most Village bed bug cases happen in small buildings with no staff. A rowhouse cut into four apartments
  ...
  than people expect.
metaDescription: >-
  Bed bug treatment for Greenwich Village tenements and converted rowhouses: party-wall pockets,
  railroad flats and inspection where there is no staff.
faqs:
  - question: Can bed bugs cross a party wall between two attached buildings?
    answer: >-
      They can, through the joist pockets. The floor framing of both buildings bears into the shared
      wall, and those bearing recesses were rarely closed on nineteenth-century construction. That
      leaves horizontal voids at every floor linking the two structures, which is a short and entirely
      sheltered distance for an insect already living in a wall.
  - question: Which neighboring units should be inspected besides the one that reported?
    answer: >-
      The apartment above, the apartment below and those sharing a wall, at minimum. In this stock the ring is
      often wider: a retrofitted riser, a closed air shaft used as a services chase and an unclosed
      party wall can all connect apartments that no floor plan shows as adjacent.
  ...
  - question: Our building has four apartments and no superintendent. Who organizes this?
    answer: >-
      The owner, and the process should exist on paper before it is needed. Who inspects the
      neighboring apartments, on what notice, at whose cost and with what confidentiality are all
  ...
  - question: Can heat be used in an attached Village building?
    answer: >-
      ...
      monitoring of the apartments around the treated one.
  ...
  - question: Does a small landlord have to file anything?
    answer: >-
      Owners of multiple dwellings file an annual bedbug report with HPD covering units infested,
      units where eradication was applied and units reinfested, and give occupants the filing receipt
      or post it. Most three-apartment Village buildings are multiple dwellings. Confirm current
      requirements with HPD.
  - question: How do we know when it is over?
    answer: >-
      By a verification interval in which monitoring finds nothing, across the treated apartment and its
      ring — not by the absence of bites. Reactions are delayed in many people and absent in some.
      Interceptors left in place and a documented follow-up inspection are what close a case honestly.
...
## Why is a four-apartment building the hardest version of this job?
...
Meanwhile the building itself is behaving exactly like a large one. The apartments share a retrofitted riser. The party walls contain open joist pockets at every floor level. A closed air shaft may run between two buildings with openings into it on each story. The floors are out of level, so there are gaps under baseboards. Everything that lets an insect move around a three-hundred-unit building is present here at a smaller scale, minus the staff.

That combination is why small Village buildings so often get a second case eight months after the first. Not because the treatment was wrong, but because the ring was drawn around the apartment that reported and nothing else was ever looked at.

For the general method see [bed bug treatment](/pest-control/bed-bug-treatment/), and for the insect the [bed bug](/pest-library/bed-bug/) profile. For the wider building stock here, [pest control in Greenwich Village](/locations/greenwich-village/).

## Where do they actually travel in this construction?

Along the wall lines, through the joist pockets, and up whatever vertical route the building has acquired.

Bed bugs are not strong dispersers. Where they are left alone beside a sleeping host, that is where they remain. What moves them is being carried, or being disturbed — at which point they move away from the disturbance along whatever surface is continuous. In a Village building the continuous surfaces are unusually generous, and three of them cross between households.

**The party wall.** In masonry construction on narrow lots, the floor joists of both attached buildings bear into the wall they share. Those bearing recesses were rarely closed on nineteenth-century work, so the wall contains a row of horizontal voids at every floor level running the length of both buildings, connecting through wherever the masonry has settled or been cut into for services. That is a sheltered route between two separately owned buildings that never sees daylight. It is not the main route in most cases, but it is the one that explains the cases nobody can explain.

**The retrofitted riser.** Conversion and modernisation cut new plumbing through floors and walls. Every penetration that was collared badly is an opening between the apartment above and the apartment below.
...
## How does a Village household pick them up in the first place?

Carried in, and the local mix of routes is distinctive.

**Turnover.** With most households renting and most units small, a building of five apartments may see two changes of occupant a year, each involving mattresses, luggage and furniture through one narrow stair.

**Second-hand and stored furniture.** Anything upholstered, anything with a frame, anything that has been in storage. In a neighborhood where apartments are small and furnished on a budget, this route runs hot.
...
**Institutional and shared living.** The Village holds a large transient population — students, sublets, short tenancies, people who move between shared apartments within the same few blocks. Movement between households in the same neighborhood is a real and underrated route, and it is why a case can appear in a building with no travel history and no second-hand furniture.
...
None of those routes is a statement about a household, and treating a report as an accusation is a reliable way to ensure the next person says nothing. The routes a building can actually manage are the ones involving furniture and contractors: wrapping anything upholstered that comes in or goes out, and a word about where bags are stored between jobs, both cost nothing.

## What does an inspection cover in a railroad flat?

More wall line than an inspector expects, because the plan pushes everything to the perimeter.

A railroad flat has rooms opening one into another with no corridor, so the flat functions as a single circulation route. Furniture is pressed against the walls to keep that route clear. Interior rooms have no window and depend on light from an adjoining room or a shaft, which makes them the warmest and least ventilated spaces in the building.

The sequence is still a narrowing followed by a widening.

**The bed first.** Frame joints, slats, the underside of the box spring, mattress seams and piping, the headboard front and back, and the wall directly behind it. Most first evidence is found here in every building type.

**The six-foot radius.** Bedside furniture, lamp bases, a chair, the rug edge, the outlet nearest the bed, the picture frame on that wall.
...
**The fabric.** Baseboard gaps where the floor is out of level, conduit clips, junction boxes, the door frame and threshold, and the boundary with the neighboring apartment or the shaft.

**Then interceptors go in and stay in.** Passive monitors under bed and furniture legs convert a one-off inspection into a continuous one, and in the neighboring apartments they are the cheapest information the building can buy.
...
## Which treatments fit an attached building with people over and under the work?

Whichever the structure supports, planned around the fact that every wall in the apartment is shared with somebody.
...
What does not fit is treating the reported apartment alone in a building where the boundaries are uncertain. That is the definition of a job that comes back, and in a four-apartment building it comes back into a household that will be entitled to be angry about it.

## What happens when the ring crosses into the building next door?

It becomes a conversation between two owners, and it is much better had early than late.

In a detached building the inspection ring stops at the exterior walls. In an attached row it does not necessarily, because the party wall is a shared structure with open joist pockets and, in this neighborhood, frequently a shared air shaft as well. Where an apartment that reported is against a party wall and the apartment on the other side of it is in a different building under different ownership, the honest ring includes a household nobody in your building has any authority over.
...
Because the people most likely to encounter one first are the people with the least incentive to say anything.

The Village's rental profile is short tenancies, small units, sublets and a large transient population moving between shared apartments within a few blocks. Somebody six months into a one-year tenancy who wakes up with marks has a set of reasons not to raise it that have nothing to do with the insect: fear of being blamed, fear of being charged, fear of a renewal not being offered, uncertainty about whether it is even a bed bug, and a reasonable suspicion that nothing will happen anyway.
...
An owner cannot legislate for candour, but four things measurably shorten the delay.

**Say in writing, at the start of a tenancy, that reporting will not be held against anyone.** It costs nothing and it is the single most useful sentence a small landlord can write.
...
The owner, and the awkwardness is the real obstacle rather than anything technical.

A great many Village buildings are owned by one person or one family, often with the owner living in the building. That produces a genuinely difficult dynamic: the person who has to require access to a tenant's bedroom is also the person who says good morning to them on the stoop. It is the reason procedures do not get written and access gets asked for apologetically and late.

Four things are within any owner's gift and all of them help.
...
**Pay for inspecting the neighbors.** Charging the apartment next door to be cleared produces refusals, and one refusal in a four-apartment building is a quarter of the structure.
...
A case closes with a verification interval that found nothing, documented across the treated apartment and its ring. If somebody is asking you to accept silence as proof, ask what was monitored and where it was put. [Get in touch](/contact/) and describe the building, the apartments around the one that reported, and what has already been tried.
