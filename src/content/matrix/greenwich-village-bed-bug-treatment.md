...
faqs:
  ...
  - question: Which flats should be inspected besides the one that reported?
    answer: >-
      The flat above, the flat below and those sharing a wall, at minimum. In this stock the ring is
      often wider: a retrofitted riser, a closed air shaft used as a services chase and an unclosed
      party wall can all connect flats that no floor plan shows as adjacent.
  ...
  - question: Does a small landlord have to file anything?
    answer: >-
      ...
      or post it. Most three-flat Village buildings are multiple dwellings. Confirm current
      requirements with HPD.
  - question: How do we know when it is over?
    answer: >-
      By a verification interval in which monitoring finds nothing, across the treated flat and its
...
## Why is a four-flat building the hardest version of this job?
...
Whichever the structure supports, planned around the fact that every wall in the flat is shared with somebody.
...
A case closes with a verification interval that found nothing, documented across the treated flat and its ring. If somebody is asking you to accept silence as proof, ask what was monitored and where it was put. [Get in touch](/contact/) and describe the building, the flats around the one that reported, and what has already been tried.
