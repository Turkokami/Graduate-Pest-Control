...
Because there are two entirely different kinds of building here, and the difference that matters is not architectural. It is about who is allowed to authorise a repair.

Great Neck is nine incorporated villages and several unincorporated pockets sharing a few square miles between two bays. About seventy per cent of its housing is detached, which is the world most people picture. But roughly seventeen per cent of units sit in buildings of fifty or more, concentrated in and around Great Neck Plaza — an unusually heavy multifamily layer for the North Shore, and one that changes this particular service more than it changes any other.
...
The governance consequence is the one to plan around. A resident report is evidence and should be treated as such. The inspection, the licensed removal visit, the closure and the return check all have to be authorised by the corporation, and they involve roofing and sometimes masonry alongside the wildlife scope. Sequencing those separately is how a roofer ends up closing an opening on a Tuesday with an animal behind it.
