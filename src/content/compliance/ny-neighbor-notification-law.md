---
slug: ny-neighbor-notification-law
title: New York Neighbor Notification Law
metaTitleCore: New York Neighbor Notification Law
quickAnswer: >-
  New York's neighbor notification law requires commercial applicators to give abutting property
  owners and occupants at least 48 hours' written notice before covered outdoor lawn pesticide
  applications, and to post visual markers at the site. It is a local-option statute: it applies
  only in the counties and cities that have adopted it, so coverage varies across the state.
metaDescription: >-
  New York's neighbor notification law requires 48 hours' written notice and site markers before
  covered lawn pesticide applications, where counties adopt it.
jurisdiction: New York State (county adoption varies)
faqs:
  - question: Does the neighbor notification law apply everywhere in New York?
    answer: >-
      No, and that is the most important thing to understand about it. The statute is local-option:
      it takes effect in a county or city only where the local legislative body has adopted it. A
      number of counties have, along with New York City, and the rest of the state has not. Check
      the current adoption list with NYSDEC before assuming either way.
  - question: Does it cover Nassau and Suffolk?
    answer: >-
      Both Long Island counties appear on the list of jurisdictions that have adopted the law, as
      does New York City covering all five boroughs. Adoption can change, so confirm the current
      status with NYSDEC or with the county rather than relying on a page that was reviewed on a
      particular date.
  ...
  - question: What kinds of application are exempt from the 48-hour notice?
    answer: >-
      The exemption list includes granular products, certain horticultural soaps and oils, spot
      applications, direct injection into plants or the ground, cemetery applications, emergency
      applications, and certain lower-risk product classes such as minimum-risk, reduced-risk and
      biopesticide categories. Each has a technical meaning, so read the current list rather than
      the shorthand.
  - question: Are fertiliser applications covered?
    answer: >-
      Fertiliser that contains no pesticide is not regulated as a pesticide and falls outside the
      notification scheme. A combined product that includes a herbicide or insecticide is a
      different matter, and the common weed-and-feed formulations are exactly the case where people
      guess wrong. Check the label and ask the applicator.
  - question: How do I check that a lawn or pest contractor is legitimate?
    answer: >-
      A business offering pesticide services for hire in New York must be registered with the NYSDEC
      Bureau of Pesticides Management, and applications must be made by appropriately certified
      individuals. Ask for the registration and certification details, and ask for the application
      records for your property, which commercial applicators are required to maintain.
sources:
...
The law took effect at the start of the 2000s and has been amended since. The most consequential recent change came in 2020, requiring that notifications and signs be printed in both English and Spanish, and in further languages where the Commissioner of Environmental Conservation determines it necessary. It sits within the state's wider pesticide regime under Article 33 of the Environmental Conservation Law and the regulations at 6 NYCRR Part 325, which is where the certification, registration and recordkeeping obligations on the trade also live.

This page describes published rules in general terms. It is not legal advice, it cannot address the facts of a particular property, and it should not be used in place of what NYSDEC and the state Department of Health publish.

## Why does the law apply in some places and not others?

Because it is a local-option statute. It does not take effect in a county or city automatically; the local legislative body has to adopt it.

This is the single most misunderstood feature of the law and the source of most of the confusion around it, including among contractors who work across county lines. A landscaper operating in an adopting county on Monday and a non-adopting county on Tuesday is under a different obligation each day, on identical work. A homeowner who moves fifteen miles and applies the same product to the same size of lawn may go from having a posting duty to having none.
...
It covers outdoor applications to ground, trees and shrubs. It carves out a defined list of application types and product categories, and the carve-outs are more technical than their shorthand names suggest.

The scope statement matters as much as the exemption list. State Department of Health guidance describes the [neighbor notification law](https://www.health.ny.gov/environmental/pests/public_notification_law.htm) as applying to outdoor applications to ground, trees or shrubs. That framing tells you two useful things. It tells you the law is not the rulebook for an interior treatment. And it tells you that scope is wider than the word *lawn* suggests in casual use — shrub and tree work is inside it, which is where perimeter mosquito and tick applications become a live question rather than an obvious exemption. If you are having a property treated for mosquitoes, ask specifically whether the planned method and product fall inside the notification requirement; do not assume that because it is not a lawn treatment it is outside. The wider approach to that work is described under [mosquito management](/pest-control/mosquito-management/).

The exemptions from the 48-hour requirement include granular pesticide products, certain horticultural soaps and oils, spot applications, direct injection into plants or into the ground, applications in cemeteries, emergency applications, and certain lower-risk classes including minimum-risk, reduced-risk and biopesticide products. Fertiliser containing no pesticide is not regulated as a pesticide at all and sits entirely outside the scheme.

Each of those terms has a regulatory meaning, and the gap between the meaning and the everyday sense of the word is where mistakes happen. *Spot application* does not mean a small job. *Granular* describes the formulation actually being applied on the day, which may not be what was on the estimate. *Emergency* does not stretch to a scheduling problem. And *reduced-risk* and *minimum-risk* are classification terms rather than marketing ones, so a product described as natural or organic may or may not sit inside a carve-out.

The current list is NYSDEC's and it can be amended. Read it there.

## What happens if the law is ignored?

Enforcement falls on the applicator and their business, through the certification and registration that let them operate — and for a homeowner, through the same regulatory route on a smaller scale.

Pesticide enforcement in New York is administrative rather than theatrical. It runs through inspections, findings and penalties, and in serious or repeated cases through action against a certification or a business registration. That last consequence is the one with teeth, because it is existential for a contractor rather than merely expensive. A business that cannot hold a registration cannot offer pesticide services for hire in the state.

There is a parallel recordkeeping regime that makes failures visible. Commercial applicators and commercial technicians are required to keep application records and to report annually to the state, and those records are the basis on which most enforcement questions are answered. A contractor who cannot produce a record of what was applied on your property, on what date, at what rate, is not merely disorganized — they are out of step with a requirement that exists independently of the notification law.
...
## How does this work in practice on Long Island and in the city?
...
Seven questions, and the answers tell you as much about the operation as any inspection would.

**"Is my county an adopting county, and are you sure?"** A contractor working across county lines should know exactly which of their service areas the law applies in. Hesitation here is informative.

**"Is this particular application covered, and if not, which exemption applies?"** Ask for the exemption by name. A contractor relying on the granular exemption can say so; a contractor waving it away cannot.

**"Who will you notify, and when?"** For a property with awkward adjacency, ask to see the list. It is a reasonable request and it takes them two minutes.
