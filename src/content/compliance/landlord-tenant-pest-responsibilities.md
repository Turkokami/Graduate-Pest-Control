---
slug: landlord-tenant-pest-responsibilities
title: Landlord and Tenant Pest Responsibilities in New York City
metaTitleCore: NYC Landlord and Tenant Pest Responsibilities
quickAnswer: >-
  In New York City the owner of a multiple dwelling must keep the premises free of rodents and
  insects and must exterminate where an infestation exists. Tenants keep their own space clean, must
  report conditions and must allow reasonable access for inspection and treatment. Unresolved
  reports can be raised with the city through 311, which routes housing complaints to HPD.
metaDescription: >-
  Who is responsible for pests in a NYC rental: the owner's duty to exterminate, what tenants should
  report and document, access, and the HPD complaint route.
jurisdiction: New York City
faqs:
  - question: Can a landlord tell a tenant to hire their own exterminator?
    answer: >-
      An owner can ask, and in some situations the parties may agree on who arranges what, but the
      duty the housing code places on ownership is not discharged by the request. If a condition is
      present and it goes unaddressed, the finding is recorded against the building. Cost allocation
      and legal duty are separate questions and are constantly conflated.
  - question: What if the tenant genuinely caused the problem?
    answer: >-
      Occupants carry real obligations to keep their space clean and free of conditions that invite
      pests, and a building may have contractual routes to recover costs. Neither of those removes
      the owner's obligation to see the condition corrected. Take the cost argument up separately and
      afterwards, rather than using it as a reason to delay.
  - question: Does a tenant have to let the exterminator in?
    answer: >-
      Access for inspection and repair is a normal obligation of a tenancy, subject to reasonable
      notice, and a refusal can genuinely stall work on a whole line of apartments. If the timing is
      impossible, propose an alternative in writing rather than simply declining, and keep a copy.
      Persistent refusal has consequences for both sides.
  - question: What should a tenant write down when reporting pests?
    answer: >-
      The date, what was seen, exactly where in the apartment, how many, at what time of day, and any
      water or damage nearby. Add photographs with the date visible. Then report in a form that
      leaves a trace — email or a portal message rather than a conversation with the superintendent
      in the lobby.
  - question: How long should a tenant wait before contacting the city?
    answer: >-
      There is no waiting period a tenant has to observe before calling 311, and the useful measure
      is responsiveness rather than a fixed interval. A report acknowledged and acted on quickly
      rarely becomes a city complaint. Silence is what drives tenants to escalate, more often than
      the pests themselves do.
  - question: Does a violation get recorded against the apartment or the building?
    answer: >-
      Against the building. That single fact reframes most landlord-tenant pest arguments, because
      the record a lender, a purchaser's attorney or a prospective tenant eventually reads is a
      building-level record regardless of which unit the inspector visited or who anyone believes
      caused the condition.
  - question: Are bed bugs treated differently from cockroaches or mice?
    answer: >-
      The building-condition duties still apply, and there are additional disclosure and reporting
      obligations in New York around bed bug infestation history that owners should confirm with HPD
      and with counsel. Practically, blame-driven handling is worse with bed bugs than with anything
      else, because it makes residents conceal reports.
  - question: What if the source turns out to be next door, not in the building?
    answer: >-
...
**An owner should also ask about credentials.** Any business applying pesticides for hire in New York must be registered with the state, and applications are made by certified individuals. What to ask for and how to check it is set out under [New York pesticide applicator requirements](/compliance/nys-pesticide-applicator-requirements/) and [how to verify a contractor](/compliance/choosing-a-pest-control-contractor/).
...
The standing duties sit in the [NYC Housing Maintenance Code](https://www.nyc.gov/assets/buildings/pdf/HousingMaintenanceCode.pdf), with the extermination and rodent-eradication provisions covered in more detail under [the code's pest article](/compliance/nyc-housing-maintenance-code-pests/). The inspection cycle, the definition of an allergen hazard and the required work practices come from [Local Law 55 of 2018](https://www.nyc.gov/assets/buildings/local_laws/ll55of2018.pdf), covered under [NYC Local Law 55](/compliance/nyc-local-law-55/). HPD publishes the current violation classes, correction periods, certification procedures and penalty schedules, and those are the authoritative source for every figure this page has deliberately declined to state. Where outdoor applications are made on the property, the notification rules described under [Local Law 36](/compliance/nyc-local-law-36-pesticide-notification/) and the [New York neighbor notification law](/compliance/ny-neighbor-notification-law/) apply separately.
