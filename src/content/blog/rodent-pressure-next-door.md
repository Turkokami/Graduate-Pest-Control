---
slug: rodent-pressure-next-door
title: Why your rodent problem started next door
metaTitleCore: Why Your Rodent Problem Started Next Door
quickAnswer: >-
  A house mouse works an area roughly ten to thirty feet across and a Norway rat perhaps a hundred
  and fifty. So a mouse problem is your own building, while a rat problem belongs to the block. When
  a nearby site is dug or cleared, the animals it held move to the nearest opening.
metaDescription: >-
  Rodent home ranges decide whether a problem is yours or the block's, and why excavation next door
  puts rats in your cellar within weeks.
cluster: rodent-pressure
datePublished: 2026-08-26
dateModified: 2026-08-26
faqs:
  - question: How far does a rat actually travel from its burrow?
    answer: >-
      Published figures put a Norway rat's daily activity inside an area roughly 100 to 150 feet in
      diameter, and University of Georgia extension material notes that a rat may spend its entire
      life within a range that size. University of California guidance allows for wider nightly
      foraging, anywhere from 100 to 500 feet from the nest depending on conditions. Either way, the
      relevant unit is the block, not the lot line.
  - question: And a mouse?
    answer: >-
      Far less. One mouse works an area averaging 10 to 30 feet in diameter during its daily
  ...
  - question: Does demolition next door really send rats into my building?
    answer: >-
      ...
      applicant for a permit covering full demolition, demolition of more than half a building's
      floor area, construction touching half or more of it, or an enlargement of more than a quarter,
      to certify that a licensed exterminator has been retained to treat the premises. Full
      demolition also carries a separate rodent control document before the permit issues.
  - question: How can I tell whether the rodents just arrived or have been here for months?
    answer: >-
      By arithmetic and by the marks. Cornell puts a rat at 40 to 50 droppings a day and a mouse at
  ...
  - question: Why does baiting alone stop working during a pressure event?
    answer: >-
      Because it acts on the animals present rather than on the route, so the interval between visits
  ...
  - question: What is a rat mitigation zone, and does it apply to me?
    answer: >-
      ...
      properties across parts of Manhattan, Brooklyn and the Bronx, and inspects properties in them
      on a repeating cycle rather than only on complaint. Inspectors record both active rat signs and
      conditions conducive to rats. Outside the zones the same conditions still produce the same
...
sources:
  ...
  - name: 'University of Georgia Extension C970 — Rats and Mice: Get Them Out of Your House and Yard'
    url: https://fieldreport.caes.uga.edu/publications/C970/rats-and-mice-get-them-out-of-your-house-and-yard/
  - name: UC Statewide IPM Program — Rats
    url: https://ipm.ucanr.edu/home-and-landscape/rats/
  - name: Cornell Integrated Pest Management — Managing Mice and Rats
  ...
  - name: 'NYC Department of Buildings Service Notice — Local Law 109 of 2022: Rodent Abatement During Construction'
    url: https://www.nyc.gov/assets/buildings/pdf/ll109of22-sn.pdf
  - name: NYC Department of Health — Pre-Demolition Rodent Extermination Certificate
    url: https://www.nyc.gov/assets/doh/downloads/pdf/pesticide/pre-demolition-rodent-extermination-certificate.pdf
  - name: NYC Environment & Health Data Portal — Rat Mitigation Zone Report
    url: https://a816-dohbesp.nyc.gov/IndicatorPublic/data-features/rat-report/
gatePassed: false
---

## Why does a rodent problem arrive in a building that has not changed?

Because the building was never the only variable, and on a rat job it is frequently not the variable that moved.
...
## How far does a rodent travel, and whose problem does that make it?

This is the single most clarifying pair of figures in the whole subject, and they differ by an order of magnitude.

A house mouse, on the published figures, travels an area averaging 10 to 30 feet in diameter during its daily activities. That is not a foraging expedition; it is a life. University of Georgia extension guidance turns the same fact into a practical rule for anyone setting traps, advising that you should not expect a mouse to travel more than five or ten feet to find one. Thirty feet is roughly a small house.

A Norway rat runs an area about 100 to 150 feet in diameter daily, and University of Georgia material notes that a rat may spend its entire life inside a range of that size. University of California guidance is broader on nightly foraging, putting Norway rats anywhere from 100 to 500 feet from the nest depending on local conditions. So a rat's world is a block face, a rear yard run of four or five properties, an alley, a service court.
...
Four, in descending order of how often they are the answer.

**Excavation and demolition.** This is the big one, and it is abrupt. A burrow system is a physical structure in soil, and a machine removes it in an afternoon. The animals that were living in it are not killed by the removal; they are dispersed by it, at full strength, in the hour the ground opens. Because the dispersal radius matches the home range, the properties that receive them are the ones inside roughly a hundred and fifty feet — which on a Brooklyn block is a dozen buildings and on a Long Island street is perhaps four.

**The removal of a food stream.** A restaurant closing is the classic case, and it produces a strange, delayed complaint pattern. For as long as the kitchen was operating, a substantial local population was supported at one address and had no reason to test the buildings around it. When the stream stops, the population does not stop; it forages outward, and the buildings that had quietly coexisted for years suddenly find themselves interesting. The same thing happens when a long-running refuse arrangement changes, or when a bird feeder that had been serving as an outdoor buffet comes down.

**Ground disturbance without demolition.** Sewer and water main work, gas line replacement, the clearance of dense ground cover, the removal of a deck or shed that had been sitting on grade, regrading a rear yard, taking out a hedge line. None of these look like a rodent event to the person paying for them. All of them evict.

**Seasonal compression on top of any of the above.** The autumn drop in temperature raises pressure on every structure at once. A dispersal event in July resolves itself relatively quietly because the exterior is still habitable; the same event in early October funnels the whole displaced population at buildings, because there is nowhere else to go. If a machine arrives on the lot behind you in September, that is the week to look at your own foundation line rather than the month after the noise stops.

There is a fifth trigger that belongs in a category of its own because it is invisible from the street: work below ground on the building's own drainage. A house trap that is broken or has been removed, a cellar drain line disconnected during a renovation, a sewer lateral repaired without the connection being made good — each of these opens a route from the municipal system directly into the structure, and the animals using it are not crossing your yard at all. On a city job with rats appearing in a cellar and no exterior evidence whatsoever, that is the first hypothesis rather than the last, and the survey goes to the drainage before it goes to the walls.

Speed, in our experience, is a matter of days rather than months. The evidence usually shows up inside two to three weeks of the trigger, which is roughly the time it takes for a displaced animal to find an opening, use it repeatedly, and leave enough behind to be noticed.
...
## How do you tell an arriving population from one you already had?
...
Conditions, not only animals — which is the same argument this firm makes, arriving from the other direction.
...
## Why does baiting through a pressure event measure the refill rate?
...
## What can you actually control when the source is not your property?
...
**Timing** is the fourth and the one people miss. If you know a lot is coming down, the correct week to close the building is before the machine arrives, not after the droppings do. That is the one occasion when exclusion work can genuinely get in front of a problem rather than respond to it, and it is why we ask on the phone whether anything is being built near you.

## What does the work look like when the pressure is external?

The same sequence as always, with two additions and one honest limitation.

The sequence itself does not change: read the evidence, bring the resident population down, confirm the structure is empty, close it, verify after weather. What an external source adds is, first, a defined survey of the exterior beyond the property line, done from where we can lawfully stand, to locate the burrow system that is actually generating the animals; and second, a bias toward doing the below-grade work properly rather than economising on it, because a displaced rat arriving at a closed wall does not give up, it digs. A barrier that stops at grade on a property under active external pressure is a barrier with a known bypass.

The limitation is worth saying plainly. Where the burrow system is on land we have no access to, we can close your building and we cannot remove their population. That is a genuine boundary, and a firm that implies otherwise is selling you something it cannot deliver. What closing your building does is take you off the route, which is the outcome you actually wanted; and in blocks where several owners reach the same conclusion at once, the shared result is considerably better than the sum of the individual ones. Boards and managing agents dealing with this across a portfolio will find the coordination argument set out at greater length in the [commercial section](/commercial/) and on the [property management](/commercial/property-management-pest-control/) page.

If you want the animal identified before anything else, the [Norway rat](/pest-library/norway-rat/) and [house mouse](/pest-library/house-mouse/) profiles cover it, and where a burrow system is suspected but cannot be seen, [canine rodent detection](/pest-control/canine-rodent-detection/) answers the question a visual survey cannot. Everything else written in this cluster is indexed on the [blog](/blog/).
