---
slug: overwintering-wasp-queens
title: Where wasp queens spend the winter, and why it decides next summer's nests
metaTitleCore: Overwintering Wasp Queens and Next Year's Nests
cluster: nesting-season
quickAnswer: >-
  Every wasp nest on a property next August begins as one fertilised queen sheltering somewhere this
  winter, and a great many of them shelter in the building itself — attics, wall voids, behind siding,
  under a lifted shingle course. That is why the number of nests a house gets is a property of the
  house rather than of the weather.
metaDescription: >-
  Next summer's wasp nests are set by where this winter's queens shelter. Why some houses produce
  nests every year and the one next door does not.
faqs:
  - question: Do wasp nests get used again the following year?
    answer: >-
      Almost never. The colony dies with sustained cold and only mated queens survive the winter,
      each of which starts a new nest somewhere else in spring. What gets reused is the site, because
      the cavity and the gap that made it attractive are unchanged and the queens that emerge nearby
      are looking for exactly that.
  - question: Why do I find large wasps inside the house in October?
    answer: >-
      They are usually new queens that entered the structure looking for somewhere to overwinter and
      came out on the wrong side of the wall. A queen resting in an attic or wall void will move
      toward light showing through a gap at a baseboard, a fixture or a vent, and that route leads
      into the room rather than out of the building.
  - question: And in February, on a mild day?
    answer: >-
      Same animal, different trigger. Overwintering queens become active on any warm day, and a
      cavity in a heated building warms far sooner than leaf litter outdoors. The wasp crawling on a
      windowsill in a February thaw has been in the wall since autumn.
  - question: Is it worth killing the queens I find indoors?
    answer: >-
      It does no harm, and it makes almost no difference. The ones that reach a living room are a
      small and unrepresentative fraction of the ones in the structure, and the survivors emerging
      outdoors in April are unaffected. The change that matters is closing the places they shelter.
  ...
  - question: Should I seal the hole a wasp went into?
    answer: >-
      Not while there is traffic at it. Sealing an active entrance pressures the colony toward the
      remaining exits, and those point into the house. Sealing in winter, once the season is over and
      nothing is moving, is a completely different proposition and is the whole point of doing this
      work then.
  - question: Does spraying the eaves in spring stop nests forming?
    answer: >-
      Not durably. A residue on a surface weathers, and a queen surveying a roofline in May is
      looking for a cavity rather than landing on treated trim. Removing the cavity changes the
      outcome for as long as the closure lasts, which is the difference between a fix and a season.
  - question: What if the insects turn out to be honey bees?
    answer: >-
      Then it is not a pest control matter and we will say so. Honey bees in a structure are a
      beekeeping and removal question, with the added complication that abandoned comb and honey left
      in a cavity ferments, stains through and draws a long list of secondary pests.
sources:
  - name: Ohio State University Extension (Ohioline) — Yellowjackets, HYG-2075
    url: https://ohioline.osu.edu/factsheet/HYG-2075-11
  - name: Penn State Extension — Eastern Yellowjacket
    url: https://extension.psu.edu/eastern-yellowjacket
  - name: NC State Extension — Controlling Paper Wasps In and Around Structures
    url: https://content.ces.ncsu.edu/publication/controlling-paper-wasps-in-and-around-structures
  - name: "University of Maryland Extension — Social Wasps: Yellowjackets, Hornets and Paper Wasps"
    url: https://extension.umd.edu/resource/social-wasps-yellowjackets-hornets-and-paper-wasps
...
One thing worth repeating, because it changes the answer completely: if what you have is honey bees rather than wasps, none of the above applies and the correct call is a beekeeper. Identification detail sits in the pest library on the [eastern yellowjacket](/pest-library/eastern-yellowjacket/), [bald-faced hornet](/pest-library/bald-faced-hornet/) and [paper wasp](/pest-library/paper-wasp/) profiles.

The rest of the writing on the stinging-insect year is indexed on the [blog](/blog/), the sealing trade underneath all of it is [structural exclusion](/pest-control/structural-exclusion/), and the same roofline details that host a colony in August host [wildlife](/pest-control/wildlife-management/) in March.

If your house produces a nest most years, the useful conversation is not about this year's nest. [Tell us where they went in](/contact/) and what month you last saw wasps indoors — the consultation is free, and winter is the season this problem is actually solved in.
