---
slug: cockroach-source-apartment
title: How to find the source apartment in a cockroach line
metaTitleCore: Finding the Source Apartment in a Cockroach Line
cluster: service-cores
quickAnswer: >-
  German cockroach complaints in an apartment building arrive from the units that notice, not the
  units that produce. The population sits in the plumbing chase connecting stacked kitchens, so the
  map that matters is a monitor map of the whole line — and the source apartment is frequently one
  that never called.
metaDescription: >-
  German cockroach pressure sits in the plumbing chase, not the tidy kitchen. How monitor data across
  a whole line finds the apartment actually producing it.
faqs:
  - question: What is a line, and why does it matter more than a floor?
    answer: >-
  ...
  - question: Why would an apartment with cockroaches never report them?
    answer: >-
      ...
      In a published high-rise study, most residents of units that traps showed to be infested did
      not know they had cockroaches. People report what they see, and what they see lags a long way
      behind what is present.
  - question: How many monitors does a line actually need?
    answer: >-
      Several per kitchen and bathroom rather than one per apartment, and every unit in the column
      rather than the ones that called. Placement beside the range and the refrigerator tends to
      catch more than a trap left under the sink, so a single trap in the wrong corner of a kitchen
      reads as a clean apartment.
  - question: Can a resident do anything to help find the source?
    answer: >-
  ...
  - question: If my apartment is clean and my neighbour's is not, is that the cause?
    answer: >-
      ...
      turn in a building investigation, and it reliably sends the work to the wrong floor.
  ...
  - question: How long does it take to prove a line is finished?
    answer: >-
      Longer than the sightings take to stop. Traps have to read zero across the whole column for
      several consecutive service intervals, because egg cases present at treatment hatch afterwards
      and a very small surviving population is also an invisible one.
  - question: Does any of this apply to a private house?
    answer: >-
      Partly. A house has the same wet wall and the same unsealed penetrations, but no other
      household feeding the void, so the investigation is smaller and the sealing usually settles it.
      The vertical mapping problem belongs to buildings where several kitchens share one riser.
sources:
  - name: Journal of Integrated Pest Management — Effectiveness of Building-Wide IPM for German Cockroach and Bed Bug in a High-Rise Apartment Building
    url: https://academic.oup.com/jipm/article/10/1/33/5625298
  - name: Spatial Distribution of German Cockroaches in a High-Rise Apartment Building During Building-Wide IPM (PubMed)
    url: https://pubmed.ncbi.nlm.nih.gov/31120112/
  ...
  - name: University of Kentucky Entomology — Cockroach Control (ENTFACT-614)
    url: https://entomology.mgcafe.uky.edu/ef614
  - name: NYC Local Law 55 of 2018 — Indoor Allergen Hazards
...
## Why do complaints in a building arrive in a vertical pattern?

Because the habitat is arranged vertically, and the complaint log is a distorted picture of it.

Pull three years of service records for an eighty-unit building with a German cockroach problem and the calls will not be scattered evenly. They fall in a column. The B line reports in March, reports again in June, then an apartment two floors below the first one reports in September — while the A line on the same landings, with the same age of fit-out, the same refuse room and the same corridor, has said nothing at all. Most managing agents have noticed this pattern. Very few draw the conclusion it demands.

The conclusion is that whatever produces the insects is laid out the way the plumbing is laid out. Residential buildings stack their wet rooms on purpose, because running one riser past twelve kitchens is far cheaper than running twelve risers to twelve kitchens. The kitchen in 2B therefore sits directly under the kitchen in 3B, which sits under the kitchen in 4B, and behind every one of them is a single continuous cavity carrying cold and hot supply, a waste stack, a vent stack and — in a great deal of the pre-war stock in Manhattan, Brooklyn and Queens — a heating line that keeps that cavity warm from October to April.

Nothing about a household's habits is distributed that way. Nobody's cleaning standards travel up a pipe. When a phenomenon follows the shape of the building's mechanical services rather than the shape of its social arrangements, the building's mechanical services are the better explanation, and that is as close to a controlled experiment as anyone gets in occupied housing.
...
A void, and usually a much larger and better-connected one than the resident imagines.

Open the cabinet under a kitchen sink in a pre-war building and you are looking at the back of a partition that was never intended to be a finished surface. The waste line comes through it in a hole cut oversize with a hammer and a cold chisel, because the fitter needed room to swing the pipe into place. The hot and cold supply arrive through two smaller holes, each dressed on the room side with a thin chrome escutcheon that covers the hole without sealing it. Behind that partition, the space runs sideways into the adjoining bay and downward past the floor framing into the ceiling void of the apartment below.

That is the essential point about a chase and the one that is hardest to picture from inside a finished room. It is not a duct with walls. It is the absence of construction — a continuous three-dimensional gap that exists because nobody built anything there, threaded with pipes that provide condensation on the cold lines in summer and radiant heat from the hot lines all year. The University of Kentucky's cockroach guidance makes the practical version of the point plainly: German cockroaches travel between rooms and between adjoining apartments by way of walls, ceilings, pipes and wires.

Now add what the insect wants. Cornell IPM describes cockroaches as cryptic animals that prefer tight, dark spaces — gaps, crevices and corners. A pipe passing through a rough hole in a masonry partition produces, along its entire length, exactly the geometry the animal seeks: two surfaces meeting at a narrow angle, in the dark, above ambient temperature, within a few feet of water. There is no need to imagine that the population is doing anything clever. It is sitting in the best available real estate in the building, and the building supplied it for free.

The food supply is the least demanding part of the arrangement. Grease film behind a range, residue in a trap, the glue on stored cardboard and the crumbs in a floor joint will each sustain a colony, and the animal only has to leave the void far enough to reach one of them. A female's productivity does the rest — the Kentucky guidance notes that up to forty nymphs emerge from one German cockroach egg case, and that a single mated female can put thousands of descendants into a building inside a year.

So the void is warm, wet, dark, tight, connected to eleven kitchens and adjacent to food. The apartment is not the habitat. The apartment is where the habitat has an opening.

## Why is the complaint list a bad map of the infestation?
...
None of this is a criticism of residents. A moderate German cockroach population is nocturnal, spends the day pressed into cracks inside cabinetry and appliance housings, and produces no noise, no smell and no visible damage. Expecting a household to detect it reliably is expecting them to do a job that requires equipment. Which is the whole argument for the equipment.

## How is a line actually mapped?
...
## What separates a source unit from a receiving one?
...
## Why does the housekeeping theory keep sending crews to the wrong apartment?
...
Sealing every penetration on every floor of the column, in materials matched to the substrate, with the sequencing that lets the treatment work first.

The order is not negotiable. Monitors first, so the map exists. Population reduction next, so that the animals sealed inside a void are not a substantial breeding colony with nowhere to go. Then the physical work, floor by floor, and then continued monitoring to confirm the void has stopped delivering.

The inventory at each floor is short and repetitive, which is what makes it auditable:

**The waste-line annulus.** The oversize hole around the drain where it passes into the wall or through the floor. Masonry substrate takes cement and mortar; where the pipe has to remain free to move, the gap is packed with Xcluder fill fabric and closed rather than mortared solid against the pipe.
...
That choice is the same one that runs under every subject in this cluster, and it is the same one facing a board dealing with [bed bugs](/pest-control/bed-bug-treatment/) in the same building, along many of the same voids. The rest of the writing on risers, chases and service cores is indexed on the [blog](/blog/); the work itself is [cockroach control](/pest-control/cockroach-control/); the species detail sits on the [German cockroach profile](/pest-library/german-cockroach/); and the governance side — inspection scope, notice, records, who commissions common-element work — is written for boards and agents on the [co-op and condo page](/commercial/coop-condo-pest-control/).

If you manage a building where one line keeps coming back, the useful first step is not a treatment. It is a trap in every apartment in that column on the same day. The [consultation is free](/contact/) and most of this can be worked out on the phone before anyone visits.
