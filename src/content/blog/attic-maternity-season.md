---
slug: attic-maternity-season
title: The maternity calendar that decides when an attic can be sealed
metaTitleCore: Attic Exclusion and the Maternity Calendar
cluster: roofline-and-attic
quickAnswer: >-
  Squirrels, raccoons and bats each carry dependent young at predictable times, and a one-way device
  fitted in the wrong month seals a litter into the ceiling. New York's health department names late
  May to mid-August as the period not to batproof. The calendar sets the schedule; the sealing
  decides the outcome.
metaDescription: >-
  Squirrels, raccoons and bats carry dependent young on a predictable calendar. What that means for
  when an attic can lawfully and safely be closed.
faqs:
  - question: What is the bat maternity window in New York, and who sets it?
    answer: >-
      The State Department of Health publishes it. Its guidance says not to batproof between late May
      and mid-August so that baby bats are not trapped in the roost, and it describes house bats using
      buildings as nurseries from early June through late August. It also names late autumn through
  ...
  - question: Why can't the animal simply be trapped and taken away instead?
    answer: >-
      Removing a nursing female leaves the same litter in the same cavity with nobody feeding it, so
      it produces the identical outcome by a different route. Timing has to be established before any
  ...
  - question: If we have to wait, does that mean nothing happens for months?
    answer: >-
      ...
      the roofline can be closed while the animals are still using their main entrance, so that when
      the window opens the exclusion is one visit rather than a season of chasing relocations.
  - question: How do you tell whether there are young up there before committing?
    answer: >-
      Species, calendar and evidence together. Time of day separates a diurnal squirrel from a
      nocturnal raccoon, repeated short returns during daylight suggest nursing, and high-pitched
      chittering from a fixed point is the clearest sign of all. New York's own guidance is to look
      and listen for animal noises before sealing anything, particularly in spring.
  - question: Does the calendar change what materials are used?
    answer: >-
      Not the materials, only the sequence. The closure specification is decided by the species and
      the substrate. What the calendar changes is when the last opening is closed, and whether the
...
## Why does a calendar decide an attic job at all?

Because the standard method for getting an animal out of a roof cavity relies on the animal walking out under its own power, and for a large part of the year some of the occupants cannot walk.
...
New York states the principle directly rather than leaving it to trade custom. The Department of Environmental Conservation's guidance on raccoons tells homeowners not to permanently seal entrances without first verifying that all the animals are out of the den, and to look and listen for animal noises, especially in spring. That is a state agency writing down the sequencing rule.
...
This is why "we will do it in the spring" is one of the least useful sentences in wildlife work on Long Island. Spring is a peak dependency period for the most common attic animal in this market, not a clear window.

The compensating fact is that squirrel young are comparatively mobile once they start moving, and by the time they are exiting the nest with the adult they will use a one-way device themselves. So the good windows are real: broadly the stretch after the first litter has weaned and before the second is born, and again once the late-summer litter is foraging, running into the winter. What the calendar demands is that somebody establishes which litter, and how old, before anything is fitted — which is done by listening at the ceiling and by watching the entrance at the right hour, not by consulting a chart.

## What about raccoons?

One litter a year, born late, and dependent for far longer than people expect.

The Department of Environmental Conservation records litters of one to seven young born in April and May, with females seeking den sites in late winter. The young open their eyes at about three weeks, nurse for about six weeks, and then leave the den to follow the mother — but they stay with her until September or early October, when they disperse.

That last clause is the one that catches people out. A raccoon litter is not "done" in June. It is mobile in June, which is a different thing, and a mobile juvenile will leave through a device and can then be excluded successfully. But between April and roughly mid-June the animals in an attic are physically incapable of leaving, and any closure fitted in that period produces the worst version of the outcome described above — the largest carcasses, the most determined mother, and the greatest damage during her attempts to re-enter.
...
It is published by the New York State Department of Health, it runs from late May to mid-August, and it is the clearest statement of any of these constraints.

The Department's fact sheet on bat habitat inspection and batproofing instructs that buildings are not to be batproofed during the period from late May to mid-August, in order to avoid trapping baby bats inside the building. Its public material on bats and rabies restates the same window — do not batproof between late May and mid-August so that baby bats are not trapped in the roost — and adds two facts that are just as useful for planning. First, that the house bats people actually encounter in buildings here, the big brown and the little brown bat, use those buildings as nurseries from early June through late August. Second, that the best time to batproof is late autumn through winter.

That gives a whole-year shape rather than a prohibition. Late autumn and winter is the window to aim for. Spring, before the colony forms, is workable. Late May to mid-August is closed.

The Department of Environmental Conservation's material on the northern long-eared bat lands in the same place from the conservation side, advising against activity near roosts until after the pup rearing season in mid-August. The species matters here because federally endangered species that occur in New York carry endangered status under the state's own Endangered Species Law, and because DEC treats Nassau and Suffolk separately in its guidance rather than folding Long Island into the statewide position. A practice working on this island does not get to reason from the statewide default.

Two further details from the health department's inspection guidance are worth carrying up the ladder, because they change what an inspection is looking for. Bats are described as using openings larger than half an inch by half an inch, and long thin slots larger than a quarter of an inch by two inches. That second dimension is the one that defeats most surveys. Nobody scanning a roofline for "a hole" finds a two-inch slot at a ridge course or the gap where a fascia board has cupped away from a rafter tail, and a roof assembly can present dozens of candidates of that description.

Which is precisely why bat work is a survey job with a seasonal deadline attached, and why the survey is worth doing during the closed period rather than after it.

## How do you tell whether there are young up there?
...
**Watch the entrance and count.** An adult that leaves at dusk and does not return until dawn is behaving like an animal with nothing to come back for. An adult making repeated short trips, in and out several times in an evening, is provisioning something. That pattern in a nocturnal animal during April or May is close to conclusive on its own.
...
## What can actually be done during a closed window?

A great deal, and this is the part of the argument that turns a delay into an advantage.

The mistake is to treat a maternity window as a period in which the file sits closed. What it actually is, is the only period in which you can do envelope work on a building while the animals are still using a known entrance and are therefore not opening new ones. That is a genuinely useful condition and it never exists again on the same job.

**Reduce the roofline to one opening.** Every secondary gap on the structure gets surveyed and closed while the occupants continue to use their main entrance. Soffit returns on the other three corners. The gable louver at the far end. The lifted ridge cap. The fascia gap over the porch. Done in this order, the animals are not displaced anywhere, because their route is untouched, and at the end of it the building has one hole in it instead of nine.

**Design the closure rather than improvise it.** Deciding the substrate, the fabrication and the fastening in advance is what makes the final visit a single afternoon. Custom-fabricated 26-gauge galvanized sheet metal is cut and formed to the detail it has to close. Where the substrate is masonry the answer is cement and mortar. Vents that must keep moving air get copper or stainless mesh or hardware cloth from behind, sized to the species, because blocking a functioning vent trades an animal problem for a condensation problem in the roof deck. Xcluder fill fabric and door sweeps close the openings that have to stay serviceable. Everything is mechanically fastened. Foam is not used in any position — not as a filler, not as backing, not as a cover over something better — because a squirrel is through cured foam in minutes and a raccoon is through it in one movement, and the opening is by then recorded as closed on somebody's paperwork.
...
**Book the sequence.** The removal visit, the watching period, the closure and the return check are separate appointments. Arranging them during the wait is the difference between excluding in the first fortnight of the open window and excluding in the last.

## How does the permanent closure differ from a repair?

By where it stops. A repair closes the hole the animal used. An exclusion closes every detail on that building constructed the same way.

This is the distinction that decides whether the calendar problem recurs next year. A house that had a squirrel in one soffit return has three or five other soffit returns framed identically by the same carpenter on the same afternoon in 1974. A house where a raccoon pulled one section of vinyl soffit out of its channel has forty more feet of the same channel. Closing the one opening the animal happened to choose leaves the building in the same condition that produced this year's job, and the next occupant will be along on the next breeding cycle — at which point the maternity calendar becomes a problem all over again, on the same house, for the same reason.

There is a scent dimension too, and it is more consequential than it sounds. A cavity that has raised a litter goes on broadcasting that fact to every animal of the same species passing along the roofline, and a roof void with an occupancy history behind it is taken up again far more readily than one without. So the removal of fouled and compressed insulation, and the treatment of the affected cavity, is not housekeeping at the end of the job. It is part of the exclusion.
