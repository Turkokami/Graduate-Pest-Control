...
faqs:
  - question: How often should a restaurant kitchen actually be serviced?
    answer: >-
      A full-service kitchen with a cellar, a bar and a dish area generally needs weekly or
      fortnightly attention, not monthly. Frequency should come out of the baseline survey rather
      than out of a contract template, and it should be higher during a reduction phase than once the
      structural corrections are closed out.
  - question: Will a clean kitchen pass on cleaning alone?
    answer: >-
      No, because most of what an inspector cites for pests is structural. Cracked coving, a hollow
      equipment leg, a delivery door that does not seal at the corner and a floor drain with no
      standing water in the trap all persist through immaculate nightly cleaning, and each of them
      sustains a population by itself.
  - question: Why do small flies come back a week after the drains are cleaned?
    answer: >-
      Because the cleaning removed surface film rather than the breeding medium. Drain and phorid
      flies develop in the organic layer clinging to the pipe wall, under the drain basket, beneath
      loose tile and sometimes in a broken line under the slab. If the source is below the floor, no
      amount of pouring anything down the drain reaches it.
  - question: Can a pest contractor promise us an A grade?
    answer: >-
      Nobody can. The grade reflects everything the inspector observes on the day, most of which is
      outside a pest contractor's control. What a contractor can do is remove the pest-related
      findings from the list, evidence the work in a logbook, and tell you honestly which open items
      are likely to be cited if they are not closed.
  - question: Should we fog or spray the night before an inspection?
    answer: >-
      Do not. A repellent application scatters German cockroaches deeper into equipment voids and
      along wall penetrations, wrecks any bait placement already working, and frequently produces
      dead insects in visible places on the very morning you least want them. Panic treatment before
      an inspection reliably makes the inspection worse.
  - question: Who is responsible for sealing the building — us or the landlord?
    answer: >-
      Legally that depends on your lease, and it is worth reading before the argument starts. As a
      practical matter the inspector cites the operator, so unowned structural items are your
      exposure regardless of who pays. Get the finding in writing early, assign it, and keep the
      correspondence in the file.
  - question: What should be in the pest logbook kept on site?
    answer: >-
      Service reports with dates, areas covered and specific findings, a device or monitor map that
      matches the site, records of any material applied, the corrective-action list with owners and
      closure dates, and the contractor's licensing and insurance paperwork. It should live where a
      manager can hand it over without hunting for it.
  - question: Why do cockroaches keep arriving even after the kitchen is clear?
    answer: >-
...
## What is actually at stake when an inspector walks through the kitchen door?

The letter in your window, and in the worst case the right to serve that night.

Restaurants in New York City are inspected unannounced by the Department of Health and Mental Hygiene. The inspector records violations, each carrying a weight according to how directly it threatens public health, and the total determines the letter grade posted at the door. That card is not a private matter between you and the agency. It is published, it is on the glass where every arriving guest reads it before they read the menu, and the underlying inspection detail is available online long after the visit itself is forgotten.
...
So the honest framing for this vertical is that pests are a business-continuity risk expressed through a regulatory mechanism. Nothing about that is solved by an insect dying. It is solved by the building not producing insects and by your file showing that you knew it and acted.

## Which pest findings actually carry weight in an inspection?

Three families of finding, and they are not weighted equally.

**Live pest evidence.** The inspector observing live cockroaches, live mice or rats, or the unmistakable traces of them — droppings, gnaw damage, urine staining, egg cases, burrows — in food-preparation, storage or service areas. Evidence carries whether or not anything is moving at the time, which is a point operators consistently misjudge. A tray of droppings behind the ice machine is a finding even at ten in the morning when every insect in the building is asleep.
...
That hierarchy is also the correct order of priority for the work. Killing what is present is the fastest part and the least durable. Removing the conditions is slow, unglamorous, involves trades other than us, and is the only part that changes the next inspection.

## Where does an inspector actually look in a restaurant?
...
**The cellar.** In an older city building this is where the answer usually is. Prep space and dry storage below grade, the sidewalk hatch, the house trap, the grease interceptor, the electrical and plumbing penetrations through the slab, and the abandoned pipework nobody has capped.

**The refuse area.** Container lids, the condition of the pad or the sidewalk staging area, wash-down, and the interval between the bag leaving the kitchen and the material leaving the property.

None of that list is exotic. It is the same list every time, which is exactly why a restaurant that walks it deliberately once a week is in a different position from one that walks it the morning after a violation.

## Why are German cockroaches and small flies structural problems rather than cleaning failures?

Because both are sustained by things a cleaning rota cannot reach, and treating them as hygiene failures puts the effort in the wrong place and demoralises a kitchen that is already working hard.

Take the cockroach first. *Blattella germanica* needs warmth, moisture, a tight crack to press into and a short walk to food. A commercial kitchen supplies all four continuously, at a scale a domestic kitchen does not. Motor compartments run warm all night. Equipment voids are sealed cavities nobody opens. The dish area never dries. And the population arrives by delivery rather than by neglect — in corrugated boxes, produce crates, beverage cases and returnable containers coming from a warehouse or a supplier with its own problem. A spotless kitchen taking in cardboard at the back door every morning is receiving a steady inoculum, and no amount of scrubbing addresses that. What addresses it is decartoning at the receiving point, inspecting incoming goods, and closing the voids the arrivals would otherwise settle into. The species-level detail sits on our [cockroach control](/pest-control/cockroach-control/) page.

Small flies work the same way one level down. The adults you see are not the problem; they are the evidence of a breeding site, and each species points to a different one.

**Drain flies** — small, fuzzy, moth-like, weak fliers that sit still on the wall near a drain — develop in the gelatinous organic film lining a drain pipe and the underside of the basket. Pouring anything caustic down the drain removes some surface material and leaves the film adhering to the pipe wall above the water line. Mechanically brushing the line and treating with a foaming product that clings to the vertical surface is what actually removes the medium.

**Fruit flies** — smaller, tan, often red-eyed, hovering — breed in fermenting sugars: the drip tray, the mop head, the bar mat, the recycling bin with a week of bottles in it, a case of overripe produce, the pulp trap in a juicer.

**Phorid flies** — humpbacked, running in short erratic bursts across a surface rather than flying — are the important one diagnostically. They develop in decomposing organic matter, and in a restaurant with no visible source they very often indicate a break in the drain line beneath the slab, a cracked lateral, or a saturated void where sewage has been leaking into the sub-floor. A persistent phorid population with a clean kitchen above it is a plumbing finding waiting to be made, and treating the adults indefinitely instead of opening the floor is how a restaurant spends two years fighting flies.
...
**Drain management as a standing item.** Lines brushed and treated on a defined cycle, traps kept primed, baskets intact, and the cellar and yard drains included rather than forgotten.

**Rodent work as a separate track.** Mice and rats in a restaurant are usually an envelope-and-below-grade problem rather than a kitchen problem, and in an older city building the route is frequently up from the cellar through a failed house trap or a broken line rather than in through the front. The approach is set out under [rodent control](/pest-control/rodent-control/).
...
## What goes wrong, and why do the same restaurants fail the same violation twice?

Six failure patterns, and they recur across operations of every size and price point.
...
Underneath all six sits one structural fact about the trade. A firm selling a monthly visit has no commercial incentive to end the problem, because the recurring visit is the product. A firm scoping corrections is selling itself out of a subscription. It is worth knowing which arrangement you are in.

## What proof should you expect from a pest contractor?

Not stories about other restaurants. Documents about yours.

Expect a written baseline after the first survey: what was found, where, at what intensity, with photographs of the significant findings and a plain statement of what is driving the problem. Expect a device map that matches the site. Expect a corrective-action list that names each item, says who owns it, and carries a target date — including the items that are not ours and the ones that will cost you money we do not receive. Expect service reports that record findings rather than attendance, including the awkward findings, because a sanitised report is worthless in exactly the circumstances you are keeping it for.

Expect a trend after a few months: counts by area, over time, with a direction. Expect a walkthrough before a re-inspection, in which someone goes through the site the way an inspector would and tells you which open items are likely to be cited. And expect a straight answer when the source turns out to be next door, below the floor or in the landlord's cellar, because a contractor who tells you what you want to hear is of no use when the inspector arrives.

What you should not expect is a promise about a grade. The letter reflects everything observed on the day across the whole operation, most of which has nothing to do with pests. Anyone offering to secure it is telling you something about themselves.

## How does a restaurant account actually begin?
