...
title: Food Safety & SQF Programs
...
faqs:
  ...
  - question: Does a pest contractor need to be SQF credentialed to service an SQF site?
    answer: >-
  ...
  - question: Can rodenticide be used inside a food manufacturing plant?
    answer: >-
      As a general rule it is kept out of the building entirely. Interior rodent monitoring is
      mechanical and non-toxic, and any toxicant use belongs on the exterior, documented, strictly
      within label terms and within whatever the facility's own policy allows. The placement
      reasoning has to be written down and has to match the device map.
  - question: What does an auditor do with our trend data?
    answer: >-
      They look for location and direction, not for a total. Pressure concentrated in a handful of
      devices at one end of the building is a structural finding about a door or a penetration. A
      flat site-wide number tells them nothing, and a run of uniform zeros across every device
      invites the question of whether anyone is genuinely checking.
  - question: Who owns the corrective actions a pest inspection raises?
    answer: >-
      Mostly the facility, not the contractor. Door hardware, dock seals, roofing, drainage, floor
      repair, storage practice and sanitation procedure all belong to maintenance, engineering or
      QA. An item with no named owner inside the plant does not close, and an auditor reading a log
      full of unowned items draws the obvious conclusion.
  - question: How often should an SQF-certified facility be serviced?
    answer: >-
      The frequency should come from a written risk assessment rather than a template, and it should
...
If your operation includes retail or foodservice outlets, the inspection regime there is different and is described under [restaurant pest control](/commercial/restaurant-pest-control/). If you run several buildings of different ages, the consistency problem is covered under [property management](/commercial/property-management-pest-control/). The wider commercial framework sits on the [commercial pest management](/commercial/) page, and the coverage area is listed under [locations](/locations/).
