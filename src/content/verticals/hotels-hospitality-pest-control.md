...
metaTitleCore: Hotel Pest Control & Bed Bug Response Programs
quickAnswer: >-
  Hotel pest management is a liability and reputation problem concentrated in one insect. Bed bugs
  arrive with guests no matter how well a property is run, so what separates an exposed hotel from a
  protected one is proactive room inspection, trained housekeeping, a same-day response protocol
  covering adjacent rooms, and a written record of every report.
metaDescription: >-
  Hotel pest management built around bed bug liability: proactive room inspection, housekeeping
  reporting, adjacent-room protocol and documentation that holds up.
faqs:
  - question: Does a bed bug report mean the hotel did something wrong?
    answer: >-
      No. Bed bugs arrive in luggage, and a property with high turnover is exposed continuously
      regardless of how well it is cleaned. Introduction is not the failure. The failure is a slow,
      undocumented or partial response, and that is the part a court, an insurer and a brand auditor
      will actually examine.
  - question: How many rooms should be inspected when one is reported?
    answer: >-
      More than the reported room. At minimum the rooms either side, the room directly above and the
      room directly below, because those share wall assemblies, conduit and floor penetrations.
      Where the report is credible or the evidence is heavy, the ring widens, and the rooms inspected
      are recorded whether or not anything was found.
  - question: Can the room be re-let after treatment?
    answer: >-
      Not on the strength of one treatment and a quick look. Eggs present at the time of treatment
      hatch afterwards, so a room should stay out of inventory through a defined verification period
      with monitoring in place and a follow-up inspection before it goes back on the board. Returning
      a room early is how a second guest report happens.
  - question: How reliable is canine detection?
    answer: >-
      It depends almost entirely on the training and handling behind the dog rather than on the
      concept. Used well it is fast enough to screen a floor of rooms in the time a visual inspection
      takes for a handful, which is its real advantage. Ask any provider about training standards,
  ...
  - question: Should we tell the guest what was found?
    answer: >-
      Yes, in plain terms, promptly, and with what you are doing about it. Guests escalate when they
      feel dismissed far more often than when they feel informed. Coordinate the wording with your
      own counsel and insurer, keep the record of what was said and when, and never let a room be
...
## What is actually at stake when a guest reports a bed bug?
...
## What do brand-standard auditors and inspectors actually look for?
...
**A proactive inspection schedule.** Evidence that rooms are inspected on a cycle rather than only when someone complains, with the cycle defined, the coverage recorded and the results logged.

**An incident log.** Every guest report, with the date and time received, the room, what was done, which adjacent rooms were inspected, the findings in each, the treatment, the verification, and the date the room returned to inventory. This is the document that does the most work in every scenario an operator worries about, and it is the document most properties do not keep in a usable form.
...
**Consider canine screening for scale.** Detection dogs are widely used in hospitality for one reason: a trained team can screen a floor of rooms in the time a careful visual inspection takes for a handful, which changes what is affordable. Quality varies enormously, and it depends on the training and the handler rather than on the animal. If you are evaluating a provider, ask what standard the team is trained and evaluated against, how often that evaluation is repeated, how the handler avoids cueing the dog, what the protocol is when the dog alerts, and — critically — whether every alert is visually confirmed before a room is taken out of service or treated. An alert is a reason to look, not a finding in itself.
...
**Log every step with times.** Report received, room removed from inventory, inspection performed, ring inspected, findings, treatment, verification, room returned. That sequence with timestamps is the document that answers the only question anyone will ask afterwards.

## How does housekeeping reporting actually work, and why does it usually fail?
...
**Make reporting blameless and say so repeatedly.** The person who finds early-stage activity has saved the property a claim. That framing has to come from management, in the language staff actually use, and it has to survive the first time someone reports something inconvenient.

**Make reporting take seconds.** A photograph to a defined number or channel, with the room number, and nothing else required. Any process that requires filling in a form at the end of a shift will produce a report rate of approximately zero.
...
That question is answered from records or it is not answered at all. Memory is worthless two years later, staff have turned over, and the guest's account will be specific and sympathetic. What holds is a contemporaneous log that shows the report arriving, the room coming out of inventory within the hour, the inspection performed and by whom, the ring inspected with findings for each room, the treatment, the verification, and the release date. A file like that demonstrates a reasonable, systematic response. A file with a maintenance ticket saying "guest complaint, room cleaned" demonstrates the opposite, and it does so in the operator's own handwriting.

Several practices make the record hold up.

**Log every report, including the ones that turn out to be nothing.** A property with an incident log containing negatives looks like a property that investigates. A property that only logs confirmed cases looks like one that decides what to write down.

**Record the negatives in the ring.** Rooms inspected and found clear are evidence of scope. Without them, the record shows only that you dealt with the room the guest was in.

**Keep the pest contractor's reports and your internal log connected.** Two systems that never reference each other produce gaps at exactly the seams where the story needs to be continuous.

**Photograph findings and closures.** Dated images of evidence found and of the room after verification are more convincing than any description.

**Retain for longer than feels necessary.** Claims arrive well after the event, and the useful record is the one from the incident before the one being litigated.

Take advice from your own counsel and insurer on retention, disclosure and what you say to guests — we are a pest contractor, not your lawyers. What we can do is make sure the pest side of the file is complete, specific and legible to somebody reading it cold. The general shape of audit-ready reporting is set out under [commercial pest management](/commercial/).
...
**Kitchen and banqueting.** The same structural realities as any commercial kitchen: floor drains, hollow equipment legs, wet areas under dish machines, cracked coving, dry storage on the floor, and cardboard arriving daily. Banqueting adds a specific risk, because equipment and stock are moved between spaces and stored in rooms that are not cleaned on a kitchen schedule.

**Storage, mechanical and staff areas.** Old furniture, broken FF&E awaiting disposal, staff lockers and break rooms with food in them, and the riser and chase spaces that connect all of it vertically to the guest floors.

The connection between back of house and the guest floors is structural and it is the reason a lobby-level sighting is rarely a lobby-level problem. Chases, risers, dropped ceilings and conduit runs carry populations upward from a cellar or a kitchen without anything crossing an open floor. When a guest room reports a cockroach, the productive question is what is directly below it. The species-level detail is on our [cockroach control](/pest-control/cockroach-control/) page, the below-grade routes are covered under [rodent control](/pest-control/rodent-control/), and the sealing work that closes them is on [structural exclusion](/pest-control/structural-exclusion/).

## How should guests be communicated with?

Promptly, plainly, and by someone who has been told what to say before the situation arises.

Guests escalate when they feel dismissed. The front desk response that produces a claim is the one that sounds like management of the guest rather than management of the problem — a suggestion that it was probably something else, an offer of a different room with no explanation, a promise that the room will be "taken care of." What defuses the situation is the opposite: taking the report seriously in the first sentence, moving the guest away from the affected area, handling their belongings at the property's expense, telling them what is being done and when they will hear back, and then actually coming back to them.

Scripting helps, provided the script is written with your counsel and insurer rather than improvised at the desk at two in the morning. Three principles hold generally. Never describe a room as clear before it has been inspected and verified — that statement is both untrue and quotable. Never speculate about where it came from in front of the guest. And never let the resolution depend on the guest chasing you, because the chase is what turns a complaint into a review and a review into a claim.

Internally, the equivalent principle is that the guest-facing message and the operational record have to match. A guest told the room was treated and verified, alongside a file showing the room was returned to inventory the same afternoon, is a problem entirely of the property's own making.

## What should the file hold when a brand auditor asks for it?
...
## How should a property put this in place?
...
The pest-specific pages worth reading are [bed bug treatment](/pest-control/bed-bug-treatment/) for the biology and the treatment options, and [rodent control](/pest-control/rodent-control/) for the back-of-house picture. Our coverage across the city and the Island is listed under [locations](/locations/), and [Ryan Katz](/ryan-katz/) sets out how the diagnostic side of the work is approached.

To begin, [contact us](/contact/) with the property type, the room count, whether there is food and beverage on site, and what your incident history looks like. If you are currently dealing with an active report, say so first — that changes the order of everything.
