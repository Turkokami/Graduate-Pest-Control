...
State agencies operate on a different instrument. [State Finance Law section 163](https://www.nysenate.gov/legislation/laws/STF/163) requires commodities to be awarded on lowest price and services on best value — the offer optimising quality, cost and efficiency — with a priority order running from preferred sources through centralised contracts to agency contracts, and with the procurement record required to document the decisions and the basis for the award. For a pest program, "best value" is the single most useful phrase in New York public procurement, because it is the statutory permission to buy method rather than price.
