...
title: Municipal, County & Public Facilities
metaTitleCore: Municipal & Public Facility Pest Control
quickAnswer: >-
  A public agency buying pest control is buying two things: a result inside a building the public
  uses, and a file that will be read by somebody who was not there. Procurement rules,
  prevailing wage exposure, limits on what may be applied in a public building and the Freedom of
  Information Law all shape the work before it starts.
metaDescription: >-
  Pest management for municipal and county buildings: procurement rules, prevailing wage exposure,
  what may be applied, and records that survive a FOIL request.
faqs:
  - question: Does a municipality have to competitively bid a pest control contract?
    answer: >-
      It depends on how the contract is classified. General Municipal Law section 103 requires
      competitive bidding for purchase contracts above twenty thousand dollars and public works
      contracts above thirty-five thousand, and the courts have carved out professional services.
      Where bidding does not apply, section 104-b still requires the municipality to follow its own
      written procurement policy. Your attorney classifies the contract, not your contractor.
  - question: Does prevailing wage apply to pest control work for a public agency?
    answer: >-
      It can, and the answer turns on what the work is rather than on what it is called. Article 8
      of the Labor Law reaches public work of a construction character, which structural sealing can
      resemble. Article 9 reaches building service employees on public agency contracts over fifteen
      hundred dollars, and its enumerated occupations do not name pest control. Get the
      determination before bids are opened.
  - question: What can be applied inside a New York City agency building?
    answer: >-
      Considerably less than in a private one. The city's pesticide law covering agency property
      prohibits products in EPA Toxicity Category I, products the EPA classifies as known or likely
      human carcinogens, and developmental toxins under California's list, subject to defined
      exemptions and time-limited waivers. It binds firms working under contract to an agency, not
      only agency staff.
  - question: Do we have to notify the public before an application in a public building?
    answer: >-
      In New York City, agency property carries a posting requirement in advance of application,
      identifying the date, the location, the pest, the product and a contact, with a concurrent
      provision for emergencies. Outside the city, the New York neighbor notification framework and
      any facility-specific rules apply. Confirm the current requirement with the agency's counsel
      before scheduling anything.
  - question: How does a public agency verify a pest contractor's credentials?
    answer: >-
      By asking for the numbers and checking them against the state register rather than accepting
      a logo. New York issues a business registration and a certified applicator identification with
      specified categories, both of which are lookups. Trade association memberships are not
      certifications and should not be scored as if they were.
  - question: Are our pest records subject to a public records request?
    answer: >-
      Assume they are. Under the Freedom of Information Law, agency records are presumptively
      accessible subject to the statutory exemptions, and an agency must respond within five
      business days. That means service reports, findings and corrective registers should be written
      to be read by a stranger, including the findings nobody wanted.
  - question: Why is the lowest bid a worse deal for a public owner than a private one?
    answer: >-
      Because the agency owns the building indefinitely and cannot walk away at the end of a lease.
      A low per-visit price buys attendance, and the structural conditions producing the problem
      stay on the agency's own balance sheet, accruing, until somebody funds them. A private tenant
      can move; a village hall cannot.
  - question: Will you tell us in writing that a condition is our maintenance department's problem?
    answer: >-
      Yes, and it is most of what a survey produces. Roof penetrations, failed door hardware, drain
      lines, masonry and storage practice belong to facilities, engineering or public works. A
      finding without a named owner and a date does not become work, and a register full of unowned
      items reads badly to anyone who eventually requests it.
sources:
  - name: NY General Municipal Law § 103 — competitive bidding
    url: https://codes.findlaw.com/ny/general-municipal-law/gmu-sect-103.html
  - name: NY General Municipal Law § 104-b — procurement policies and procedures
    url: https://codes.findlaw.com/ny/general-municipal-law/gmu-sect-104-b/
  - name: NYS Comptroller — Seeking Competition in Procurement
    url: https://www.osc.ny.gov/files/local-government/academy/pdf/seeking-competition-procurement-062624.pdf
  - name: NY State Finance Law § 163 — state agency purchasing and best value
    url: https://www.nysenate.gov/legislation/laws/STF/163
  - name: NY Labor Law § 230 — building service employee definitions
    url: https://codes.findlaw.com/ny/labor-law/lab-sect-230.html
  - name: NYC DOHMH — Local Law 37, pesticides used by city agencies
    url: https://www.nyc.gov/site/doh/health/health-topics/local-law-37.page
  - name: NYC Administrative Code Title 17, Chapter 12 — Pesticide Use by City Agencies
...
For local governments — counties, cities, towns, villages, districts — the governing instrument is [General Municipal Law section 103](https://codes.findlaw.com/ny/general-municipal-law/gmu-sect-103.html). It requires competitive bidding, with award to the lowest responsible bidder, for purchase contracts above twenty thousand dollars and for contracts for public work above thirty-five thousand dollars. Those thresholds are aggregate and annual in the way the Comptroller's guidance describes, which catches agencies that think of a recurring service as a series of small purchases.

Sitting alongside that is a body of case law exempting professional services from competitive bidding — services involving specialised skill, training or expertise and the exercise of professional judgement or discretion. The [Comptroller's own procurement guidance](https://www.osc.ny.gov/files/local-government/academy/pdf/seeking-competition-procurement-062624.pdf) is direct that this is a judicial construct rather than a statutory definition, which is precisely why it should be settled by counsel in advance rather than argued about afterwards.

Where competitive bidding does not apply, the obligation does not disappear. [Section 104-b](https://codes.findlaw.com/ny/general-municipal-law/gmu-sect-104-b/) requires every local government to adopt written procurement policies and procedures for goods and services not subject to bidding: who is responsible for purchasing, how it is determined whether bidding applies and how that determination is documented, what method is used at what value, when alternative proposals or quotations must be sought, and how an award to anyone other than the lowest offerer is justified and documented. In practice, an agency that follows its own 104-b policy carefully is in a stronger position than one that bid a contract it did not need to bid and evaluated it badly.

State agencies operate on a different instrument. [State Finance Law section 163](https://www.nysenate.gov/legislation/laws/STF/163) requires commodities to be awarded on lowest price and services on best value — the offer optimising quality, cost and efficiency — with a priority order running from preferred sources through centralised contracts to agency contracts, and with the procurement record required to document the decisions and the basis for the award. For a pest programme, "best value" is the single most useful phrase in New York public procurement, because it is the statutory permission to buy method rather than price.
...
When the physical half of it starts to look like construction, and the answer changes the labour cost enough that nobody should find out after the award.
...
New York's certification framework is the floor everywhere. Commercial application requires a certified applicator in the right category, and the categories are specific. Structural and rodent work sits in the 7 series; public health work, including mosquitoes, sits in category 8; ornamental and turf work sits in a category Graduate does not have and does not bid. Any contractor proposing grounds work should be asked to produce the certification authorising it, and an agency is entitled to see it. How that structure works is set out under [New York pesticide applicator requirements](/compliance/nys-pesticide-applicator-requirements/).

Notification is the piece most likely to catch an agency out. Nassau and Suffolk have both adopted New York's neighbor notification framework, as has New York City, and it imposes advance written notice and visual marking obligations around certain commercial lawn applications, with a defined exemption set. A town that treats its own parkland or a village that treats the green outside the hall is inside that framework through its contractor. The plain-language version is under [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/) and the city rule under [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/).

Two categories of public facility carry tighter constraints again and should be scoped separately rather than folded into a general municipal contract: buildings used by children, and buildings used for care. Where an agency operates a day camp, a pre-kindergarten programme, a library children's room or a recreation programme, the child-occupied setting rules bear on it; that ground is covered under [schools](/commercial/schools-pest-control/) and [childcare facilities](/commercial/childcare-pest-control/). Where an agency runs a clinic, a nursing home or a public health facility, the infection-control expectations described under [medical facilities](/commercial/medical-facility-pest-control/) apply.
...
**Senior centres, community centres and libraries.** Food service in buildings that were not designed for it, programme use by vulnerable people, and the tightest constraints on what can be applied where the pressure is highest.
...
Agencies operating school buildings will want [schools](/commercial/schools-pest-control/); those operating childcare or pre-kindergarten programmes, [childcare facilities](/commercial/childcare-pest-control/); those operating clinics or care facilities, [medical facilities](/commercial/medical-facility-pest-control/). Agencies with housing stock should read [apartment buildings and rental portfolios](/commercial/multi-family-pest-control/), and those with port, terminal or waterfront property, [ports, marine terminals and offshore](/commercial/maritime-port-pest-control/). The wider framework is on the [commercial pest management](/commercial/) hub, the physical discipline behind the durable half of the work is on [structural exclusion](/pest-control/structural-exclusion/), and the two problems municipal buildings report most are covered under [rodent control](/pest-control/rodent-control/) and [cockroach control](/pest-control/cockroach-control/). The qualifying questions worth putting to any bidder are set out under [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/), coverage is listed under [locations](/locations/), and [Ryan Katz](/ryan-katz/) sets out what is held and what is not.
