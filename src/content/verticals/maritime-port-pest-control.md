...
title: Ports, Marine Terminals & Offshore
metaTitleCore: Port, Terminal & Offshore Pest Management
quickAnswer: >-
  Working inside a secure maritime facility is an access problem before it is a pest problem.
  Unescorted entry to a regulated terminal requires a Transportation Worker Identification
  Credential, and offshore transport requires helicopter underwater escape training. Ryan Katz holds
  both, which is why the work happens without a terminal employee walking beside him all day.
metaDescription: >-
  Pest management for MTSA-regulated marine terminals and offshore sites, run by a TWIC and HUET
  holder who does not need an escort to reach the work.
faqs:
  - question: Why does a pest contractor need a TWIC to work at a marine terminal?
    answer: >-
      Because the Coast Guard's facility security regulations require a valid Transportation Worker
      Identification Credential for unescorted access to a secure area of a regulated facility.
      Without one, a technician can only enter accompanied by an authorised credential holder, and
      the escort has to remain in a position to observe them for the whole visit.
  - question: What does escorting actually mean in a maritime facility?
    answer: >-
      The regulation defines it as ensuring the escorted individual is continuously accompanied
      while within a secure area, in a manner sufficient to observe whether they are doing anything
      other than what access was granted for — by side-by-side companion or by monitoring, depending
      on where the person is going. In practice that is a terminal employee's whole shift.
  - question: Who issues a TWIC and what does holding one prove?
    answer: >-
      The Transportation Security Administration issues it after a security threat assessment, and
      it is valid for five years. It proves the holder has been vetted for access. It says nothing
      about entomology, applicator certification or competence, and a facility should treat it as a
      gate credential rather than a technical one.
  - question: Can you work on an offshore structure as well as at the terminal?
    answer: >-
      Ryan Katz holds helicopter underwater escape training and Tier 1 offshore, with the records
      verifiable through the RelyOn platform, alongside the TWIC. Those are the qualifications that
      decide whether someone may be transported to a structure at sea at all. What happens once
      there is ordinary rodent and insect work in a very unusual building.
  - question: Do you issue Ship Sanitation Control Certificates?
    answer: >-
      No, and neither may any other private firm in the United States. Under the International
      Health Regulations the CDC is the competent authority for United States ports, with limited
      delegated authority to the Navy and Coast Guard for their own vessels. A certificate issued by
      a private company here is not valid, and any contractor offering one should be questioned
      closely.
  - question: What pests actually arrive with cargo?
    answer: >-
      Wood-boring beetles in pallets, crating and dunnage are the volume problem, which is why wood
      packaging material carries treatment marking. Egg masses of the flighted spongy moth complex
      on vessel structures are the seasonal one. Stored-product insects arrive in the commodity
      itself, and rodents board from the quay rather than from the sea.
  - question: Can you treat around the water's edge at a terminal?
    answer: >-
      Only within what the label and state law permit, and the water constrains it heavily. New York
      does not permit aquatic use of minimum-risk exempt products, and a great deal of a terminal's
      real mosquito production is standing water in tyres, containers, catch basins and covered
      equipment, which is a drainage problem rather than an application problem.
  - question: How does pest work fit into a facility security plan?
    answer: >-
      As a recurring authorised activity with named people, defined areas and a record. The useful
      version is agreed with the facility security officer in advance: who attends, which secure
      areas the work reaches, how devices are identified so they are not mistaken for anything else,
      and how findings are reported into the facility's own file.
sources:
  - name: "33 CFR Part 105 — Maritime Security: Facilities"
    url: https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-105
  - name: "33 CFR Part 104 — Maritime Security: Vessels"
    url: https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-104
  - name: 33 CFR § 101.105 — definitions, including escorting and secure area
    url: https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-101/subpart-A/section-101.105
  - name: TSA — Transportation Worker Identification Credential
    url: https://www.tsa.gov/for-industry/twic
  - name: CDC — Ship Sanitation Certificate information
    url: https://www.cdc.gov/port-health/php/maritime-guidance/ship-sanitation-certificate-information.html
  - name: USDA APHIS — Flighted Spongy Moth Complex
    url: https://www.aphis.usda.gov/plant-pests-diseases/flighted-spongy-moth-complex
  - name: 7 CFR § 330.400 — garbage from foreign countries
    url: https://www.ecfr.gov/current/title-7/subtitle-B/chapter-III/part-330/subpart-D/section-330.400
  - name: NYCEDC — South Brooklyn Marine Terminal offshore wind port
    url: https://edc.nyc/press-release/construction-underway-transform-sbmt-into-largest-us-offshore-wind-port
gatePassed: false
---
...
The framework is the Maritime Transportation Security Act and the Coast Guard regulations under it. [33 CFR Part 105](https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-105) covers facilities: which ones are regulated, the Facility Security Assessment and the written Facility Security Plan submitted for Coast Guard approval, the designated Facility Security Officer, the requirement to designate secure areas and control access to them, and the escalating measures at MARSEC Levels 1, 2 and 3. [Part 104](https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-104) does the equivalent for vessels, with a Vessel Security Plan, a Vessel Security Officer and designated restricted areas.
...
It is worth reading the definition of accompanied, because it is more demanding than people assume. [33 CFR 101.105](https://www.ecfr.gov/current/title-33/chapter-I/subchapter-H/part-101/subpart-A/section-101.105) defines escorting as ensuring that the escorted individual is continuously accompanied while within a secure area in a manner sufficient to observe whether the escorted individual is engaged in activities other than those for which escorted access was granted, accomplished by side-by-side companion or by monitoring depending on where access is granted. The same section defines a secure area as the area over which the owner or operator has implemented access control measures under a Coast Guard approved security plan, and restricted areas as those identified in a security assessment as requiring a higher degree of protection.
...
A credentialed contractor removes that constraint. It is not a marketing distinction. It is the difference between a programme that can go where the problem is and one that cannot.
...
On that second question, the credential that actually bears is the ACE, the Associate Certified Entomologist administered by the Entomological Society of America, which Ryan also holds. It requires, for a United States applicant without an entomology degree, a minimum of five years of verifiable pest management experience, a current pesticide applicator licence, professional references, adherence to a code of ethics and a passed examination on structural pest control and applied entomology, and it renews on a three-year cycle against continuing education. Ryan does not hold a degree; his father Arnold Katz, who founded the firm in 1983, holds the B.S. in Entomology from the University of Georgia. ACE exists precisely for the experienced practitioner in that position, which is why the experience requirement is where it is. Graduate is also a member of the National Pest Management Association and the New York State Pest Management Association, and those are memberships rather than certifications — a distinction this trade blurs constantly.
...
One further point belongs here because contractors misrepresent it. Ship Sanitation Control Certificates and their exemption equivalents, which replaced the older deratting certificates under the International Health Regulations, are issued in the United States only by the CDC as competent authority, with limited delegated authority to the Navy and Coast Guard for their own and certain government vessels. [CDC's own guidance](https://www.cdc.gov/port-health/php/maritime-guidance/ship-sanitation-certificate-information.html) is explicit that no port authority, public agency or private organisation is authorised to issue them here and that a certificate issued by a private company in the United States is not valid. Graduate does not issue them and cannot. Any firm suggesting otherwise is telling a vessel operator something that will not survive contact with a port health officer.
...
Take the physical environment first. A marine terminal typically presents rock armour or riprap along a bulkhead, which is among the best rat harbourage in existence — deep, dry, unreachable voids with water and food adjacent and no possibility of exclusion. It presents a quay apron with fendering, bollards, cable trenches and expansion joints. It presents cargo sheds with roll doors that are open through every working shift and were never specified to seal. It presents container stacks and, at any terminal with refrigerated boxes, a reefer rack area that is warm, sheltered, continuously powered and generates condensate. It presents a canteen and offices with ordinary domestic pressures. And it presents a boundary that in this harbour is frequently adjacent to residential streets, vacant lots, rail, or other terminals with their own conditions.

Then take the interface. When a vessel comes alongside, two rodent populations are connected by mooring lines, a gangway and a cargo operation. The standard mitigations are old and they work: rat guards on mooring lines, gangway lighting through the night, a watch that notices, and stores and freight checked before they go aboard. Guidance from harbour and vessel authorities has said the same things for decades — young rats disperse actively and will board a clean vessel from a dirty quay regardless of how well the vessel is kept. The direction of travel runs both ways, which is why a terminal that regards vessel rodent control as the ship's own business is only managing half of its problem.

This is the part of the work that is closest to Graduate's core trade, and it is worth saying where that expertise comes from rather than asserting it. Rodent exclusion is the centre of this business rather than one service among several, and Ryan Katz teaches it: for the Mexican pest management association ACPUB in Querétaro, where he also ran a field rodent safari taking more than a hundred members out to work, for the Pest Management Association of Nigeria, and as an invited speaker in the United States. Very few firms in this market are teaching rodent work to national associations abroad, and none of that is relevant to a terminal except in one respect — the diagnosis on a quay is a reading problem, and the reading is what separates sealing forty openings from sealing the four that matter.
...
Where a terminal handles food commodities and sits inside a customer's audit scheme, the expectations converge with those described under [food manufacturing and processing](/commercial/food-facility-ipm/) and [food safety and SQF programs](/commercial/food-safety-sqf/), and Ryan holds PCQI, HACCP and SQF credentialing on that side of the work, which means the conversation happens in the language the customer's own food safety plan already uses.
...
**Treating the vessel and the shore as separate problems.** They are connected by a gangway for as long as the ship is alongside, and a programme that addresses only one side is managing half a population.

**Rock armour treated as untouchable, therefore ignored.** It cannot be excluded, which is true, and it is therefore left out of the survey entirely, which does not follow. It can be monitored, understood, and used to explain why pressure concentrates where it does.
...
**Assuming the neighbour is irrelevant.** In this harbour, terminals sit against streets, lots, rail and other operators. Unexplained recurring exterior pressure reads as programme failure; explained recurring pressure with the evidence attached reads as a managed risk, and the difference is a paragraph.
...
Terminals with a food commodity operation should read [food manufacturing and processing](/commercial/food-facility-ipm/) alongside this page; those under a customer's certification scheme, [food safety and SQF programs](/commercial/food-safety-sqf/). Publicly owned port and waterfront property sits under [municipal, county and public facilities](/commercial/government-pest-control/), and terminal operators with warehousing or office portfolios elsewhere will want [property management](/commercial/property-management-pest-control/). The wider framework is on the [commercial pest management](/commercial/) hub, the physical discipline behind all of it is on [structural exclusion](/pest-control/structural-exclusion/), and where a facility is being built or converted — which describes a good deal of this waterfront right now — the cheapest version of the conversation happens before the walls close, under [exclusion consulting](/pest-control/exclusion-consulting/). Coverage is listed under [locations](/locations/), and [Ryan Katz](/ryan-katz/) sets out the credentials and the numbers behind them.

To begin, [get in touch](/contact/) with the facility, what it handles, and what the access arrangement is. An initial consultation costs nothing and is usually a phone call, because most of what shapes a terminal programme can be established that way. The written proposal and plan is billed as the deliverable it is, and where the facility proceeds, that fee comes off the cost of the project.
