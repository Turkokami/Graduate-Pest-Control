...
title: Co-op & Condo Boards
metaTitleCore: Co-op and Condo Board Pest Management
quickAnswer: >-
  In a New York City co-op or condo, the pest obligation sits with the corporation or the owner
  rather than with the shareholder who reported it. Because cockroaches and rodents travel through
  shared chases, risers and party walls, the durable fix is building-wide structural work,
  documented well enough to answer a complaint or an inspection.
metaDescription: >-
  In a NYC co-op or condo the pest duty runs to ownership, not the shareholder. Shared chases and
  risers make the fix building-wide, not unit-by-unit.
faqs:
  - question: Is the board or the shareholder responsible for pest control in an apartment?
    answer: >-
      Under the city's housing code the duty to address infestation in a multiple dwelling runs to
      ownership, which in a cooperative means the corporation. The proprietary lease or condominium
      bylaws then allocate repair costs internally, but that private allocation does not transfer
      the statutory duty to the resident. Take counsel on your building's documents.
  - question: Why does the board need to inspect apartments that have not complained?
    answer: >-
      Because complaints map who noticed, not where the population lives. A cockroach or mouse
      population inside a plumbing chase feeds in whichever apartment on that line is currently the
      easiest, so the quiet units above and below a reported one are the ones that tell you how far
      the problem actually runs.
  - question: Can we charge a shareholder for treatment if they caused the problem?
    answer: >-
      That is a question for the managing agent and counsel, because it turns on the proprietary
      lease, the bylaws and the house rules rather than on anything a pest contractor decides. What
      we can supply is the diagnostic finding — whether the population is living in a common element
      or inside the unit — so the decision is made on evidence.
  - question: What happens if a resident refuses to let anyone into the apartment?
    answer: >-
      Record it, in writing, every time. Note the date of the notice, the scheduled window, the
      refusal and the re-attempt. A building that tried repeatedly and was refused stands in a very
      different position from one that cannot show it tried, and a single closed unit on a stack can
      hold up work on the whole line.
  - question: Should building-wide pest work be a special assessment or an operating expense?
    answer: >-
      It depends on whether the work is a repair to common elements or a recurring service, and on
  ...
  - question: A shareholder is renovating. Does that affect the pest program?
    answer: >-
      ...
      afterwards. Boards can require penetration sealing and post-work inspection in the alteration
      agreement, which costs the building nothing and prevents years of recurrence.
  - question: Do co-ops on Long Island face the same obligations as those in the city?
    answer: >-
      The statutory frame is different outside New York City, and a Nassau or Suffolk board should
      confirm its position with counsel rather than assume the city codes apply. The building
      physics do not change. Garden-apartment complexes share attics, slabs and utility trenches,
      and pests move through them exactly as they move through a city riser.
sources:
