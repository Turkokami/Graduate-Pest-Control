...
metaTitleCore: Mosquito Management & Source Reduction
quickAnswer: >-
...
faqs:
  - question: How little water does it take to breed mosquitoes?
    answer: >-
      Far less than people expect. A bottle cap holds enough for the container-breeding species that
      cause most backyard biting, and a saucer under a potted plant is a fully functional nursery.
      The water only has to stand for about a week, which means most rain-filled objects qualify.
  - question: Do you fog the yard or run a barrier spray?
    answer: >-
      No. Fogging knocks down the adults present and leaves a residue that decays, while the larvae
  ...
  - question: How far do mosquitoes actually fly?
    answer: >-
      It varies enormously by species. The container breeders responsible for most daytime biting in
      a suburban yard tend to stay close to where they emerged — often within a few hundred feet —
      which is exactly why removing sites on your own property has a measurable effect. Some
      floodwater species travel much further.
  - question: When does the mosquito season start and end on Long Island?
    answer: >-
      Activity generally builds from late spring as temperatures rise, peaks through the humid part
      of the summer and continues into autumn until sustained cold ends it. Warm wet stretches
      produce noticeable surges roughly a week to ten days later, because that is the development
      time from egg to adult.
  - question: What can I do myself between visits?
    answer: >-
      Walk the property after every rain and tip out anything holding water, keep gutters clear and
...
## Why is mosquito pressure a drainage problem rather than a spraying problem?

Because every mosquito that bites you in your yard spent the first part of its life in water that was sitting somewhere, and most of the time that somewhere is on the property or immediately next to it.

A mosquito has four life stages. Egg, larva, pupa, adult. The first three are aquatic and completely immobile in the sense that matters — they are stuck in whatever puddle, gutter, saucer or container they hatched in. Only the adult flies. So the entire population that bothers you on a July evening was, seven to twelve days earlier, sitting in standing water within a fairly short distance of where you are standing.

That is an unusual and useful property for a pest. It means there is a bottleneck in the life cycle, and the bottleneck is a place you can physically go and look at.

Adult mosquito control works on the last stage — the one that flies, disperses, hides in dense foliage, and is continually replenished from water you have not touched. Larval control works on the stage that cannot go anywhere. A gutter holding water at a sag produces adults continuously all season; empty it and it produces none, permanently, with no reapplication and no residue. One of those interventions is a treadmill and the other is a fix.

This is the same reasoning that runs through the rest of our work. On a [carpenter ant](/pest-control/ant-control/) job the finding is usually that a member is wet; on a mosquito job the finding is usually that something on the property holds water for a week at a time. Different insect, same posture: look for the condition, not just the occupant.

It also means the survey matters more than the equipment. Anyone can run a mist blower around a property line. Working out that the actual production site is a corrugated drain extension buried under the mulch behind the garage takes an hour on foot with your eyes down.

## How little water does it actually take?
...
The obvious ones — the bird bath, the wheelbarrow, the kiddie pool — are usually already dealt with by anyone who cares enough to call us. The productive sites are the ones that do not look like water.

**Gutters.** The most consistently missed site on Long Island, by a distance. A gutter with debris at one end, or a sag between hangers, holds a shallow standing pond twenty feet long, out of sight, warm, sheltered and rich in organic matter. It is close to ideal habitat. Under mature oaks and maples on the North Shore, gutters fill fast and are often cleared once a year at most.

**Corrugated drain extensions and buried drain pipe.** Black flexible pipe is ribbed, and every rib holds water when the run is level or reverse-pitched — and most of them are, because they get laid by hand and settle. Buried corrugated pipe from a downspout to a pop-up emitter is the same story underground, and it is invisible.

**Tarps and covers.** Boat covers, grill covers, patio furniture covers, pool covers, tarps over a woodpile or over a project in the side yard. Anything with a wrinkle in it holds a puddle for weeks, and pool covers in particular can hold a genuinely large volume.
...
Not one insect but several, and the difference between them changes what will and will not work.

Broadly, the mosquitoes on a residential property here fall into two groups.
...
Practically, the mix on a given property tells us the ceiling. A wooded inland lot with heavy container breeding and no ditch nearby is a property where source reduction can make a large difference. A low waterfront lot backing onto marsh is a property where we will be honest that the achievable improvement is smaller and that a large share of the biting pressure originates on land we cannot touch.

## Why does adulticide fogging alone stop working so quickly?

Because it treats the flying stage, and the flying stage is being replaced daily from water it never touched.

Break down what a barrier or fogging application does. It kills adult mosquitoes present in the treated area at the time of application, and it leaves a residue on the foliage where mosquitoes rest during the day, which continues to affect some that land on it. That is a real effect and it is the reason these applications produce a noticeable improvement for a few days to a couple of weeks. We are not going to pretend otherwise.
...
## What is applied here, under what certification, and what will it not do?
...
**It cannot go in the water.** This is the constraint that decides the shape of the whole service. New York does not permit aquatic use of minimum-risk pesticides, because of the state's separate requirements for aquatic pesticide use. A practice working with exempt materials therefore has no lawful route to larvicide your ornamental pond, your dry well or the low corner that holds after every storm. That water has to be removed, drained, re-pitched, screened, circulated or engineered away, because treating it is simply not on the table.

That is not an inconvenience worked around quietly. It is the reason the survey is the service.

## What is larval source reduction, and how is it done?
...
**Engineer out what is left, and write down what cannot be.** Some water genuinely will not tip: a catch basin, a working drainage structure, a low area that holds after every storm. Because the state does not allow aquatic use of the exempt materials this practice works with, treating that water is not an option open to us, so the answer has to be physical. Re-pitch the run. Have the basin or dry well cleaned out until it drains as it was designed to. Cut a positive outlet. Screen the chamber. Put a pump on the feature so the surface never sits still. Where none of that is achievable, the site goes onto the written list as a known producer we cannot correct, named, with whose it is beside it — a street basin belongs to the county, not to you. A named uncorrected source is a more useful thing to own than a treatment interval nobody audits.

The maintenance side is where most of the value sits, and most of it is unpaid work you do yourself. Walk the property after every meaningful rain. Look down, and look behind things. Anything that has caught water gets tipped and, ideally, wiped out. That fifteen minutes a week is worth more than any single treatment we can sell you, and we would rather say so than not.
...
We would rather set that expectation in the first conversation than have it discovered in the second week of August. If your yard backs directly onto a marsh, we will tell you before you spend anything that the achievable improvement is real but partial. That is not a sales technique — it is the reason the client is still with us three years later.

## When does the season run, and what should be done when?
...
**Summer.** Peak. Development is fastest in the heat, and generations stack. Warm wet stretches produce a noticeable surge roughly a week to ten days later — that lag is the development time, and it is why the biting gets worse on a fine day several days after the storm rather than during it. This is when the maintenance visits and the weekly walk-around earn the most, and when a container missed in April has had eight generations to compound.

**Late summer and early autumn.** Populations remain high well past the point people expect, and the species composition shifts. Activity continues until sustained cold ends it, so a warm September holds pressure that a cool one does not.

**Autumn, after leaf fall.** The second high-leverage window, and the one that determines next spring. Clear the gutters again — this is the clearing that matters, because a gutter blocked by November leaves is a gutter full of water in April. Drain and store everything. Empty and invert containers. Pull the boat plug. Scrubbing the inside of the containers you are storing removes overwintering eggs from the walls, which is a small piece of work with a disproportionate effect on the following year.

Where drainage is the underlying fault, the fix belongs in the shoulder seasons rather than in July. And it is worth noticing that the same standing water and poor drainage that produces mosquitoes is frequently the same water keeping a sill plate or a band joist damp, which is how a mosquito survey turns into a conversation about [structural exclusion](/pest-control/structural-exclusion/) and the framing.

## How does this connect to the rest of the work?

Mosquito management is the outdoor, property-scale version of the same argument we make about buildings, and it sits alongside the rest of our [pest control services](/pest-control/).

It shares its root cause with [ant control](/pest-control/ant-control/), because the gutter overshooting at a corner is both a mosquito nursery and the reason the trim below it is soft enough for a carpenter ant colony to excavate. It shares its logic with [structural exclusion](/pest-control/structural-exclusion/), where the durable fix is a physical change to the property rather than a residue with a half-life. And the same clutter and drainage conditions in a side yard — stacked containers, dense ground cover against the foundation, standing water at the sill — are what make a property attractive to [rodents](/pest-control/rodent-control/) as well, so the two surveys tend to produce overlapping lists.

The property-by-property inventory behind this work — the leader extensions, the catch basins, the covers and saucers that hold no more than a cupful — is written up in [the standing water cluster](/blog/#cluster-standing-water) on our blog.

Graduate Pest Control has worked across Nassau and Suffolk since 1983, and the position has not changed since Arnold Katz founded it: understand what the property is doing before you treat what is on it. If your yard is unusable in the evenings and you would like a written list of what on it is producing mosquitoes, [get in touch](/contact/). More about [Ryan Katz](/ryan-katz/) and the [areas we serve](/locations/) is elsewhere on the site.
