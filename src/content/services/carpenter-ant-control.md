...
metaTitleCore: Carpenter Ant Control on Long Island
quickAnswer: >-
  Once termites are ruled out, carpenter ants become a search problem. The nest holding the queen is
  usually outdoors within a hundred yards of the house, and the galleries you can hear inside a wall
  are a satellite of it. Finding the wet timber that made both possible is the repair.
metaDescription: >-
...
faqs:
  - question: If the ants are in my wall, why are you searching the garden?
    answer: >-
      ...
      of cases. The wall holds older brood and workers. Treat only the wall and the outdoor nest
      restocks it.
  - question: How old is a colony that is producing flying ants?
    answer: >-
      Several years. Penn State puts the threshold at roughly 2,000 to 3,000 workers before a colony
      invests in winged reproductives at all, and those reproductives develop over the summer, sit
      in the nest through the winter and leave the following spring. Winged ants indoors are a
      statement about how long this has been running.
  - question: Why is treating the ant trail the wrong move?
    answer: >-
      Two reasons. University of Minnesota Extension is blunt that spraying foraging workers is
      ineffective because so little material reaches the nest. And the trail is the only map you
  ...
  - question: What time of night do you actually inspect?
    answer: >-
      ...
      you watch.
  - question: How dry does the wood have to be before they lose interest?
    answer: >-
      Penn State's working figure is that carpenter ants will not usually infest sound wood holding
      less than 15 percent moisture. That number is why a moisture meter is on the job and why the
      scope so often ends with a flashing detail rather than a treatment.
  - question: Do I have to open the wall to resolve this?
    answer: >-
      Often not. A located gallery can be treated through an opening smaller than a pencil, and the
      spoil, the sound and the moisture reading usually narrow a satellite to one or two stud bays
      first. Opening finished surfaces is a decision taken on evidence, and normally only where the
      wet member has to be replaced anyway.
  - question: How long before the activity stops?
    answer: >-
      Bait-led work on a colony network typically shows a falling trail count over two to four
      weeks, because the material has to be carried and shared before numbers drop. The carpentry
      that removes the water runs on its own schedule, and that is the half that decides whether we
      are back.
  - question: Is this the same job as the ant control page describes?
    answer: >-
      It is the narrow version of it. The ant control spoke covers every species we work on in this
      region and the method across all of them. This page is only the wood-nesting one, and it goes
      further into colony structure, the night survey and the moisture repair than a general page
      can.
sources:
  ...
  - name: University of Kentucky Entomology — Carpenter Ants (ENTFACT-603)
    url: https://entomology.ca.uky.edu/ef603
gatePassed: false
---
...
This page is the narrow version of a broader service. The general method across every ant species we work on in this region, including the budding species that must never be sprayed, is set out under [ant control](/pest-control/ant-control/), which is the parent for this page. Identification, biology and what the damage looks like when a member is opened are covered on the [carpenter ant](/pest-library/carpenter-ant/) profile in the pest library, and the insect most often confused with it has its own page under [eastern subterranean termite](/pest-library/eastern-subterranean-termite/).

The sealing half of the work is the same discipline described under [structural exclusion](/pest-control/structural-exclusion/), and the wet sill and open penetration that let ants trail onto a building are very often the same defects behind the [rodent control](/pest-control/rodent-control/) findings in the same report. Where a colony is in a commercial kitchen ceiling rather than a house, the documentation and monitoring framework sits under [commercial pest management](/commercial/). Everything we cover is listed on the [pest control services](/pest-control/) page, and the markets we work in are on [locations](/locations/).

If you have swept up shredded spoil twice in a fortnight and would like to know which member is wet, [tell us what you found and where](/contact/), and mention the month you first saw anything. That single detail changes where the survey starts. The way [Ryan Katz](/ryan-katz/) approaches this work is set out on his page.
