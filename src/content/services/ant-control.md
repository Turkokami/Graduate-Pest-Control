...
The nearest neighbor is [structural exclusion](/pest-control/structural-exclusion/), since the gaps ants trail through at sills, utility penetrations and siding terminations are the same gaps that admit everything larger, and the sealing half of an ant job is that discipline wearing a different name. On properties where the drainage is the underlying fault, the standing water that keeps the framing wet is frequently the same water driving [mosquito](/pest-control/mosquito-management/) pressure in the yard, so the two surveys tend to find each other. And where the wet framing has already opened a gap at the sill line, the [rodent control](/pest-control/rodent-control/) findings usually arrive in the same report.

The adjacent problem is termites. They follow the same moisture and soil-contact logic into the same members, and spring is the week they get confused with this insect at the same windowsill. On a termite job Graduate keeps the identification, the plan and the moisture work, and the treatment goes to a licensed operator we bring in. The [eastern subterranean termite](/pest-library/eastern-subterranean-termite/) profile is there to settle which one you have before anyone quotes anything.
