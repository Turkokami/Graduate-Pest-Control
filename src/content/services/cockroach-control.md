...
faqs:
  - question: How do I tell which cockroach I have?
    answer: >-
      Size and markings do most of it. A German cockroach is small, tan, and carries two dark
      lengthwise stripes on the shield behind its head. An American cockroach is much larger and
      reddish-brown with a pale margin on that shield. An oriental cockroach is dark, glossy and
      slower-moving, and the female's wings are stubs rather than full length.
  - question: Does having cockroaches mean my apartment is dirty?
    answer: >-
      Not in a multi-unit building. German cockroach pressure follows warmth, moisture and the
      plumbing chases that connect apartments, so a meticulously kept unit next to an untreated one
      gets them. Housekeeping affects how fast a population grows and how well control works, but it
      is rarely what started it.
  ...
  - question: How long does it take to clear a German cockroach infestation?
    answer: >-
  ...
  - question: What should I do before a cockroach service visit?
    answer: >-
      Clear under the sink and out of the lower cabinets near the plumbing, get food into sealed
...
## Which cockroach do you have, and why does the answer change the whole job?

Before anything else happens, we establish the species. It is not a taxonomic nicety. The species determines where the insects live, where they came from, whether the problem is your apartment's or the building's, and what the work consists of. Getting it wrong produces months of effort in the wrong place.

Three species account for nearly everything we see across New York City and Long Island.

**German cockroach**, *Blattella germanica*. Small — roughly half an inch as an adult — light tan to brown, with two dark parallel stripes running lengthwise on the pronotum, the shield-shaped plate covering the head. It has wings but does not meaningfully fly. It lives indoors permanently and does not survive outdoors in this climate. It is the species behind the overwhelming majority of serious residential and food-service cockroach problems, and it is the one that reproduces fastest. Females carry the egg case attached to the abdomen until it is nearly ready to hatch, which protects the eggs from almost everything applied to a surface and is a large part of why these infestations rebound.

**American cockroach**, *Periplaneta americana*. Much larger, often an inch and a half or more, reddish-brown, with a pale or yellowish margin around the edge of the pronotum. It flies, or at least glides, and it does so more readily in warm weather, which produces a memorable first encounter. It lives in warm, damp, dark places: sewers, steam tunnels, boiler and mechanical rooms, cellars, sub-slab voids, floor drains, grease interceptors and utility vaults. In a New York building the American cockroach in the ground-floor apartment is typically a visitor from that infrastructure rather than a resident of the apartment.

**Oriental cockroach**, *Blatta orientalis*. Dark brown to nearly black, glossy, an inch or so, slower and clumsier than the others. Females have short, non-functional wing stubs; males have wings that do not cover the abdomen. It prefers cool and damp rather than warm and damp: cellars, crawlspaces, drains, foundation voids, window wells, the space under a porch. It is the species most often behind an outdoor-to-indoor problem on a Long Island property with a wet cellar.

Two others appear occasionally. Brown-banded cockroaches turn up in warm, dry, elevated locations — the interior of electronics, behind picture frames, in upper cabinetry — which is a different search pattern entirely. Wood cockroaches wander in from outdoors and do not establish.

The practical divide is simple. German cockroach means an established indoor breeding population and, in a multi-unit building, a building problem. American and oriental cockroach usually means a structural and drainage problem — a route from below, from a sewer connection or a wet void — and the fix is largely about closing that route and drying the space.

## Why does German cockroach pressure track plumbing rather than housekeeping?

Because what the insect needs is warmth, moisture, a tight place to hide and a route between them, and a building's plumbing supplies all four at once.

Consider what a plumbing chase actually is. It is a vertical void running the height of the building, carrying supply lines, waste stacks and vent stacks, warmed by hot water and heating lines, humidified by condensation and the occasional slow leak, dark, undisturbed, and full of the pipe-to-surface junctions that a thigmotactic insect prefers. It also connects the kitchen and bathroom of every apartment stacked above and below one another. If you were designing habitat for *Blattella germanica* and a distribution network to go with it, you would design that.

Which is why the pattern of complaints in an apartment building so often runs vertically. Activity appears in the 3 line, then the 4 line, then the 2 line — the same stack, floor after floor — while apartments on the same floor in a different stack stay clear. Housekeeping does not distribute itself vertically through a building. Plumbing does.

The corollary is the part that matters to residents, and it is worth saying plainly: an immaculate apartment adjoining an untreated one will get cockroaches. A German cockroach needs very little to sustain itself — grease film behind a range, residue in a drain, the film on the underside of a dish rack, soap, glue on cardboard, crumbs in a floor joint — and a clean kitchen reduces the carrying capacity without removing it. Blaming the resident is both unfair and operationally counterproductive, because residents who feel blamed stop reporting, and unreported units are how a building's problem becomes permanent.
...
Working through a kitchen in the order we actually inspect it:

**Under and behind the sink.** The single most productive location in most apartments. The cabinet floor, the joint where the cabinet meets the wall, around the trap and the tailpiece, the escutcheons where supply lines pass through the wall, and the annulus around the waste line where it enters the wall. That penetration is very often the connection to the chase.

**The range and its surroundings.** Behind and beneath it, inside the burner assembly and control panel, the insulation of the oven, and the gap between the range and the counter or adjacent cabinet.

**The refrigerator.** The motor compartment and condenser coils at the back and underneath — warm, sheltered and rarely disturbed. The door gasket and the underside of the housing.

**Cabinetry.** Upper corners of cabinet interiors, the underside of shelves, hinge and shelf-pin holes, the toe kick beneath base cabinets, and the void behind the cabinet carcass.

**Small appliances.** The interior of microwaves, toasters, coffee machines and anything with a warm cavity.

**Structural detail.** The joint between counter and backsplash, loose or damaged tile, gaps at trim, the void behind a dropped soffit above the cabinets, and any hole cut for plumbing or electrical.
...
These are drainage and structure problems, and treating them as a kitchen problem is why they persist.
...
## Why does a multi-unit building need building-wide work?
...
The final component is the physical one. Where the structural work has been done — penetrations sealed, chases closed, leaks repaired, drains restored — the building is measurably harder to reinfest, and the monitoring interval can lengthen. Where it has not, monitoring is permanent, because the conditions that produced the first infestation are still there. That is the choice a building is really making, and it is the same choice described across the rest of this practice.

If you have cockroaches and want the species confirmed and the source found rather than the kitchen sprayed, [get in touch](/contact/). Tell us the building type, how many units are affected if you know, and where the activity is concentrated.
