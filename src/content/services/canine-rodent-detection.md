...
title: Canine Rodent Detection & Abatement
...
faqs:
  - question: Which dogs work this program?
    answer: >-
      ...
      bottom or under a deck, hard-wired to work below ground, and physically built for cover that
      would stop a larger dog at the edge.
  - question: What can a dog find that a person cannot?
    answer: >-
      Occupancy. A person reads a hole and has to guess whether anything is using it. A dog is
      working live scent, so an active system smells different from an abandoned one, and a burrow
      concealed under ivy, pachysandra or a low hedge registers to the dog even though nothing is
      visible above it. That is the whole advantage.
  - question: Is canine detection more accurate than a human inspection?
    answer: >-
      It answers a different question rather than the same question better, and we will not put a
      percentage on it because the figures circulating in this industry are not supported by anything
      you could check. What a dog contributes is speed over ground and the ability to work concealed
      cover. What a person contributes is interpretation.
  - question: Does the dog find every burrow on a property?
    answer: >-
      No inspection method finds everything, and any firm saying otherwise is overselling. Scent is
      affected by wind, ground temperature, recent rain, hard frozen surfaces and how recently an
      animal used a run. A survey is a picture of that property under those conditions, which is one
      of the reasons a second visit after the work is part of the plan.
  - question: What is abatement, as distinct from detection?
    answer: >-
      Abatement is the working removal that follows detection — the terriers doing the job they were
      bred to do, on burrow systems that have been located and confirmed. It reduces a resident
      population physically rather than chemically, which matters most on sites where toxicant use is
  ...
  - question: How is a canine inspection charged?
    answer: >-
      Inspections are billed per unit. This is a chargeable inspection service with a deliverable
      attached, not a free walk-around used to sell something else, and it is priced from the site
      because a hedge-lined estate perimeter and a bare commercial yard are not the same day's work.
  - question: Can the dogs work on a marine or port facility?
    answer: >-
...
## What does a terrier actually find that a person walking the property cannot?

Occupancy, and occupancy under cover.

A trained person surveying a property for rat activity is reading physical evidence: hole diameter, the shape and spread of the spoil at the entrance, smoothed runs through grass, rub marks where a run passes a hard edge, droppings, gnawing. That evidence is real and it is how the work has always been done. But it has two limits that no amount of experience removes.

The first is that a hole is ambiguous. A burrow entrance with soft, freshly turned spoil and a polished lip is obviously active. A burrow entrance with the spoil weathered flat, a few leaves across the mouth and no clear run leading to it might be abandoned, might be a secondary bolt hole in a system whose main entrance is thirty feet away, or might be in daily use by an animal that simply happens to be tidy. Deciding between those from the surface is a judgment call, and on a property with forty candidate holes it is forty judgment calls with a real error rate attached.
...
## Why do groundcover and landscaping defeat a visual burrow survey?
...
To survey that visually you would have to physically lift, part or cut back the cover, section by section, over the whole property. Nobody does. What actually happens on a visual inspection is that the accessible ground gets read properly and the covered ground gets a general assumption, and the general assumption is where the burrow system is.

A dog works the cover directly. A Patterdale is small, low and built to push into a hedge bottom, under a deck edge or through a mat of ivy, and it does not need to see the entrance to know an occupied system is under it. That is the specific gap this service fills. It is not a novelty and it is not a demonstration. It is the only practical method of surveying ground that has been roofed over by planting.
...
Anyone offering canine work of any kind should be asked who the handler is, what the dogs are trained on, and how the team works a site. That is a fair question to ask us and a fair question to ask anybody else.

## What is the difference between detection and abatement?
...
## How does a detection survey actually run on the ground?
...
**A joint interpretation at the end.** The map, the structural findings, the priority order and an honest statement of what could not be surveyed and why. Ground under a slab, sealed voids, an area of an adjoining property, standing water, frozen ground — where there is a limit, it goes in the report.

## How does what the dogs find turn into an exclusion plan?

By converting locations into a sequence of physical corrections with an order of operations attached — which is the only part of this that produces a permanent change.

The map is the input. What it usually shows is that activity is not evenly distributed and never was. It concentrates along a small number of corridors: a hedge line running the length of a boundary, a mulched bed against a warm foundation wall, the void behind a retaining wall, a run from a compost area to a service door, a stone terrace with hollow bedding adjoining a cellar entrance. Those corridors terminate somewhere, and one of the terminations is very often the building.

From there the plan splits into three kinds of work.

**Habitat correction.** Cutting groundcover back off the foundation and maintaining a clear, inspectable strip against the building. Thinning or lifting the base of hedges that adjoin the structure. Reducing mulch depth. Getting stored material, wood, pallets and unused equipment off the ground and away from the wall. Correcting drainage and standing water. None of this is landscaping work and we do not take it on as such — it is a set of findings the property's own grounds staff or contractor executes, and it is written specifically enough to be actioned.

**Structural exclusion.** The permanent half. Sealing where the runs actually terminate at the building: the sill junction, utility and line-set penetrations, service and cellar doors, vents and hatches, gaps at grade and any below-grade route. Custom-fabricated 26-gauge galvanized sheet metal, copper and stainless mesh, hardware cloth where an opening has to keep passing air, mortar and hydraulic cement at masonry, and Xcluder sweeps, fill fabric and below-grade barrier where a burrowing route has to be blocked. We do not use expanding foam in any role, because rodents chew straight through it and a foamed penetration stops being closed within the first year. The general principles are on the [structural exclusion](/pest-control/structural-exclusion/) page.

**Verification.** Re-survey after the work, under different conditions where possible. Ground that was frozen or saturated on the first visit reads differently later, and the point of a second pass is to check both the seal and the assumption.
...
**A habitat and housekeeping schedule.** The planting, storage, drainage and material conditions supporting the population, with the correction stated and the owner named where that is clear.

**The abatement record**, where abatement was carried out — what was worked and what the outcome was.

**A statement of limits.** What could not be surveyed, why, and what that means for confidence in the result. This is the section most inspection reports leave out and the one a careful client should read first.

**A recommended sequence and a re-survey point.** What to do first, what depends on what, and when to look again.

What is deliberately not in it is a percentage. We do not publish detection-accuracy figures and we do not repeat the ones that circulate in this industry, because there is no verifiable basis for them. What a working dog does is well established. What it does expressed as a number to one decimal place is marketing.

## Which properties get the most out of this work?

Sites with ground the eye cannot survey, or constraints that rule out the usual approach — usually both.

**Estate grounds and large residential properties.** Mature planting, extensive groundcover, hedging, terraces, retaining walls, outbuildings, pool structures, wood stores and compost. On the North Shore this describes a great many properties, and it is the classic case: a homeowner with a rodent problem, a landscape maintained to a high standard, and no visible explanation anywhere.

**Institutional campuses.** Schools, colleges, healthcare and religious campuses with dispersed buildings, long planted boundaries, courtyards, service yards and loading areas, and typically a strong preference for minimizing what gets applied outdoors around people. The surveyable ground on that kind of site is much smaller than the total ground.
...
Several things, and being clear about them is more useful than a claim.

**A dog does not tell you how many animals are present.** An alert on an occupied system is not a count. Population estimates come from the physical evidence, the extent of the systems, the runs and the history — and they remain estimates.

**A dog does not tell you what to do about it.** It resolves a question of fact. Everything downstream of that — whether this is one system or three, where it runs, why it is there, what the building has to do with it, what to correct and in what order — is interpretation and belongs to the people.

**A dog does not survey what it cannot reach.** Ground under slabs and hardstanding, sealed voids, interiors of structures that are not opened, and anything on an adjoining property outside the scope. Where a run leaves your boundary, the survey stops at the line and says so.

**Conditions affect the result.** Wind direction and strength, ground temperature, hard frost, heavy rain immediately before the survey, and how recently animals moved through an area all change what is available to work with. A survey is a picture of that site under those conditions.

**Detection is not a treatment.** Nothing about locating a population reduces it. That is what the abatement step and the structural work are for.

None of this makes the method weak. It makes it a specific instrument with a specific job, which is what you want in an inspection tool.

## How is this inspection arranged and what does it cost?

The initial consultation is free and is usually a phone call. Most sites can be scoped that way: the size and type of the property, what is planted and where, what has been seen and over what period, what has already been tried, and whether there are access or timing constraints.

**Canine inspections are billed per unit.** This is a chargeable inspection service with a written deliverable, not a free walk-around performed in order to sell something afterwards, and no rate is published on this site because a hedge-lined estate boundary and a bare commercial yard are not the same day's work. A written proposal and plan carries a service fee, and if you proceed with the project that fee comes off the cost of the work.

Timing is worth planning for. Late summer into autumn is the highest-value window, because that is when rodent pressure moves toward structures and a site corrected in September never acquires the autumn population indoors. Deep winter is workable but harder — frozen ground and hard surfaces change what scent is available and what the physical evidence shows. Immediately after heavy rain is the least useful day to survey.

Access requirements: the dogs need the ground itself, which means gates unlocked, other animals secured indoors, and somebody available who can open service areas, outbuildings and enclosures. Do not have the grounds cut back or tidied before the survey. The cover is the survey.

## Where does this sit alongside the rest of the work?

It is a diagnostic front end to the rodent practice, not a separate business.
