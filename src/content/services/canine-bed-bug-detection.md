...
metaTitleCore: Canine Bed Bug Detection & Inspection
quickAnswer: >-
...
metaDescription: >-
  ...
  spread, so treatment is scoped rather than guessed.
faqs:
  - question: What does NESDCA certification actually certify?
    answer: >-
      The National Entomology Scent Detection Canine Association certifies a handler and dog as a
      working team, assessed together against a defined standard rather than the dog alone. That
      distinction matters, because a dog is only as good as the person reading it. Certification is
      periodic, so the current certificate and its date are the things to ask for.
  ...
  - question: What happens if the dog alerts and nobody finds an insect?
    answer: >-
      It gets recorded as an unconfirmed alert and handled on its merits. A visual search of a
      cluttered occupied unit failing to find a small insect is entirely ordinary, so the sensible
      responses are a closer targeted search, interceptor monitors under the furniture legs, and a
      re-inspection on a set date. What we do not do is treat on an unconfirmed alert alone.
  - question: How much preparation does a unit need before an inspection?
    answer: >-
      Far less than a treatment needs, which is one of the reasons to inspect first. Rooms should be
      quiet, pets secured elsewhere, strong-smelling cleaning and air fresheners avoided for several
      hours beforehand, and floors clear enough for the dog to work the perimeter. Nothing should be
  ...
  - question: How is a canine inspection billed?
    answer: >-
      Per unit. That is deliberate — it lets a board or an operator scope an inspection ring
      precisely and expand it if the results warrant, rather than committing to a whole floor
...
## Which question does a canine inspection actually answer?

Not "do we have bed bugs." By the time anyone commissions an inspection, that has usually been settled by a resident, a guest, an exterminator or a laundry.
...
## What does NESDCA certification mean, and what should you ask for?

NESDCA is the National Entomology Scent Detection Canine Association, and it certifies a **handler and dog as a working team** — assessed together, against a defined standard, rather than certifying a dog in isolation.

That team framing is the useful part. A detection dog is a sensor, and a sensor is only as good as the person reading it. Handler skill is what determines whether a room is worked in a pattern that gives the dog usable air, whether the handler can distinguish a genuine trained final response from interest, curiosity or a dog reading its handler's expectations, and whether the search is repeated from a second direction when the first pass was compromised. A superb dog with a weak handler produces confident nonsense.

The trade has a credibility problem here and it is worth naming. Canine bed bug detection went through a period of rapid, largely unregulated expansion, and the marketing that came with it was full of accuracy percentages that nobody could trace to a study anyone had published. We do not repeat those figures. What is well established is that a properly trained and certified team, working a properly prepared room, is a fast and useful instrument. What is not established is any specific number, and a firm that leads with one is telling you about its marketing rather than its dogs.

What to ask any canine team, ours included:

**The current certificate, and its date.** Certification is periodic, not permanent. An expired certificate is a former certification.

**Who certified it, and is the handler named on it.** A certificate for the dog alone is a partial answer.

**What is the dog trained to alert on.** Live bed bugs and viable eggs. A dog that alerts on dead insects, cast skins and old fecal staining will find every unit that has ever had a problem, which is not the question you asked.

**How is the team maintained between certifications.** Ongoing proofing and blind training, not a certificate in a drawer.

**Will you inspect somewhere you were not asked to inspect.** A team that only ever alerts where the client already suspects a problem is worth thinking about carefully.
...
Further than the report suggests, and the reason is biological rather than negligent.

An infestation is quiet for a long time before it is noticeable. A small founding population feeds infrequently, hides in seams and voids, and produces very little that a resident would spot. Bites are the usual first signal and they are an unreliable one: reactions vary enormously between people, some individuals show nothing at all for weeks, and the marks are commonly attributed to something else entirely. By the time a person is confident enough to report it, the population has generally been established for a while and has had time to disperse.
...
By starting from the confirmed unit, working outward through adjacency, and letting the results set the boundary rather than deciding it in advance.

**The core.** The confirmed unit itself, inspected fully so the extent within it is understood — bedroom, living areas, upholstery and any furniture that has been moved around during the resident's own attempts to deal with it.
...
## What happens when a dog alerts and nobody can find an insect?
...
What we do not do is treat a unit on an unconfirmed alert alone. Treating unconfirmed units is how a four-unit scope becomes a twelve-unit scope, and it is how a board loses confidence in the inspection that produced it.

## How does scoping stop a building treating a whole line blind?

By replacing a precaution with a boundary, and the arithmetic is not subtle.

The blind approach treats the reported unit plus everything vertically and horizontally adjacent as a precaution — often a whole line, sometimes a floor. Every one of those units needs resident notification, preparation instructions, access coordination, the treatment itself, follow-up visits, and in occupied buildings a certain amount of complaint handling. The cost is not only the treatment; it is the disruption, the staff time, and the effect on residents who are now being told to bag their belongings because of somebody else's problem.

The scoped approach inspects the same ring first, at a per-unit inspection cost that is a fraction of a per-unit treatment cost, and treats only the units that come back confirmed. On most jobs that is a small number, because most reports are caught before the infestation has moved as far as the building fears.

There is a second benefit that arrives later. A blind treatment leaves you with no idea whether it worked, because you never established which units had a problem to begin with. Scoping produces a baseline, and a baseline makes the follow-up inspection meaningful: you know what you found, you know what you treated, and the re-inspection tells you whether the boundary held. Without that, "we treated the line and nobody has complained since" is the only evidence available, and it is not evidence.

For a board specifically, there is a governance dimension. A documented inspection with a defined scope, a stated method and a named certified team is a record of a considered decision. Deciding to treat eleven apartments on the basis of one complaint is a decision that is much harder to explain at a meeting. The broader picture of building-wide obligations is covered under [co-op and condo pest control](/commercial/coop-condo-pest-control/), and the portfolio version under [property management](/commercial/property-management-pest-control/).

## What should a unit look like before the team arrives?

Prepared enough for the dog to work, and otherwise left alone — which is a much lighter ask than treatment preparation, and one of the reasons to inspect first.

**Do not bag or move anything.** Moving belongings between rooms, bagging bedding, or carrying a mattress to the corridor spreads the problem and destroys the evidence about where it actually is. This is the single most common thing residents do before an inspection and it is the most damaging.

**Do not throw furniture out.** Discarded furniture in a corridor or a refuse area seeds the rest of the building, and the item may have been the only clear confirmation available.

**Do not treat it yourself first.** Over-the-counter products applied before an inspection disperse the population into voids and adjacent units, which makes both the inspection and the eventual treatment harder.
...
## What follows a confirmed detection?
...
**Follow-up inspection is part of the work, not an extra.** Interceptor monitors go in and stay in. A re-inspection is scheduled on a defined date, and the unit is not considered closed until it comes back clean. The full treatment picture, including how the insects behave and why unit-by-unit work fails in a shared building, is on [bed bug treatment](/pest-control/bed-bug-treatment/), and the species detail is in the [bed bug](/pest-library/bed-bug/) library entry.
...
Within those limits it remains the fastest way to establish a boundary across a set of units, and there is no non-canine method that covers the same ground in the same time.

## What does a board or an operator receive in writing?

A record that can be put in front of a meeting, a brand auditor or an insurer without further explanation.

**A unit-by-unit result schedule.** Every unit inspected, the result for each — confirmed, unconfirmed alert, or no indication — and the areas covered within it.

**Alert locations described specifically.** Not "bedroom" but the seam, frame, item or junction, with the physical confirmation noted where one was obtained.

**The team and the standard.** Who handled, which dog, and the certification held with its date.

**Access exceptions.** Any unit that could not be entered, any room that could not be worked, any preparation failure, and what each of those means for the result. This section is not padding; it is the honest boundary of the inspection.

**A recommended scope and sequence.** Which units to treat, which to monitor, which to re-inspect and when.

**A monitoring and re-inspection plan** with dates on it.

For hospitality operators, the same package supports the documentation obligations described under [hotels and hospitality pest control](/commercial/hotels-hospitality-pest-control/), where the reputational stake around a single confirmed report is the reason proactive inspection cycles exist at all.

## How often should a building or property re-inspect?

It depends on turnover and history, and it is worth setting a cycle rather than reacting to each event.

**Buildings with a current incident** should re-inspect the treated units and the immediate ring on a defined schedule until two consecutive rounds come back clean, with monitors in place throughout.
...
With a phone call, which is free, and with the facts about the report you already have: how many units have reported, over what period, where they sit relative to each other, what has already been treated and by whom, and whether anyone has moved furniture between units.
