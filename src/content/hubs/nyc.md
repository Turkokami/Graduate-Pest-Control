---
slug: nyc
title: Pest Control in New York City
metaTitleCore: New York City Pest Control
quickAnswer: >-
  In a New York City building the pest pathways are internal and vertical. Plumbing chases, steam
  risers, party-wall joist pockets, compactor chutes and cellar drain lines connect every apartment
  to every other one, so treating a single unit relocates the population rather than removing it.
  The work that holds is building-wide.
metaDescription: >-
  New York City pest control for shared-wall buildings, where chases, risers, joist pockets and
  cellar drainage carry pests between every unit.
faqs:
  - question: Why does treating a single apartment not solve the problem?
    answer: >-
      Because the building, not the apartment, is the unit the population occupies. Multi-unit
      housing research finds pests disperse from high-density units into units next to them or
      otherwise structurally continuous with them. Reduce the count behind one door and the remainder
      redistributes along the same chase, usually within weeks.
  - question: What is the most commonly missed rodent route in a city building?
    answer: >-
      The cellar drainage. Rats frequently enter from below through deteriorated house traps and
      broken or disconnected drain lines, and that route is invisible from the street and untouched
      by exterior baiting. It is why a building can be treated on a schedule for years while the
      population under it stays stable.
  - question: What does Local Law 55 require of a multiple dwelling?
    answer: >-
      Owners must investigate every dwelling unit and common area at least annually and whenever a
      complaint arises, then remediate using integrated pest management — removing nests and debris
      by HEPA vacuuming, sealing openings so gaps are a quarter inch or less, and eliminating water
      sources. Pesticide use does not substitute for those measures.
  - question: Do co-ops and condos have to file a bedbug report?
    answer: >-
      Yes. Owners of multiple dwellings, including cooperatives and condominiums, file a bedbug
  ...
  - question: Which New York City neighbourhoods do you cover in depth?
    answer: >-
      ...
      Tribeca, SoHo, NoHo, Greenwich Village, Flatiron and NoMad, Hudson Yards, Central Park South,
      the Upper West Side, Williamsburg, Dumbo, Cobble Hill, Astoria, Whitestone and Malba.
  - question: Can a resident fix a building-wide problem on their own?
    answer: >-
...
sources:
  ...
  - name: NYC HPD — Bedbug Annual Report FAQ
...
## What makes pest control in New York City a different job?
...
That is the whole of the difference, and it produces a specific and very common failure. A resident reports a problem. A technician attends, applies material, and the problem in that apartment stops. Within weeks it reappears there or turns up next door, above, or below. Nothing was done badly. The treatment acted on the animals in one volume of air while the population occupying the building carried on, and the pressure applied in one place simply redistributed it.

Research on proactive integrated pest management in multi-unit housing describes the mechanism directly: pests disperse from high-density units into units next to them or otherwise structurally continuous with them. In the same work, several of the most severe infestations were only found because every unit was being monitored, rather than only the ones that had complained. Complaint-driven service maps tolerance, not infestation.

The conclusion that follows is not a sales position, it is arithmetic. In a shared-wall, shared-riser building the only intervention that changes the outcome is one applied to the building. Everything else is maintenance of a steady state.

## How do pests actually move through a New York building?
...
**Pre-war elevator apartment houses, roughly 1900 to 1940.** Masonry shells with floors framed into them, generous plans, steam heat and vertical service runs threaded up through the structure. These are the buildings where chase sealing pays the largest dividend, because the chases are long, warm and continuous.

**Post-war and mid-century blocks.** Many of these replaced tenement rows — on the Upper East Side, high-rise construction began arriving in the 1950s after the elevated railway came down. Compactor chutes, central refuse rooms and larger service cores are standard, and those systems become the dominant internal pathway.
...
## What does the law require of a New York City building owner?

Four obligations that a board or managing agent should be able to describe from memory.

**The Housing Maintenance Code** places the duty to keep a dwelling free from rodents, insects and other pests on the owner, and requires extermination where an infestation is present. That duty does not turn on who reported the condition or how the building allocates cost internally. Full treatment at [NYC Housing Maintenance Code — extermination and rodent eradication](/compliance/nyc-housing-maintenance-code-pests/).

**Local Law 55 of 2018**, the Asthma Free Housing Act, converted a reactive duty into a scheduled one. Owners of multiple dwellings must investigate dwelling units and common areas at least annually and whenever a complaint arises, and must remediate using integrated pest management: physically removing pest nests and debris by HEPA vacuuming, sealing entry points so gaps are reduced to a quarter inch or less, and eliminating the water sources pests depend on. The law states plainly that pesticide use does not substitute for those measures, and that where pesticides are applied a licensed professional must do it. Full treatment at [NYC Local Law 55](/compliance/nyc-local-law-55/).

**The bedbug annual report** is a separate filing made with HPD between 1 and 31 December each year by owners of multiple dwellings, including co-ops and condominiums, under Housing Maintenance Code sections 27-2018.1 and 27-2018.2. It reports the total number of dwelling units, the number infested, the number where eradication occurred and the number reinfested after treatment, aggregated for the whole building. The filing receipt must then either be given to occupants at lease commencement or renewal, or posted in a prominent public location.

**Pesticide notification** governs how and when residents are told before material is applied. See [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/) for the city rule and [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/) for the state one, with [New York State pesticide applicator requirements](/compliance/nys-pesticide-applicator-requirements/) covering who may lawfully apply.

Boards and managing agents will also want [co-op and condo board obligations](/compliance/coop-condo-board-obligations/); owners letting units, [landlord and tenant pest responsibilities](/compliance/landlord-tenant-pest-responsibilities/); and anyone comparing proposals, [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/).

## Which New York City markets do we serve?
...
The wider service area covers Tribeca, SoHo, NoHo, Greenwich Village, Flatiron and NoMad, Hudson Yards, Central Park South and the Upper West Side in Manhattan; Williamsburg, Dumbo and Cobble Hill in Brooklyn; and Astoria, Whitestone and Malba in Queens. The complete list is on the [service areas page](/locations/).

## How should a board or managing agent buy this work?
...
Sequence matters as much as scope. Reduce the existing population, correct the conditions, seal the routes, then verify. Sealing a building that still holds an active population removes the animals' route out and concentrates them in the wall voids, which is worse than the situation you began with.

## What can a resident actually do on their own?

A useful amount, and it is worth setting out honestly rather than pretending either that residents are powerless or that they can fix a building.

**Seal what is inside your own walls.** The openings around a supply line where it enters a wall, the gap behind a radiator riser, the unsealed penetration under a sink, the void behind a cabinet toe kick and the gap where a waste pipe passes through a floor are all inside your apartment and all yours to close. Packed mesh with a sealant over it holds; sealant alone does not, and cured foam is chewed straight through whatever it is sitting behind.

**Fix the water.** A dripping trap, a sweating cold line, a slow shower drain and a leaking radiator valve are the reasons a population chooses your apartment over the one next door. Insects need water more urgently than they need food, and removing it changes the local arithmetic quickly.
...
## How does this compare with our Long Island work?

Same principle, entirely different surfaces — and it is worth understanding both if you own property in each.

On Long Island the building is a closed envelope with one owner. The pathways are the sill plate junction, the utility penetrations, the garage door corners, the soffit returns and the weep holes, and behind almost all of it is water arriving from a gutter, a grade or a flashing detail. The work is done from a ladder and a crawlspace, it is finite, and once it is done properly it holds for years without a schedule. The regional detail is set out on the [Long Island hub](/locations/long-island/), with market pages for [Huntington](/locations/huntington/), [Great Neck](/locations/great-neck/), [Manhasset](/locations/manhasset/), [Port Washington](/locations/port-washington/) and [Garden City](/locations/garden-city/).
...
The urban calendar is flatter than the suburban one, but it is not featureless.

**Late summer into autumn** is the rodent window everywhere, and in the city it is when cellar, drainage and refuse work pays best. A building closed before the first cold nights does not take on a winter population.

**Winter** drives insects indoors and makes the vertical routes findable, because the heating is running and the warm columns are exactly the paths the animals prefer. Heat loss also becomes legible in January, and the places a building loses warmth are very often the places it admits animals.

**Spring** is the masonry season. A winter of freeze-thaw cycling records itself in spalled brownstone, open joints, failed sills and damaged cornices, and correcting those removes the moisture driving concealed insect activity later in the year.

**Summer** is for roof and exterior work — parapets, bulkheads, cornice returns and terraces — and for the source reduction that keeps mosquito pressure down in gardens and on roofs.

Regardless of season, evidence is worth acting on the week you see it. In a shared-riser building the interval between one apartment and four is measured in weeks, not seasons.
...
If you would like a straight reading of what your building is doing and where its pathways run, [get in touch](/contact/). The [pest control index](/pest-control/) lists the services in full, and [commercial pest management](/commercial/) covers boards, managing agents, restaurants, hotels and food facilities.
