...
faqs:
  ...
  - question: Does NPMA or NYPMA membership certify anything?
    answer: >-
      ...
      examination. They buy technical resources, model contract language, legislative tracking and,
      through NYPMA, DEC-certified training that carries recertification credits. This site keeps
      them separate from the certifications and never records them as credentials in its structured
      data.
  - question: Is Graduate Pest Control SQF certified?
    answer: >-
...
sources:
  ...
  - name: Transportation Security Administration — TWIC
    url: https://www.tsa.gov/twic
  - name: SQF Institute — SQF Food Safety Code for Food Manufacturing
...
Because the question a serious buyer asks is not "are you good at this" but "who am I actually hiring, and what can I check."

Those are different questions and only one of them can be answered honestly on a website. Any firm can describe itself as experienced. Very few will print a number a stranger can take to a state agency, and fewer still will say what a certification required before it was awarded, because the requirement is usually the least impressive part of the story.
...
Because a company and a person are licensed separately in New York, and confusing them is the single most common way a buyer ends up unable to check anything.

**Graduate Pest Control, Inc. holds New York pesticide business registration 03298.** This is the company's registration to operate as a pesticide business in the state. It attaches to the firm.

**Ryan Katz holds New York certified applicator C1822141, in categories 7A, 7F and 8.** This is a personal certification, held by an individual, and it is the one governing what may lawfully be done at your property.

The categories describe scope, and scope is the useful part:

- **7A** — structural and rodent control. The larger share of the practice, and the category behind the exclusion and rodent work.
...
## What is PCQI, and what does it let a contractor do?

PCQI stands for Preventive Controls Qualified Individual, and unlike most items on this list it is not a badge awarded by an association — it is a role defined in federal regulation, at **21 CFR 117.180**, under the Food Safety Modernization Act.

The regulation is specific about what a PCQI does or oversees:

- preparation of the food safety plan;
- validation of the preventive controls;
- review of monitoring records and corrective-action records;
...
**Safe Quality Food** is administered by the SQF Institute, a division of FMI, and it is benchmarked against the Global Food Safety Initiative. Its codes now run to Edition 10 and cover manufacturing, storage and distribution, packaging, primary production and more, across thousands of certified sites worldwide. Certification is granted after audit by a licensed certification body, and a certified site is required to have a qualified SQF practitioner.
...
**HUET** — helicopter underwater escape training. Offshore platforms and rigs are reached by helicopter over water, and current escape training is a condition of boarding the aircraft. It is trained practically, in a simulator, and refreshed on a schedule. **Tier 1 offshore is also held.**

Neither of these says anything about competence with rodents, and neither is presented here as though it did. What they say is that this practice has spent years working in environments where access is controlled, materials are logged, documentation is checked before work starts and improvisation is not available. That standard then arrives unchanged at a co-op cellar in Manhattan, which is the actual argument for listing them.

## What is RelyOn, and why is a platform on a credentials list?

**RelyOn Nutec** is a global safety and competence training business, headquartered in Copenhagen, working across safety-critical industries. Alongside training delivery it runs digital systems that track workforce training, compliance and competence.

It appears here because it is the **verification layer** for the offshore and industrial credentials above. An operator checking a contractor at a gate or a heliport does not want a laminated card and a claim; it wants a live record it can query. That is what the platform provides, and it is how those credentials are actually checked in the field.

The boundary is straightforward: RelyOn is a training and verification platform, not a certifying body for pest management, and nothing about pest control competence follows from being on it. It is included because a page about verification that left out the mechanism of verification would be an odd page.

## NPMA and NYPMA: what does membership buy, and what does it not prove?
...
## Teaching abroad, and why it belongs on this list
...
If this page is useful beyond our own file, it is because the same five questions can be put to anybody bidding against us.
...
If you are assembling a vendor file, everything above is verifiable today and the numbers are printed in full for that purpose. If you are earlier than that and simply want to know how the work is approached, the practitioner's own account is on [Ryan Katz](/ryan-katz/), the regulatory pages sit under [commercial and compliance work](/commercial/), and the two disciplines this practice is built on are set out under [rodent control](/pest-control/rodent-control/) and [structural exclusion](/pest-control/structural-exclusion/).

The consultation is free, and most cases can be narrowed considerably on a phone call before anybody visits a site.
