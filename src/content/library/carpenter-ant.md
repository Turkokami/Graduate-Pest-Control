...
slug: carpenter-ant
title: Carpenter Ant
metaTitleCore: Black Carpenter Ant Identification & Damage
quickAnswer: >-
  Carpenter ants hollow galleries in wood to live in it, not to eat it, and they pick timber that has
  already been weakened by damp. Indoors on an older Long Island frame house, a trail usually leads
  back to a leaking flashing detail, a wet band joist or a porch column standing in water.
metaDescription: >-
  Carpenter ants hollow galleries in damp wood to nest, not to feed. A trail indoors on a Long Island
  house usually leads back to a moisture fault.
faqs:
  - question: How big is a carpenter ant compared with the ants in my kitchen?
    answer: >-
      Noticeably bigger, and the range within one colony is itself a clue. Carpenter ant workers come
      in a spread of sizes rather than one standard size, so a line of ants where some are obviously
      larger than others is a strong hint. The small uniform ants along a countertop are almost
      always a different species entirely.
  - question: Is a single carpenter ant indoors a problem?
    answer: >-
      Usually not by itself. Foragers travel a long way and one wandering in through a door is
      ordinary. What matters is repetition and timing — the same route used night after night, or any
      sighting in the middle of winter, both of which suggest the colony is inside the heated part of
      the building rather than out in the yard.
  ...
  - question: What is the difference between the sawdust they make and ordinary sawdust?
    answer: >-
      Content and shape. Carpenter ant spoil looks shredded and fibrous, like fine pencil shavings
      rather than powder, and it usually carries insect fragments and shed brood skins mixed through
      it. Contractor sawdust is uniform, and the flour-fine powder that some wood-boring beetles
      leave is finer than either.
  - question: Do carpenter ants sting?
    answer: >-
      They do not have a functional sting, but a large worker can deliver a genuinely sharp bite and
      then spray formic acid into the wound, which is what makes it burn afterwards. It is unpleasant
      rather than dangerous for most people, and it is not a reason to treat a colony — the damp wood
      is the reason.
  - question: Can they damage a house as badly as termites?
    answer: >-
      Rarely as fast, but a long-established colony in a member that was already rotting can leave
      very little sound wood behind. The honest framing is that carpenter ants and decay fungi are
      usually working on the same wet timber, and the total loss is the sum of both, not the ants
      alone.
  - question: The ants disappeared after I sprayed. Why did they come back in spring?
    answer: >-
      A surface application kills the workers that walk over it, and workers are the replaceable part
      of a colony. The queen and the brood sit inside a gallery that no residue reaches, so the
      colony rebuilds its foraging force and the wet timber that drew it there in the first place is
      unchanged.
  - question: Should I open the wall to find the nest?
    answer: >-
      Not on a hunch. Tapping the member, listening at a quiet wall late in the evening and locating
      the spoil beneath a gallery opening will usually narrow it to a bay or two first. Opening
      finished surfaces is sometimes the right call, but it should follow the evidence rather than
      substitute for it.
...
Then look at the profile from the side, which is the check that professionals actually use. On a carpenter ant, the upper surface of the thorax runs in one smooth, even curve from the neck to the waist, with no dips, humps or spines. That evenly arched back separates it immediately from the [pavement ant](/pest-library/pavement-ant/), which carries a pair of small spines at the rear of the thorax and has a visibly uneven outline, and from the [odorous house ant](/pest-library/odorous-house-ant/), whose thorax has a distinct dip in the middle of it.
...
The winged reproductives cause the most confusion, because they appear in spring at the same windows as termite alates. The ant version has the pinched waist, elbowed antennae and a front pair of wings clearly longer than the back pair. The comparison is set out fully under the [eastern subterranean termite](/pest-library/eastern-subterranean-termite/) profile, and it is worth doing carefully, because the two insects lead to entirely different work.
...
**Correction.** The flashing, the gutter, the grade, the crawlspace, the rotted section replaced. This is where the recurrence is decided, and it is why an ant proposal from us sometimes reads like a carpentry scope. Where the sealing element is substantial it belongs under [structural exclusion](/pest-control/structural-exclusion/) in its own right.
...
Treatment for this species sits under [ant control](/pest-control/ant-control/), which covers method, materials and the moisture investigation in detail.

The two profiles worth reading alongside it are the [eastern subterranean termite](/pest-library/eastern-subterranean-termite/), for the spring identification problem and because the two insects exploit the same wet framing from different directions, and the [odorous house ant](/pest-library/odorous-house-ant/), which is the species most often misidentified as a small carpenter ant and which needs an almost opposite approach — patient baiting rather than anything that disturbs a trail.

If you have found fibrous spoil under a windowsill or a beam and want to know what is wet above it, [contact us](/contact/) with a photograph and the location in the building. The areas we cover across Nassau, Suffolk, Manhattan, Brooklyn and Queens are listed under [locations](/locations/).
