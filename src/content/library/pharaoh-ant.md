...
slug: pharaoh-ant
title: Pharaoh Ant
metaTitleCore: Pharaoh Ant Identification & Why Not to Spray
quickAnswer: >-
  The pharaoh ant is a very small pale yellow ant that cannot live outdoors in this climate, so a
  colony indoors is permanent until it is baited out. It has many queens, nests in warm wall voids
  along pipe runs, and splits violently if sprayed. Bait is the only correct approach.
metaDescription: >-
  The pharaoh ant is a tiny yellow indoor-only ant with many queens. It nests in warm wall voids
  along pipe runs and must be baited, never sprayed.
faqs:
  ...
  - question: Why is spraying them such a serious mistake?
    answer: >-
      Because the colony responds to repellent pressure by fragmenting. Groups of workers carrying
      brood and queens break away and start new nests elsewhere in the building, so a single treated
      site becomes several untreated ones spread further through the structure. With this species the
      effect is fast, reliable and very hard to reverse.
  - question: Do they swarm like other ants?
    answer: >-
      No, and this is one of the reasons they are so persistent. Mating happens inside the nest
      rather than on a flight, so there is no seasonal swarm to alert anyone and no dependence on
      outdoor conditions. The colony simply grows and divides indoors, year round.
  - question: Are they dangerous in a hospital or a care setting?
    answer: >-
      They are taken seriously there for good reason. The ants are small enough to enter dressings,
      sealed packaging and equipment, they are drawn to wound fluid and to intravenous lines, and
      they travel from soiled areas to clean ones. That is a contamination pathway, and it is why
      healthcare facilities treat a sighting as an incident.
  - question: Can I use a store-bought ant bait on them?
    answer: >-
      It is unlikely to help and it can do harm. Consumer products often pair a bait with a repellent
...
Method, materials and the ant identification process are covered under [ant control](/pest-control/ant-control/), which is the parent service for this profile.

The profile to read next to it is the [odorous house ant](/pest-library/odorous-house-ant/), which buds under pressure in the same way but is far less extreme about it and can live outdoors, and the [pavement ant](/pest-library/pavement-ant/), which shares the two-segmented waist and is the species most often mistaken for this one by size alone. For buildings where the concern is shared voids and vertical spread generally, the [German cockroach](/pest-library/german-cockroach/) profile covers the same structural pathways from a different angle.

If you have very small pale ants in a residential building, a hotel, a food operation or a care setting, [get in touch](/contact/) and describe where the activity is and what has already been applied. That second detail matters more than usual. Where we work is set out under [locations](/locations/).
