...
slug: norway-rat
title: Norway Rat
metaTitleCore: Norway Rat Burrows and Entry Routes
quickAnswer: >-
  The Norway rat is a heavy, blunt-nosed brown rodent that burrows at ground level and swims through
  sewer lines. In New York buildings it usually arrives from below — through a failed house trap or a
  cracked cellar drain — rather than across the sidewalk, so the correct fix is very often a plumbing
  repair.
metaDescription: >-
  The Norway rat burrows at grade and swims sewer lines, so city buildings are often entered from
  below through a broken cellar drain line.
faqs:
  - question: How do I tell a Norway rat from a roof rat?
    answer: >-
      Body shape and tail length settle it. A Norway rat is thick-set and low-slung, with small ears
      and a tail shorter than its head and body combined. A roof rat is slimmer, with larger ears and
      a tail longer than its body. The Norway rat is the one established across New York City and
      Long Island.
  ...
  - question: Why did bait stations along my sidewalk not stop the sightings inside?
    answer: >-
      Because exterior stations act on the exterior population, and a large share of interior rat
      activity in city buildings originates underneath the cellar floor. If a drain line is broken or
      a house trap has failed, the sewer is continuous with the building and no amount of perimeter
      work reaches it.
  - question: What does an active rat burrow look like?
    answer: >-
      A smooth, roughly circular opening at the base of a foundation, a slab edge, a shed or a
      planting bed, with loose soil fanned out in front of it and a polished, hard-packed run leading
      away. An abandoned burrow silts up, grows over and collects leaf litter and cobweb across the
      mouth.
  - question: Do rats really need to drink every day?
    answer: >-
      They need water far more than mice do, and that requirement is a diagnostic tool. Rat activity
      concentrates where water is reliable — condensate lines, a leaking supply pipe, a wet cellar
      corner, a floor drain, a pet bowl left out. A dry building is much harder for them to hold.
  ...
  - question: Should I be worried about disease from rats?
    answer: >-
      Rats are associated with pathogens that public-health agencies take seriously, and droppings,
      urine and nesting material should be handled with care rather than swept dry. Questions about a
      specific exposure, bite or illness belong with a physician or your local health department
      rather than with a pest control company.
...
## How do you know it is a Norway rat rather than something else?
...
## How does a Norway rat actually live, and how far does it range?
...
**It swims and it climbs, in that order of preference.** Norway rats are strong swimmers, comfortable in flowing water and entirely at home in a sewer lateral. They climb well enough to use a rough masonry wall, a downspout, a vine or a pipe run, but they do it less readily than a mouse and they prefer to stay low.

**It is social and ranked.** Colonies have a dominance structure, and subordinate animals are pushed to the poorest feeding times and the most exposed routes. That is why a rat seen in daylight is a meaningful observation rather than a curiosity: it usually indicates that the population has outgrown the safe hours and the safe routes.

**It is wary of change.** A new object introduced into an established travel route is avoided, sometimes for several days. Anything that resolves a mouse problem in a week may take considerably longer here, and impatience in the first days of a rat job is the most common reason it is abandoned before it works.

**Its range is small.** A Norway rat generally lives, feeds and nests within a short distance of its burrow, which is why the source of a persistent problem is nearly always on the property or immediately adjacent to it rather than somewhere abstract and distant.

## Why do rats in a New York City building so often come from underneath?

Because in a dense city the drainage system is habitat, and the building's connection to it is a door that has been quietly failing since the last renovation.

Norway rats occupy sewer lines comfortably. The system supplies food, shelter, a stable temperature and unhindered movement between blocks and buildings. What normally separates the interior of a building from all of that is a set of plumbing components: trapped fixtures holding a water seal, sound cast-iron or clay laterals, and on older buildings a house trap in the cellar floor that provides a further physical barrier. Every one of those components fails in a predictable way.

House traps crack under slab movement, get rodded out during a blockage and left uncapped, or are removed during a repair and never reinstated. Cellar drain lines fracture as fill settles beneath them. Floor drains in boiler rooms, laundry rooms and old shower stalls dry out over months of disuse and lose the seal entirely. Abandoned lines from a removed fixture get closed with a temporary plug that survives a decade and then does not. Sidewalk vaults and areaway drains connect to the same system and are inspected by almost nobody.
...
## What does the rat year look like on a Long Island property?

Less dramatic than the city version and more tied to the ground, the weather and whoever is digging nearby.

**Spring.** Burrow systems that held through the winter become active again as the soil warms and vegetation provides cover. Breeding picks up. This is the point at which activity around a foundation line, a shed base or a deck skirt becomes visible, and it is the cheapest moment of the year to deal with it, because the population is at its low point and the burrows are still few enough to count.

**Summer.** Food is abundant and largely outdoors — vegetable beds, fallen fruit, birdseed, pet food, compost, and refuse that gets set out earlier and left longer in warm weather. Populations expand through the season. Rats are often perfectly comfortable living entirely outside the structure at this point, which is why a homeowner can have an established colony under a deck for months and never see one indoors.

**Late summer into autumn.** The turn. Cooler nights, harvested gardens and thinning cover make the exterior less viable, and the building becomes the warmest and driest option available. Pressure on the envelope rises sharply. Nothing about the house changed between August and October — the openings were there all along — but the incentive to test them changed. This is when a summer of exterior activity becomes an interior complaint.

**Winter.** An established interior population lives, feeds and breeds inside, expanding into cellar voids, crawlspaces, chases and the space beneath a settled slab. This is the hardest and most invasive time to do the work, because there is a resident population to bring down before any part of the building can be closed.
...
## What is actually at risk when rats become established?
...
**Gnawing.** Fresh work on weathered wood is pale against the surface around it and darkens over subsequent weeks, so an entry point being actively enlarged looks visibly different from one worked on last year. The paired incisor grooves are broad compared with a mouse's fine parallel marks.
...
## How is a rat population actually brought down?

Reduce first, seal second, verify third — and the first step is slower and more deliberate than it is with mice.

**Work out where they are coming from before anything else.** In a city building that means the drainage: the house trap, the cellar lines, the floor drains, the sidewalk vault, the areaway. In a suburban property it means the soil: the burrow map around the foundation, under the deck, behind the shed, in the ivy bank, along the retaining wall. Placing devices before that map exists produces activity without progress.

**Account for neophobia.** Rats avoid unfamiliar objects in familiar routes. Devices are introduced into travel routes and given time to become part of the furniture before they are expected to perform, rather than being set the moment they are placed. This is the discipline that separates a rat job that works from one that stalls, and it is why the first week is often deliberately quiet.

**Trapping leads the interior work.** Inside an occupied building — a cellar, a boiler room, a restaurant back-of-house, a residential unit — an animal you can remove is preferable to one that dies inside a wall or under a slab where you cannot reach it. Devices go on the identified runs, hard against the vertical surface, in the concealed and edge-following positions the animal already uses.

**Exterior and burrow work is separate.** Burrow systems are treated and then physically collapsed and backfilled so that reopening is visible evidence of continued activity. Where rodenticide is used it is placed in secured, tamper-resistant stations, sited with regard to children, pets and non-target animals. Long Island supports hawks, owls and other predators that feed on rodents, and secondary exposure is a real consideration in how and where material is deployed rather than a footnote.

**Fix the pathway.** If the finding is a cracked lateral, a missing house trap cap or a dry floor drain, the resolution is a plumbing repair and a restored water seal. If the finding is a void beneath a slab, it needs filling. If the finding is a refuse room with no door sweep and a chute that no longer closes, that is a building operations fix. None of those are chemical work, and all of them outlast chemical work.

**Never seal while there is traffic.** Closing a structure over an active interior population removes their route out, not their presence. They stay in the voids, keep breeding, and anything that dies in an inaccessible cavity becomes a second, longer service call.

## What building work actually ends it?

Physical closure of everything at and below grade, specified for an animal that gnaws hard and digs harder.

**The bottom two feet of the building are where the yield is.** Utility penetrations for water, gas, electrical service, irrigation and communications, almost all of which are sleeved and very few of which are sealed. The joint where the frame meets the top of the foundation. Bulkhead doors that no longer seat. Crawlspace hatches. Foundation vent screening that has corroded through. Garage door corners where the seal has lifted from the jamb. Gaps where siding terminates near grade. Areaway doors and cellar hatches in the city, and the surround of a sidewalk vault.

**Material specification climbs for rats.** Half-inch gaps that would be handled with copper mesh on a mouse job need something with more substance here. Galvanized hardware cloth, sheet metal at gnawable edges, hydraulic cement and proper repointing at masonry, mechanically fastened rigid closures, and heavy door sweeps that actually contact the threshold. A rat opens cured foam without effort, so foam is absent from our specification entirely rather than demoted to some supporting corner of it. Caulk finishes a joint over metal and achieves nothing standing on its own.

**Vents stay open and get screened from behind.** Blocking a foundation vent to keep an animal out trades a rodent problem for a moisture problem in the framing, which on a damp North Shore crawlspace is a considerably slower and more expensive failure. Weep holes in brick veneer are the same case: they must keep draining, so they get screened rather than filled.

**Below-grade work is its own category.** Concrete aprons or buried hardware-cloth skirts at shed bases, deck perimeters and slab edges stop an animal digging under rather than through. Filled and compacted voids under steps and walkways. Restored drainage seals. This is the part of the job that a mouse-oriented exclusion scope does not contain, and it is the reason a rat proposal reads differently. The general method is set out under [structural exclusion](/pest-control/structural-exclusion/).

**Then verification.** A return visit after weather, after the first freeze-thaw cycle on exterior masonry, and after enough time for any missed interior animal to reveal itself. Refilled burrows are re-checked. Monitoring that stays untouched over a defined period is evidence, and evidence is what a board, an agent or an inspector actually needs.

## What keeps a property from being re-colonised?

Removing the three things a colony requires: a way in, something to eat, and somewhere to dig.

**Refuse is the largest single lever, and it is an operational fix rather than a technical one.** Containers with intact, closing lids, kept off the ground where possible. Set-out timing that minimizes the hours bags spend on the curb. Compactor rooms with sealed floor penetrations, a proper door sweep and a chute that closes. Grease containers sited on a hard surface, kept closed and cleaned around. Nothing bagged and left in an areaway overnight. A restaurant that gets this right sees a bigger change than one that doubles its station count.
