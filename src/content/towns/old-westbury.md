---
slug: old-westbury
title: Pest Control in Old Westbury, New York
metaTitleCore: Old Westbury Pest Control
quickAnswer: >-
  Old Westbury covers 8.57 square miles and not one of them is water. The village sits on the crest of
  the Harbor Hill Moraine, on Long Island's drainage divide, so nothing arrives here from anywhere
  else. Every wet condition against a foundation was produced on that parcel.
metaDescription: >-
  Old Westbury pest control for two-acre parcels on the moraine crest, where there is no surface water
  and every moisture path is made on the property.
faqs:
  - question: Old Westbury sits in two towns — who regulates building work?
    answer: >-
      The village does, across both halves. Old Westbury straddles North Hempstead and Oyster Bay, but
      because it is incorporated, its own code and its own inspectors govern the whole of it. That is
      the reverse of an unincorporated place on a town line, where the two towns are the authority and
      the resident deals with both.
  - question: Is it true there is no water in the village?
    answer: >-
  ...
  - question: If there is no waterway, why do buildings here still get wet?
    answer: >-
      ...
      water features, and service trenches that now carry water back toward the building they were dug
      from. Cornell Cooperative Extension is direct that leaking pipes, dripping faucets and excess
      irrigation all sustain soil moisture.
  - question: What is the zoning here?
    answer: >-
      Wider-ranging than people assume. The BB Residence District requires two acres per family, with a
      200-foot lot width, a 75-foot front yard and 50-foot side and rear yards. The A Residence
      District requires 8,000 square feet with a 70-foot frontage. That is better than a ten-to-one
      spread inside one village.
  - question: Does the village really allow thirty horses on a parcel?
    answer: >-
      In the two-acre district, yes — one horse per 20,000 square feet up to a maximum of thirty, along
      with farms that make no roadside sales. The A district forbids it outright: no stables or barns
      and no horses or farm animals. Stored feed, bedding and unheated stabling are the most reliable
      rodent habitat in any residential landscape.
  - question: How much of the village is college campus?
    answer: >-
      A great deal of it. The New York Institute of Technology's Long Island campus runs to 1,050
      acres, assembled from former Rockefeller, Whitney and Guest estates, and SUNY Old Westbury holds
      605 wooded acres on the old Broad Hollow estate. The village's entire land area is about 5,485
      acres.
  ...
  - question: Which building on the property should be closed first?
    answer: >-
      Almost never the house. Where there is stabling, a feed store or a plant room, that is where the
      population already lives, and closing the residence while leaving the source open just moves the
      problem across the lawn. The sequence runs outbuildings, then grade and water, then the house.
region: long-island
neighborhoods:
  - The North Hempstead side of the village
  - The Oyster Bay side of the village
  - The Old Westbury Gardens estate edge
  - Orchard Lane
  - The two-acre BB district
  - The NYIT campus edge
  - The SUNY Old Westbury campus edge
  - Wheatley Road and the Jericho Turnpike corridor
sources:
  - name: Village of Old Westbury Code — Article IV, BB Residence Districts
    url: https://ecode360.com/10658021
  - name: Village of Old Westbury Code — Article VI, A Residence Districts
    url: https://ecode360.com/10658185
  - name: The Cultural Landscape Foundation — Old Westbury Gardens
    url: https://www.tclf.org/landscapes/old-westbury-gardens
  - name: New York Institute of Technology — Architecture and History
    url: https://www.nyit.edu/about/offices/capital-planning-and-facilities/architecture-and-history/
...
Cornell Cooperative Extension makes the point in its own terms when it warns that leaking pipes, dripping faucets and excess irrigation all sustain soil moisture around a structure, and that basements and crawlspaces need ventilating. In a village with a waterway you can argue about how much of the moisture is yours. Here the answer is all of it, which is unwelcome and extremely useful, because a fault you own is a fault you can correct.

## Who is in charge when a village straddles two towns?

The village is, across the whole of it — and that is the opposite of what most people expect.

Old Westbury incorporated in 1924, separating from the adjacent Westbury that had housed the construction workers' families. The "Old" prefix was adopted so the postal service could distinguish it from another Westbury up in Cayuga County. The village straddles the Town of North Hempstead and the Town of Oyster Bay.

On unincorporated ground, a town line is a genuine administrative split: two building departments, two permit processes, two sets of property standards, and two houses on one road answering to different authorities. Incorporation reverses that. Because Old Westbury writes and enforces its own code, the town line runs through the village without dividing it. One board, one code, one set of inspectors, one records office — for a parcel on either side.

Residents get the split in a different place. Depending on where in the village a house sits, its children are zoned to East Williston, Jericho, Roslyn or Westbury schools, and the village also contains the Wheatley School and a private Catholic academy. Four school districts, one building department. That is the reverse of the usual Long Island arrangement and it catches people out in both directions.

There is a historical footnote that still shows up in records. In December 1948, 375 acres at the western edge voted 81 to 6 to secede, becoming unincorporated North Hempstead territory, and in April 1949 the Village of East Hills annexed the western portion. Boundary changes of that kind leave permit and survey history split between authorities, and on a parcel near that edge the file for a wall that was opened forty years ago may not be where you assume.

For anyone doing remedial work that crosses into construction — altering a vent, opening and reclosing a roof plane to correct a wildlife entry, replacing sill framing, installing a below-grade barrier, or regrading with a retaining structure — the practical upshot is straightforward. There is one application, it goes to the village, and establishing that at the start saves a fortnight later.

## What is this village actually built of?
...
**The estate-era fabric.** Old Westbury Gardens is the reference. Westbury House was built for John Shaffer Phipps between 1904 and 1906 to a Carolean Revival design by the English designer George A. Crawley with the American architect Grosvenor Atterbury. It went onto the National Register on 8 November 1976 and again on 10 January 2011, with 100 acres in the listing and grounds of about 160. The estate was originally 200 acres; roughly 70 are open to the public, the house became a museum home in 1959 and it opens for tours from April to October. Solid masonry, heavy roof coverings, deep service wings and a full complement of ancillary buildings.

**The mid-century modern group.** The A. Conger Goodyear House at 14 Orchard Lane is the significant example and it is a completely different problem. Edward Durell Stone designed it in 1938 in the International Style on 5.5 acres: floor-to-ceiling glass walls, a flat roof and deep overhanging eaves that shade the glass in summer and let low winter light in. It was listed on the New York State Register on 3 October 2003 and the National Register on 4 December 2003. The World Monuments Fund began preservation work in 2001 and bought the house in 2005 to prevent demolition; later owners hold it under restrictive covenants. Flat roofs, large glazed openings, minimal eaves detailing and generous soffits are a specific and recurring set of failure points.

**The contemporary large houses.** The 2000s and 2010s work, and much of the 1980s work, is big detached housing with complex rooflines, attached garages, multiple service penetrations, pool structures, generator enclosures and extensive underground service runs. Tight construction genuinely reduces incidental ingress at the wall plane. What it does not reduce is the number of penetrations, and on a house with geothermal, irrigation, pool plant, standby power, low-voltage lighting and a full mechanical fit-out, the penetration count is the highest of any stock in this service area.

## What does more than 1,600 acres of campus do to a residential village?

It puts a permanent institutional pest baseline inside a village that otherwise has none.
...
There is a demographic tell in the census figures. The 2020 count was 4,289 residents, but the village holds roughly 1,007 households at an average size of three people, which accounts for about 3,000 of them. The remainder is dormitory population, which is also why one demographic source reports a median age of 29.5 against the census figure of 35.3. Several hundred people here live in group quarters rather than houses.

For pest work that is not a curiosity. Dormitories, dining operations, loading docks, refuse compounds and student kitchens generate exactly the conditions that support commensal rodents and cockroaches, and they do it continuously rather than seasonally. Around them sit 1,655 acres of maintained woodland and playing-field edge — which is the wildlife reservoir. A residential parcel backing onto either campus is on a boundary with a permanent population, and that changes the frequency with which its envelope needs checking.

The rest of the village's institutional ground works the same way in miniature: the Meadow Brook Polo Club, established 1881 as the birthplace of American polo and the oldest continuously operating polo club in the United States, and the Old Westbury Golf & Country Club with its 187-foot water tower, originally built for Cornelius Vanderbilt Whitney and used as a military lookout in the Second World War.

## Why does a zoning code that permits thirty horses matter?

Because a stable is a rodent building, and this code allows a great many of them.
...
Rodents lead — which is not true of the estate hamlets to the north — and the wood-destroying insects follow the irrigation.

**[House mice](/pest-library/house-mouse/) and [Norway rats](/pest-library/norway-rat/), year-round with an autumn peak.** Stabling permitted at up to thirty horses per parcel, two college campuses with dining and refuse infrastructure, and a golf and polo landscape with maintenance yards in it. Cornell's figures — 40 to 50 droppings a day from a rat, 50 to 60 from a mouse — mean an established population leaves an unmistakable deposit inside a week, and its regular routes pick up sebum, the oily brown residue that marks a run in constant use. In a feed store or a tack room both are usually obvious months before anything is noticed indoors.
...
**On these lots the carpenter ant is a water problem in disguise.** Irrigated planting against foundations, mature estate timber along the Old Westbury Gardens perimeter, and forty years of decks, pergolas and pool structures give it moist wood that is easier to excavate. That is [ant control](/pest-control/ant-control/). Termites are a smaller share of the calls on ground landscaped continuously since the polo era and built on repeatedly since. Graduate identifies them, plans the job and puts right the buried timber under new work and the risen grade line — Cornell's instruction to take wooden debris including buried stumps off the property is good practice on any parcel this size — while the treatment is done by a licensed operator engaged for that step. How a working mud tube differs from an abandoned one is on the [eastern subterranean termite](/pest-library/eastern-subterranean-termite/) page.

**[Wildlife management](/pest-control/wildlife-management/)** is heavier here than the housing count suggests because of the campus and estate boundaries. Graduate runs it as a single service, bringing in a licensed nuisance wildlife control operator for the removal and doing the closure at the roof edge in durable material itself, scheduled around dependent young rather than around the calendar.
...
The whole village, with a working understanding of the four environments inside it.
...
**Orchard Lane and the modernist parcels.** Flat roofs, floor-to-ceiling glazing, deep eaves and shallow soffits. A different building physics from anything else in the village, and a different set of entry points at the roof.

**The NYIT campus edge.** A 1,050-acre boundary with reconstructed estate buildings, low modern structures, dining and residential operations and a great deal of maintained woodland.

**The SUNY Old Westbury campus edge.** 605 wooded acres, dormitories and playing fields, with part of the campus running into Jericho.
...
The buildings you do not live in, then the water you are putting into the ground, then the house.

**The stable, the barn and the feed store, if there is one.** Grain, bedding and a muck heap sustain a population indefinitely, and the buildings that hold them are unheated, timber-framed and rarely closed properly at the slab edge and the door line. Finding an established population in a feed room in October explains what will be reported in the house in November.

**Every other ancillary structure.** Pool house, plant room, generator enclosure, garden store, garage, gate structure, sports pavilion. Accessory buildings here are allowed to 25 feet, so several of these are substantial.

**The irrigation, zone by zone.** Which heads throw onto a wall, which zones run at night, which beds never dry. This is the most commonly missed item on a property of this type and it is the one that decides whether carpenter ant work holds.

**Where the roof water is delivered.** Large roofs, few downspouts, and leaders that frequently terminate into buried lines nobody has opened since installation. On a village with no waterway, roof water that does not leave the parcel stays on the parcel.
...
We will not price exclusion work on a parcel like this from a photograph or a phone description, because the source is usually a building the caller did not think to mention. Discussing it costs nothing, and a phone call is generally enough to establish whether the stable, the pool plant or the house is the problem. Committing that to a written plan carries a fee: the plan is the deliverable, and it is credited against the project if the work goes ahead.

## Why we approach Old Westbury this way

The firm dates from 1983 and has worked Nassau and Suffolk buildings for its whole existence. Arnold Katz set it up after taking a B.S. in Entomology at the University of Georgia, and he is still working as senior technician and staff entomologist; the firm is now led by his son, [Ryan Katz](/ryan-katz/). What the company argues, and organizes itself around, is that pests are a symptom of how a building is put together and that the fix has to be structural and permanent. Exclusion is the whole proposition rather than an add-on, and the benchmark for the residential work is the commercial side — audited food premises, managed property and institutional buildings.
...
For an assessment of what the whole property is doing — outbuildings included — [get in touch](/contact/). If the pest is the more natural place to start, the [pest control index](/pest-control/) lists everything.
