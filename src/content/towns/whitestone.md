...
quickAnswer: >-
  ...
  yard behind it.
metaDescription: >-
  Whitestone pest control for detached and two-family houses inside the city line, where the sill
  line, the roofline and the deep rear yard carry the work.
faqs:
  - question: Why does a Whitestone house get mice when a Manhattan apartment does not?
    answer: >-
      Because a detached house is its own envelope and it meets the ground on all four sides. An
      apartment sits inside a larger structure that somebody else maintains. Here the entry points are
      yours alone: the sill plate junction, the utility penetrations, the garage door corners, the
      crawl or cellar access, and the roofline where a re-roof left a return open.
  - question: The city separated our sewers. Did that fix the rat problem?
    answer: >-
      It removed one mechanism and left the rest. Until 2023 Whitestone drained solely into a combined
      sewer that surcharged in heavy rain, and surcharging pushes rodents up through yard and cellar
      drains. Nearly six miles of new storm sewers across 124 blocks changed the street side of that.
      Nothing in the project crossed a property line.
  - question: Do we need to worry about termites this far north?
    answer: >-
  ...
  - question: Why does the rear yard matter more than the house on a survey?
    answer: >-
      Because the rezoning that governs these blocks requires detached houses on lots of up to 5,700
      square feet at 60-foot widths, so the yards are deep and they back onto one another across the
      block interior. That interior is soft ground with planting, sheds and detached garages, and it
  ...
  - question: What does the Health Department expect a Whitestone homeowner to do?
    answer: >-
      Store refuse in hard plastic rat-resistant containers with tight-fitting lids, seal cracks and
...
sources:
  - name: NYC DEP — $128 million for six miles of new storm sewers in Whitestone
    url: https://www.nyc.gov/site/dep/news/24-019/to-better-manage-extreme-rainfall-city-invests-128-million-add-six-miles-new-storm-sewers
  ...
  - name: NYU Furman Center — Flushing/Whitestone neighborhood profile
    url: https://furmancenter.org/neighborhoods/view/flushing-whitestone
  - name: NYC Parks — Francis Lewis Park
    url: https://www.nycgovparks.org/parks/francis-lewis-park/history
...
At a short list of places, and after four decades the list barely varies from address to address.

**The bottom eight inches.** Start where the frame meets the block, because on a 1950s house that seam is the busiest opening on the property and the one nobody has looked at since the siding went on. Around it: vents screened in 1957 and rusted through by 1990, a crawlspace hatch that stopped seating when the door swelled, a bulkhead that no longer meets its frame, and every service that has ever been run into the house — water, gas, electric, irrigation, cable, air-conditioning line sets — sleeved through the wall and left unsealed at both ends. Where the house is brick-faced, the weep holes have to stay open for the cavity to drain, so they get screened, not filled. That single distinction is got wrong on this street more often than anything else in the trade.

**The attached garage.** It is the commonest Whitestone weak point and the least suspected, because it is attached to the house and treated as though it were outside it. The overhead door seal lifts away from the jamb at the bottom corners and leaves a triangle a rat walks through. The door from the garage into the house or the cellar stairs then has no sweep on it at all. A dryer vent with a stuck flapper and a hose bib penetration finish the picture, and an unheated garage full of stored food, birdseed and pet supplies makes the arrival worthwhile.

**The roof edge.** Nearly every house here has been re-roofed at least once, and re-roofing is where roof returns get opened and not closed again. Look at where a roof plane dies into a wall, at gable louvres whose screen has perished, at ridge vents with torn mesh or a compressed closure strip, at the gap behind a fascia where a gutter was rehung, and at a chimney flue with no cap on it. Everything on that list sits twenty feet up, which is exactly why it is still open.

Two facts make this less obvious than a measuring exercise. A house mouse passes through about a quarter of an inch and a rat through about half, and both will enlarge a smaller opening by gnawing at a soft substrate. And mice climb well on brick, stucco and siding, so an opening twelve feet up is not out of reach and the roofline is never a safe assumption.

Cornell's rodent guidance underlines why sealing matters more than the alternative: long-term prevention is the goal, and an approach relying on more than baiting is what gets there. One mouse produces 50 to 60 droppings a day, which is why the interior evidence in a Whitestone house appears suddenly even when the population outside has been established for a season or more.

## What did separating the sewers change, and what did it leave alone?

It removed a mechanism from the street and left the private side of the property line untouched.

Until 2023, the whole of Whitestone drained into a combined sewer. The Department of Environmental Protection completed two projects to change that — SE810 at 72 million dollars across 70 blocks between September 2018 and 2023, and SE811 at 56 million dollars across 54 blocks between August 2021 and December 2023. Together they added 31,316 feet of new storm sewers, nearly six miles, across 124 blocks; converted 12,092 feet of combined sewer to sanitary sewer; replaced 213 catch basins and installed 118 new ones; and replaced 47,341 feet of water main. Before the work, exceeding the combined system in heavy rain produced roadway flooding and untreated discharge into Flushing Bay, and the separation is projected to keep 29 million gallons of pollution a year out of the bay.
...
What it mapped describes the ground precisely. R1-2 permits one-family detached houses only, on a minimum lot of 5,700 square feet at a 60-foot width. R2A is one-family detached with 20-foot side yards on corners and a 35-foot height cap. R3X allows one or two families detached on 3,325 square feet, R3A on 2,375 square feet at a 25-foot width, and retained R2 areas keep 3,800 square foot lots at 40-foot widths. Commercial overlays were narrowed from 150 to 100 feet deep.

A 60-foot lot width with a free-standing house on it produces two things that matter. A genuine side yard on both flanks, so the entire perimeter of the building can be reached, inspected and worked — which is a luxury nobody in the denser parts of the city has. And a deep rear yard that backs onto the deep rear yard behind it, so the interior of the block is a continuous run of soft ground, planting, sheds, detached garages, compost and mature trees, with fences that stop people and stop nothing else.
...
They accumulate the two conditions that eastern subterranean termites need, slowly, over decades, until the two meet.
...
## What about the waterfront co-ops and the two-family houses?
...
Edges — and a pest problem is usually worst where two kinds of ground meet.
...
A tidal marsh margin against residential blocks is a permanent supply of cover, standing water and wildlife pressure that no work on a house will alter. It is a reason to be realistic about mosquitoes on the shoreline blocks: [mosquito management](/pest-control/mosquito-management/) at a private property is source reduction — containers, gutters, tarpaulins, boat and pool covers, low ground that ponds — through the April to October season the Health Department treats as the West Nile window. It is not marsh treatment, and we do not do ornamental or turf work.
...
## Which parts of Whitestone do we cover?
...
**Malba**, on the western bluff above Powell's Cove, is a private-association enclave of around four hundred houses on curving streets, and it is different enough to have [its own page](/locations/malba/).

**The Powell's Cove Boulevard shoreline** and **the Francis Lewis Park blocks** carry the tidal margin and the park edge, with the wildlife and standing-water pressure that comes with them.
...
Less than a landlord in a large building, and more than most homeowners assume.
...
If you want a straight assessment of your own house and its openings, [get in touch](/contact/). If a single pest is what brought you here, the [pest control index](/pest-control/) covers each service in turn.
