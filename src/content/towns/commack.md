...
faqs:
  ...
  - question: Why do so many Commack houses fail in exactly the same place?
    answer: >-
      Because they were built at the same moment by the same trades. About 5,233 units went up in
      the 1960s and 3,353 in the 1950s, to repeating plans. The band joist, the garage junction and
      the field-cut utility penetrations are common to thousands of houses here, so the entry points
      repeat street after street.
  - question: Are termites a real risk on 1960s Commack construction?
    answer: >-
  ...
  - question: If there is no marsh here, where are the mosquitoes breeding?
    answer: >-
      ...
      breeding sites and its long-term plan calls for enhanced catch basin larviciding plus source
      reduction against upland breeding. On a residential lot the productive water is in blocked
  ...
  - question: What should I look at before calling anyone about mice?
    answer: >-
      The band joist and the garage. On this stock the top of the foundation wall was rarely sealed
      and the garage-to-house junction is the most common uncontrolled opening. Cornell records that
      a mouse produces fifty to sixty droppings a day, so where you find droppings tells you which
      route is being used now.
region: long-island
neighborhoods:
  - Commack Corners
  - The Huntington-side streets
  - The Smithtown-side streets
  - Harned Road
  ...
  - Jericho Turnpike
sources:
  - name: Commack Community Alliance — History of Commack
    url: https://commackcommunityalliance.com/history-of-commack/
  ...
  - name: Nassau Suffolk Water Commissioners Association — Our Long Island Aquifers
    url: https://www.nswcawater.org/water_facts/our-long-island-aquifers-the-basics/
gatePassed: false
---

## What is different about a place with no water in it?
...
Because it genuinely was built in twelve years, by the same people, to the same details.

The dates are worth setting out because they explain the buildings. Commack was farmland: about thirty farms, from forty or fifty acres up to over two thousand, growing cabbage, potatoes, corn, broccoli and cucumbers. Pickles were a major crop in the 1920s. Then USDA agricultural agents found the golden nematode in the potato fields in the early 1950s and put the growers out of the potato business. Flat, open, well-drained farmland came onto the market in large blocks at exactly the moment post-war housing demand was at its peak.
...
Those weaknesses are consistent enough to list.

**The band joist.** On a 1960s poured foundation the timber floor structure bears on top of the wall, and the joint between the two was almost never sealed. It is a continuous horizontal line running the full perimeter of the house, usually hidden behind siding and above a planting bed. It is the first thing to check for mice and the first thing to check for cold air, because they are the same gap.

**The garage junction.** An attached garage meets the house at a wall that was framed as an exterior wall and then covered by a structure with a different floor level, a different foundation depth and often a different slab. The junction is a reliable route from an unheated space with an overhead door into the conditioned building.
...
## Does it matter that Commack sits in two towns?

It matters more than most residents expect, and it is worth settling before any permitted work starts.

Commack is an unincorporated hamlet and census-designated place. It is not a village and it is not a city. It has no mayor, no board of trustees and no architectural review board of its own — and unlike the incorporated villages elsewhere on the North Shore, it does not write its own building code. What makes it unusual is that it is split between the Town of Huntington and the Town of Smithtown, roughly along Townline Road.
...
## What work does the Commack stock actually need?

In the order this housing generates it, which is not the order a marketing list would put it in.

**[Structural exclusion](/pest-control/structural-exclusion/)** is the foundation of everything here, because the defining feature of the stock is repeatability. Once you know where a 1962 ranch leaks, you know where eleven thousand of them leak. The work means closing the band joist line, sealing field-cut service penetrations with materials that will outlast the occupant, fitting rigid closures at soffit and fascia corners, correcting the garage-to-house junction, screening rather than blocking crawlspace and gable vents, and detailing the seams where later additions meet the original frame.
...
Because the trees have finally caught up with the buildings.
...
All of it, though the profiles are not identical across a hamlet this large.

**Commack Corners**, around the crossing of Jericho Turnpike and Commack Road, is the original settlement — the little hollow in the gently rolling hills where the hamlet actually began. It holds the surviving pre-subdivision fabric, including the Commack Methodist Church and Cemetery of 1789, described as the oldest Methodist church building in New York State.

**The Huntington-side streets**, west of Townline Road, and **the Smithtown-side streets** to the east. Structurally similar, administratively distinct, and worth identifying before any permitted work.
...
Four things, and the pest is not one of them.

**The line where the foundation stops and the timber starts.** On this stock that line is a band joist above a poured wall, usually behind a hedge, usually below the level anyone looks. Getting a hand on it means moving mulch, and moving mulch is frequently the most productive ten minutes of an inspection. It answers the mouse question and the termite question simultaneously.

**Where the roof water actually goes.** Not where the gutters are, where the water goes. Follow each downspout to its termination and see whether it discharges into a leader line, onto a splash block, onto a paved surface that slopes back toward the house, or straight onto the border. Then look at the corner nearest each termination for staining, soft trim and ant activity.

**Every junction between old work and new.** Extensions, dormers, converted garages, finished basements, replacement windows. On a house that has been modified four times over sixty years, the modifications are where the openings are, and they are almost never on the original drawings — which in this hamlet frequently no longer exist anyway.

**The roof edge from the ground, with binoculars.** Soffit-to-fascia corners, gable end terminations, ridge vents, plumbing stack flashings, and any branch within jumping distance. Most wildlife entry on a Commack house is above the gutter line and almost none of it is visible from inside.

Reading a building this way takes longer than walking the perimeter with a sprayer, and it produces a different job. It is also why we do not quote exclusion work from a photograph.

## Why we work in Commack this way
