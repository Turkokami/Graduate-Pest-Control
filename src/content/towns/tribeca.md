...
metaDescription: >-
  ...
  freight shafts, sidewalk vaults and retrofitted risers.
faqs:
  - question: Why does my Tribeca loft have mice when the apartment is spotless?
    answer: >-
      Because the building has vertical shafts that predate the apartment. Goods moved through open
      hoistways before elevators were fitted, and those shafts run from the cellar to the roof. A
      population living in service space reaches your floor inside the structure without crossing a
  ...
  - question: Why can two addresses in Tribeca share one cellar?
    answer: >-
      ...
      up narrow structures that read as a single building from the street. The reverse also happens:
      what looks like one wide warehouse can be several masonry-divided structures. Neither the
      street number nor the facade tells you where the building actually ends below grade.
  ...
  - question: Our loft building has retail on the ground floor. Does that change anything?
    answer: >-
      It usually changes everything. These buildings were designed with a store at street level, and
      that arrangement survived conversion. A ground-floor food tenancy and a residential loft four
      floors up sit on the same drainage and the same riser runs, so a cockroach problem reported
      upstairs frequently has its source downstairs, and the survey has to cover both.
  ...
  - question: Why is treating one unit in a converted loft rarely enough?
    answer: >-
      Because loft floorplates were single undivided rooms and the partitions that made apartments
      out of them were added later, often stopping short of the structure above. Add the retrofitted
      plumbing stacks cut through timber and concrete floors and you have a building that is
      continuous where it looks divided. Pressure in one unit moves the population, it does not end it.
  - question: Is a heavy-timber floor structure a termite or carpenter ant risk?
    answer: >-
      Not in the way a Long Island frame house is, but wet concealed timber is wet concealed timber.
...
neighborhoods:
  ...
  - Chambers Street
sources:
  - name: Tribeca West Historic District Designation Report — NYC Landmarks Preservation Commission
    url: https://architecturaltrust.org/wp-content/uploads/2013/06/Report_LPC_Tribeca_West.pdf
  - name: Tribeca North Historic District Designation Report — NYC Landmarks Preservation Commission
    url: https://architecturaltrust.org/wp-content/uploads/2013/06/Report_LPC_Tribeca_North.pdf
  - name: NYC Loft Board — the Loft Law and interim multiple dwellings
    url: https://www.nyc.gov/site/loftboard/about/about.page
...
## Why is pest work in Tribeca a warehouse problem rather than an apartment problem?
...
Vertical shafts, oversized floor cavities and fire divisions in unexpected places. All three are permanent, and all three are invisible once a loft is finished.

The Landmarks reports for the Tribeca districts are unusually specific about how these buildings worked. Goods moved between floors through open hoistways before mechanical elevators were fitted, and stairs were pushed to the side walls to keep the floorplate clear. On the facades, the reports identify separately articulated single-bay openings as exterior elevator-door surrounds — meaning you can stand on Greenwich Street and read where the freight shaft is inside a building that has been residential for forty years.

Those shafts rarely disappear. Sometimes the elevator is still there, serving the building. Sometimes it was decommissioned and the shaft was floored over at one or two levels and forgotten. Sometimes the enclosure survives with services threaded through it, which is the worst of the three, because a shaft that has been repeatedly cut into for pipe and cable is a shaft with a hole at every floor. Whatever happened to it, the result is a continuous vertical route from the cellar to the roof, warm in winter, unlit and unvisited.

The floor structure adds the second cavity. Mid-nineteenth-century lofts here used cast-iron columns set in rows perpendicular to the facade, carrying yellow pine girders and beams. Later buildings used rolled iron and then steel; a 1903–05 warehouse on Hubert Street is steel-framed, and reinforced concrete floors turn up in later Greenwich Street buildings. Heavy timber framing means deep joist bays and thick floor assemblies, and when a loft is subdivided the new ceiling usually goes below the old structure rather than into it. The gap between the finished ceiling and the timber above it is a horizontal void that spans the whole floorplate.

The third feature is the strangest. An 1871 building regulation required fireproof partition walls every twenty-five feet, and developers answered it by building narrow structures which, as the designation report puts it, often appear as a single structure. That produces two situations that both mislead. A facade that reads as one wide warehouse can be several buildings with masonry between them. And two separate street addresses can share a cellar, a stair or a party structure that no plan shows. Neither the street number nor the front elevation is a reliable statement of where the building ends.
...
The Landmarks reports describe the arrangement precisely: basements extended beneath the sidewalk, covered in the sidewalk area by granite slabs and in front of the building by a stepped form sheathed in iron diamond plate and iron-framed glass lens panels. Nineteenth-century photographs show goods being moved across those stepped vaults, and sheet-metal awnings hung on rods over the loading areas above them. This was the delivery infrastructure of a wholesale district, and it is still there.

For [rodent control](/pest-control/rodent-control/) that changes the map. A vault is a below-grade space with a public street on one side of it, an old cellar on the other, service penetrations through both, and a covering assembly of granite, iron and glass that has been driven over, dug up, patched and resurfaced for a century and a half. Every one of those interventions is a joint. [Norway rats](/pest-library/norway-rat/) are not climbing your facade; they are already below the level you are standing on, and the question is only whether the vault is closed off from the occupied cellar.
...
At the roof and parapet, at the vault covering, and at the retrofitted plumbing that was cut into the building long after it was finished. Water is upstream of most structural insect activity in any building, and a converted warehouse gives it several routes that a house does not.

The roof comes first because these are large flat roofs over deep floorplates, often carrying decades of mechanical plant, and a leak that starts at a parapet or a drain does not show itself in a room below for a long time. It shows itself in the structure. Wet yellow pine holds moisture for months, and softened concealed timber behind a masonry wall is what [carpenter ants](/pest-library/carpenter-ant/) excavate — not because they eat it, but because damp wood is easier to work and suits the brood. There is no external sign except, sometimes, a small pile of coarse excavated material on a sill or floor.

The second route is the vault covering, which is a horizontal surface in the public way with glass and iron panels bedded into it. Every one of those bedding joints is a place water gets in, and what it gets into is the cellar wall of the building.

The third is the newest and the most consequential for insects. These buildings had no domestic plumbing. Conversion put kitchens and bathrooms into them, which meant cutting new soil and supply stacks through timber and concrete floors, generally in the cheapest available line, generally decades after construction, and frequently more than once as units were reconfigured. Those penetrations are the shared route between apartments on a stack, and where they are wet — a slow joint, a failed seal at a floor collar, condensation on a cold line in an uninsulated chase — they support a resident [German cockroach](/pest-library/german-cockroach/) population that is not in anybody's kitchen.

The practical upshot is that a serious survey of a Tribeca building looks at the roof and the cellar first and the apartments last. That order is the opposite of the order most people expect, and it is the reason repeat visits stop being necessary.

## Which services do Tribeca buildings actually need?

In the order this fabric generates them, and with the reason attached.

**[Rodent control](/pest-control/rodent-control/)** is first, and it divides. [Norway rats](/pest-library/norway-rat/) belong to the vault, the loading threshold and the cellar drainage; the Health Department is unambiguous that owners are legally required to keep rats out and that exposed refuse attracts them. [House mice](/pest-library/house-mouse/) belong to the shafts and floor cavities, and they are the reason a well-run building with no waste problem at all still finds droppings on a top floor.

**[Structural exclusion](/pest-control/structural-exclusion/)** is second in sequence and first in value, because it is what makes any of the rest durable. In a converted loft that means the vault-to-cellar boundary, the base and head of every shaft, the floor collars on retrofitted stacks, the roof bulkhead and any door threshold at street level that a delivery route runs through.
...
That quarter-inch standard is worth pausing on in a building like this. Applied honestly in a converted warehouse, it means closing floor collars around retrofitted stacks, the base and head of shafts, and the door lines between service space and occupied space — which are exactly the routes that carry the traffic.
...
## When in the year is this work best done?

Evidence sets the urgency. The calendar sets what is practical and what it costs.

**Autumn** is the rodent window everywhere in the city, and in a vaulted district it is specifically the window for below-grade work. Cooling weather pushes populations toward buildings, and a cellar-to-vault boundary closed in September never acquires a winter population in the first place. It is also the time of year when a building's own heat starts revealing its openings.

**Winter** drives insects into occupied space and makes them findable, and it is the only season when a converted loft honestly shows you its air paths. Stand in a subdivided floorplate on a cold morning and the places where warm air is escaping into a shaft or a floor cavity are the same places the traffic runs.

**Spring** is for the roof and parapet. A winter of freeze and thaw leaves its record on flat roofs, parapet copings, vault coverings and any masonry that has been holding water, and correcting that in spring removes the condition before the summer insect season can use it.

**Summer** is exterior and street-level work: rebuilding waste storage, clearing and repairing the drainage that serves a vault, correcting a loading threshold that has settled, and reducing standing water on roofs and in roof drains for [mosquito](/pest-control/mosquito-management/) control.

## Why we start with the structure

Graduate Pest Control has been at this since 1983, on buildings from the five boroughs out to the eastern end of Suffolk County. Arnold Katz set the firm up after studying entomology at the University of Georgia; his son [Ryan Katz](/ryan-katz/) runs it today. One line of Ryan's carries the whole method: we treat every job as a building problem, not a pest problem.

Tribeca is a good place to test that claim, because here the building is doing something no one living in it ever asked it to do. It was raised to move textiles and dry goods between a river, a sidewalk vault and five floors of storage. Everything about its structure — the shaft, the floor depth, the fire partition, the vault, the loading threshold — served that purpose. Then the trade left, the artists arrived, the law caught up, and apartments were fitted into a machine built for cargo. The pests are simply using the machine as designed.

Reading the building is faster than chasing what comes out of it. For a plain assessment of where the routes in your own building run, [get in touch](/contact/). To start instead from a particular pest, the [pest control index](/pest-control/) sets out each service.
