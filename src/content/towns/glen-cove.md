---
slug: glen-cove
title: Pest Control in Glen Cove, New York
...
metaDescription: >-
  Glen Cove pest control for a Nassau city where under half the housing is detached and nearly half
  is rented, on a remediated industrial waterfront.
faqs:
  - question: Why does Glen Cove being a city rather than a village matter for pest problems?
    answer: >-
      Because responsibility is concentrated. Glen Cove separated from the Town of Oyster Bay on 1
      January 1918 and runs its own building department, code enforcement, public works, sanitation
      and police. Almost every question about who inspects a building, who registers a rental and
      who collects the refuse is answered inside the city.
  - question: What is the Glen Cove Landlord Registry and why does it affect pest work?
    answer: >-
      It puts small rentals on a recurring inspection cycle. Owners of one- and two-family dwelling
      units in rental occupancy must register within 30 days unless the owner or immediate family
      lives there, and registration carries a biannual Building Department inspection for
      housing-code compliance and working smoke detectors.
  - question: Does the old industrial waterfront still affect buildings here?
    answer: >-
      It shapes the ground they sit on. Metals were processed at the 26-acre Li Tungsten facility on
      Glen Cove Creek from 1942 to 1985, EPA completed the cleanup in 2008, and of the 214 acres in
      the waterfront redevelopment area 68 sit within state and federal Superfund sites. Any work
      that disturbs soil there is governed accordingly.
  - question: Why does treating one apartment rarely fix a cockroach problem in Glen Cove?
    answer: >-
  ...
  - question: How should a Glen Cove building handle a bed bug report?
    answer: >-
      As a building matter from the first call. StopPests guidance for property managers is explicit
      that all units above, below, either side and across the corridor from an infested unit must be
      inspected, and that maintenance staff should seal openings around pipes, utility conduits and
      bathroom vents.
  - question: What does the topography do to drainage on a Glen Cove property?
    answer: >-
      It concentrates it. Average elevation is about 45 feet but the range runs from sea level to
      175 feet at a point between Harbor Hill and Carpenter Street, with level ground interspersed
      with steep knolls and slopes. Water on that kind of relief arrives at one face of a building
      with momentum rather than sitting evenly around it.
  - question: Are two-family houses a distinct pest problem in Glen Cove?
    answer: >-
...
neighborhoods:
  ...
  - Morgan Park
sources:
  - name: City of Glen Cove Code — Landlord Registry
    url: https://ecode360.com/12085081
  - name: City of Glen Cove — Code Enforcement
    url: https://glencoveny.gov/code-enforcement
  ...
  - name: StopPests in Housing — Integrated Pest Management for Bed Bugs
    url: https://www.stoppests.org/stoppests/assets/File/Bed-bug-guide-for-property-managers-v11.pdf
gatePassed: false
---
...
The Li Tungsten site is the one that shaped the modern waterfront. From 1942 to 1985 various companies processed metals at the 26-acre facility on Garvies Point Road along Glen Cove Creek, disposing of wastes into surrounding areas including a municipal and industrial dump. EPA removed radioactive materials, chemicals and storage tanks in 1989 and 1990, listed the site on the National Priorities List in 1992, and completed the cleanup in 2008 — removing contaminated soil and sediment, demolishing the facility, constructing a dewatering facility for Glen Cove Creek and imposing land use restrictions. Of the 214 acres in the waterfront redevelopment area, 68 sit within state and federal Superfund sites.

That matters practically. Land use restrictions mean soil disturbance in those areas is governed, and any pest work that involves excavation, burrow treatment, grade correction or below-grade exclusion near the creek needs to establish what the parcel's restrictions actually say before anyone puts a spade in.

## Why is Glen Cove's housing split down the middle?
...
## What does city government change on the ground?
...
For pest work that changes the conversation. On a registered rental there is a named agent, a floor plan on file and a recurring inspection. Those are exactly the three things that are usually missing when a treatment fails on a small rental property.

Code enforcement is equally direct about the conversions that generate pest problems. Cellar and basement occupancy is prohibited. A home may not be used by more than the number of families legally permitted. Rental of a dwelling unit, or any portion of one, for less than 28 days is not permitted. Each of those rules exists because the alternative produces sleeping accommodation in spaces with no proper drainage detail, informal cooking arrangements and improvised service penetrations — which is a description of ideal cockroach and rodent habitat.

Anyone managing property here should read [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/) on documentation standards, and [New York's neighbor notification law](/compliance/ny-neighbor-notification-law/) on what a commercial application requires. Boards and managing agents will find the framework at [co-op and condo pest control](/commercial/coop-condo-pest-control/) and [property management pest control](/commercial/property-management-pest-control/).

## Which pests dominate a half-rental housing stock?
...
**Mosquitoes** are managed county-wide from 44 trap sites, with the Department of Public Works applying larvicides and monitoring thousands of street basins, sumps and ponds along with hundreds of miles of freshwater streams, and the county investigating all suspect or confirmed cases of West Nile virus, Zika virus and other mosquito-borne disease. On the ground here the productive water is in the yards behind multifamily buildings, in marina and boatyard equipment, and at the wetland margins near Dosoris Pond and Welwyn.

## What work does a Glen Cove building need?

Scoped to the building type, because one list does not cover a fifty-unit block and a shingled house on the estate fringe.

**[Structural exclusion](/pest-control/structural-exclusion/)** is the backbone in both cases, but it means different things. On a house it is the band joist, the service penetrations, the soffit line and the grade. On a multi-unit building it is the vertical work: sealing riser and chase penetrations at every floor level, fitting escutcheon plates where supply pipes pass through finishes, closing joist pockets where a floor structure enters a party wall, and detailing the point where a commercial ground floor meets a shared service area.
...
The whole city, with the understanding that it contains at least four distinct building environments.
...
Because structurally it is one, and it is the most common non-detached building type in the city.

About 1,513 Glen Cove units sit in two-family buildings. The typical example was built as a house and divided, or built as a two-family from the start with one dwelling above the other. Either way the two units are connected by a stair, a chimney chase, a plumbing riser, an electrical run and — after decades of upgrades — a bundle of cables and a duct or two, all passing through floor structures that were never fire-stopped and certainly never pest-stopped.

The pattern that produces is predictable and it is routinely misread. An occupant reports mice or cockroaches, that unit is treated, the population inside it falls, the survivors move along the chase, and the same complaint appears in the other dwelling within weeks. Nobody has done anything wrong. The treatment addressed a compartment inside a building that does not have compartments.
...
It swaps one set of problems for another rather than eliminating them.

The Garvies Point buildings are tight. Modern air sealing, continuous insulation, mechanical ventilation and controlled envelopes mean the classic post-war entry points — an open band joist, an unsealed penetration, a bowed soffit — are largely absent. That genuinely reduces incidental ingress.

What replaces it is transport and concentration. Cornell's account of German cockroach movement applies directly: they are easily spread with food items, including packaging or shipping materials made of cardboard or paper, and can be transported on personal items between homes and workplaces. A building with a parcel room, a refuse chute, a shared loading area, ground-floor commercial tenancies and several hundred households moving cardboard through it every week has a very effective distribution system, regardless of how well it was built.

Bed bugs behave the same way. Nothing about a new building resists them; what a new building offers is the chance to respond correctly, because the floor plans exist, the management structure is clear and the maintenance staff can seal openings around pipes, utility conduits and bathroom vents as a matter of routine rather than as an emergency.

The other thing new waterfront construction changes is the surrounding ground. Land use restrictions from the Superfund remediation govern soil disturbance across parts of that acreage. Anyone planning burrow treatment, below-grade exclusion or grade correction on or beside those parcels should establish what the restrictions say first. That is a matter of doing the work lawfully, not a reason to avoid it.

## Why we approach Glen Cove this way

Graduate Pest Control has worked across Nassau and Suffolk since 1983. Arnold Katz founded it with a B.S. in Entomology from the University of Georgia; his son [Ryan Katz](/ryan-katz/) is the second generation running it. Ryan's formulation is the one that fits this city best: we treat every job as a building problem, not a pest problem.

Glen Cove tests that harder than a hamlet of detached houses does. Here the building is frequently not one household's building. It is a stack of dwellings sharing a chase, or a downtown block with trade below and tenancies above, or a hundred-year-old two-family whose cellar nobody has properly looked at since the boiler was replaced. The pest is a symptom of how the structure is connected and who is empowered to act on it. Work out the connection and the authority, and the treatment stops being a recurring expense.

For a clear account of how your building is connected and where it is open, [get in touch](/contact/). If the pest is the easier starting point, every service is on the [pest control index](/pest-control/).
