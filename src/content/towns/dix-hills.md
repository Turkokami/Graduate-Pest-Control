...
Graduate Pest Control has worked across Nassau and Suffolk since 1983. Arnold Katz founded the company holding a B.S. in Entomology from the University of Georgia and remains active as senior technician and supervisor; his son [Ryan Katz](/ryan-katz/) runs it as the second generation. Ryan's position is stated plainly: we treat every job as a building problem, not a pest problem. Rodent exclusion is the core of what the company does, and the commercial work — audited food premises, managed property, institutional buildings — is the standard the residential work is held to.
