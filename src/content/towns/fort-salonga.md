...
**The grade line and the buried wood on large lots here decide how wet the bottom of a building stays.** On ground that was dug for brick clay in places, the drainage is not uniform across a single parcel. One insect that follows the water is the carpenter ant, nesting in hollow, decaying wood under a pile or in a stump and working across as much as three hundred feet of wooded lot to reach framing a gutter has been wetting for a decade. That is [ant control](/pest-control/ant-control/), and the sill and soffit closure that keeps it settled is [structural exclusion](/pest-control/structural-exclusion/). Anyone who only needs to put a name to the insect should read the [eastern subterranean termite](/pest-library/eastern-subterranean-termite/) page. Termites on that uneven brick-clay ground are managed by Graduate from identification through the drainage and wood-to-soil correction, with a licensed operator it brings in doing the treatment.
