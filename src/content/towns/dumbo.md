---
slug: dumbo
title: Pest Control in Dumbo, Brooklyn
metaTitleCore: Dumbo Pest Control, Brooklyn
quickAnswer: >-
  Dumbo is a factory district with apartments in it. Its buildings are heavy timber and early
  reinforced concrete standing on filled land where the shoreline once ran along Water Street, so
  the working routes are freight shafts, loading thresholds and cellars that took several feet of
  river water in 2012.
metaDescription: >-
  Dumbo pest control for converted factory lofts on filled waterfront land, where the routes are
  freight shafts, loading thresholds and flood-exposed cellars.
faqs:
  - question: Why does a concrete building still get mice?
    answer: >-
      Because nothing has to be chewed. In a timber-framed house an animal makes an opening; in a
      reinforced-concrete factory it finds one that is already there — a construction joint, a
      cast-in sleeve, the annulus around a pipe a later trade cut through a slab, the base of a
      freight shaft. Hard substrate does not mean sealed substrate.
  - question: What was here before the buildings?
    answer: >-
      Salt marsh. Water Street marks the former waterline, the city sold underwater lots from 1686 to
      owners who filled them to build wharves, and the Empire Stores site was filled in three
      episodes between about 1796 and 1850. Buildings north of Water Street stand on made ground over
      former tidal land, which drains and settles differently from undisturbed till.
  - question: How badly did the 2012 flood hit Dumbo?
    answer: >-
      The East River came up Main Street and Old Fulton Street. A shop at Main and Water took at
      least four feet inside the storefront, a resident of 1 Main Street reported five feet in the
      lobby and basement, the carousel's basement took about five feet and lost its electronics, and
      multiple basements on lower Old Fulton Street flooded with seawater.
  - question: Are the Gair buildings really among the first concrete factories in America?
    answer: >-
  ...
  - question: Why does treating one apartment rarely settle anything here?
    answer: >-
      ...
      manufacturing — 68 Jay Street had ten acres of floorspace, 135 Plymouth held 186,500 square
      feet — and the walls that made flats out of them arrived later, often stopping at a dropped
      ceiling rather than at the structure above it.
  - question: Which bin rule applies to a Dumbo building?
    answer: >-
      Most likely the Empire Bin rule. Dumbo is in Brooklyn Community District 2, the first Brooklyn
      district in the rollout, where properties of thirty-one or more residential units must register
      for stationary on-street containers with keycard access, emptied by automated side-loading
      trucks. Properties of ten to thirty units can opt in.
  - question: Do the cobblestone streets matter for pest work?
    answer: >-
      They are a jointed surface over bedding material rather than a monolithic one, and in places
      there is no sidewalk at all — the designation report suggests that may be unique in the city.
      Granite Belgian block runs straight up to loading thresholds and doorways, and every joint in
...
sources:
  - name: DUMBO Historic District Designation Report — NYC Landmarks Preservation Commission
    url: https://s-media.nyc.gov/agencies/lpc/lp/2279.pdf
  - name: Sandy hits DUMBO hard — Brooklyn Eagle, 1 November 2012
    url: https://brooklyneagle.com/articles/2012/11/01/sandy-hits-dumbo-hard-downtown-and-heights-escape-major-damage/
  - name: NYC Hazard Mitigation Plan — Flooding
    url: https://nychazardmitigation.com/documentation/hazard-profiles/flooding/
  - name: NYC Department of Sanitation — Empire Bins
...
The housing numbers still carry the fingerprints of that history. NeighborhoodScout classifies 97.2 percent of Dumbo residential real estate as large apartment buildings, with 91.8 percent of units at studio to two bedrooms. Point2Homes counts 2,375 housing units and 4,497 residents at a median construction year of 1956, with 40.2 percent of units in pre-1940 buildings and 57.5 percent of all units in buildings of fifty or more, against 1.3 percent single-family detached. Those last two figures describe the same buildings. A pre-1940 structure holding fifty or more households is not a pre-war apartment house here; it is a warehouse with apartments in it.

That single fact reorganizes the entire survey. We are not looking for the domestic geography of a residential building. We are looking for the industrial geography still sitting underneath the finishes.

## What does a concrete building change about exclusion?
...
One further consequence is easy to miss. Because concrete does not rot the way frame construction does, water damage here shows up late and shows up somewhere else. A parapet or roof drain leaking into a heavy-timber bay wets yellow pine that holds moisture for months, and softened concealed timber behind masonry is what [carpenter ants](/pest-library/carpenter-ant/) excavate.

## What did the freight equipment leave behind?

Vertical shafts, doorways sized for vehicles and rail, and floorplates measured in acres. All three are still in the buildings.

The designation report is specific about how these places worked: ground-level vehicular entrances, wide segmental-arch loading docks, steam freight elevators, and building entries built for rail cars. The Jay Street Connecting Railroad, established in 1904, ran from the waterfront into the buildings themselves — into the Bliss foundry at 202-206 Plymouth Street, for one — and its track is still inset in the Belgian block on several streets.
...
Put those together and the reason unit-by-unit work fails here is not mysterious. Pressure applied in one flat moves a population along a plenum, down a shaft or across a core into the next one. Nothing has been resolved; something has been relocated, and the resident who reports it next is simply the one with the lower tolerance.
...
Fill behaves differently from undisturbed glacial ground in three ways that matter to a building. It settles, unevenly and over long periods, which opens joints in slabs, paving and buried drainage that were tight when they were laid. It drains differently, holding water in some places and moving it fast in others depending on what was tipped where a hundred and fifty years ago. And it sits at a level determined by whoever filled it, not by geology, which is why the ground floors along this waterfront are as close to mean water as they are.
...
It filled the below-grade level with seawater, and it demonstrated the exposure rather than creating it.
...
Set that against the city's own numbers. The hazard mitigation plan puts roughly 61,700 buildings and about 192,000 residential units, housing more than 440,000 residents, inside the one percent annual chance floodplain, and models 14,350 Brooklyn buildings as sustaining damage in such an event — around 23 percent of the borough's modeled damage. It identifies structures with basement and cellar spaces as particularly vulnerable, and projects sea level rising as much as 30 inches by the 2050s and up to 4.8 feet by the 2080s.

For pest work the consequences are practical rather than dramatic.

**A flooded cellar is a rebuilt cellar.** Every flood event is followed by drying, stripping, replacement of services and re-fitting, and each of those is a trade cutting new penetrations under time pressure. The openings created in the eighteen months after a flood are frequently the openings we find five years later.
...
**Front Street and Plymouth Street** hold the older brick and timber stock and some of the largest single floorplates, including the Bliss buildings at 135 and 202-206 Plymouth with rail track that once ran indoors. **Jay Street and York Street** run inland toward the subway and hold the 1909 and 1916 concrete buildings and the Grand Union warehouse at 68 Jay.

**Pearl Street and Adams Street** sit under and beside the Manhattan Bridge, whose Brooklyn anchorage and support pier stand inside the district and are, in the designation report's words, a major presence that strongly contributes to its sense of place. The bridge opened in 1909 and carries roughly 150,000 vehicles a day.

**Old Fulton Street and the Fulton Ferry edge** form the western boundary, where the district meets Brooklyn Heights at the foot of the bluff and where several basements filled in 2012. **Bridge Street** is the eastern edge against Vinegar Hill, and **Brooklyn Bridge Park** runs the northern boundary with its tidal margin.

Every market we cover appears on the [coverage list](/locations/), and the [New York City hub](/locations/nyc/) sets out how the five-borough work is structured. Directly uphill, [Brooklyn Heights](/locations/brooklyn-heights/) is the attached-rowhouse opposite of everything on this page; [Cobble Hill](/locations/cobble-hill/) is that same rowhouse fabric at its oldest and narrowest; [Park Slope](/locations/park-slope/) adds a drainage gradient to it; [Williamsburg](/locations/williamsburg/) is the other Brooklyn waterfront market where new towers stand beside old small buildings. In Manhattan, [Tribeca](/locations/tribeca/) and [SoHo](/locations/soho/) are the nearest relatives — nineteenth-century commercial fabric converted to housing — though neither sits on a tidal flood edge. For the contrast with detached houses, see the [Long Island hub](/locations/long-island/).

## What do the cobblestones do at street level?
...
What it does not do is close your building. A sealed container reduces the population the street can support; it has no view at all on whether the population that remains gets through your loading threshold, your shaft base or your cellar drain. Those are still building decisions, and they are still yours.

## What does a converted factory owe its residents?

The same duties as any other multiple dwelling, applied to a building that was not designed for any of them.

The Housing Maintenance Code places the duty to keep a dwelling free from rodents, insects and other pests on the owner and requires extermination where infestation is present — see [NYC Housing Maintenance Code — extermination and rodent eradication](/compliance/nyc-housing-maintenance-code-pests/). [Local Law 55 of 2018](/compliance/nyc-local-law-55/) adds a scheduled duty: investigate units and common areas at least annually and whenever a complaint arises, remediate by integrated pest management, seal openings so gaps are a quarter of an inch or less, and remove the water sources pests depend on — with the statute stating that pesticide application does not substitute for those measures.

Applied honestly in one of these buildings, the quarter-inch standard is a list of specific industrial details: the collar on every stack cut through a slab, the base and head of every shaft, the cast-in sleeves nobody packed, the door line between service space and occupied space, and the threshold under a door built for a truck. That is a real scope of works, and it is exactly the scope that ends the recurrence.

Owners of multiple dwellings, cooperatives and condominiums included, also file a bedbug annual report with HPD each December under Housing Maintenance Code sections 27-2018.1 and 27-2018.2, whether or not the building has had activity. Where a pesticide is applied, notice obligations follow — see [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/) and [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/), with the applicator side at [New York State pesticide applicator requirements](/compliance/nys-pesticide-applicator-requirements/). A board in a converted building should start with [co-op and condo board obligations](/compliance/coop-condo-board-obligations/). An owner letting a loft wants [landlord and tenant pest responsibilities](/compliance/landlord-tenant-pest-responsibilities/), and anyone weighing two bids against each other wants [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/).

## What goes into an opening in a concrete slab?

Something mechanically fixed, sized to the hole, and chosen for the substrate — which on this fabric is a narrower list than usual.

We do not use expanding foam, in any role. It is the industry's most common failure: rodents chew straight through cured foam, and in a cored slab or a cast-in sleeve it also reads to the next trade as though the penetration has been made good. Ordinary steel wool rusts. Sealant is a weather and smoke seal over a barrier and not a barrier itself.

What goes in instead is custom-fabricated 26-gauge galvanized sheet metal, cut and bent to the opening rather than trimmed off a stock piece; copper and stainless mesh where an annulus has to be packed; hardware cloth wherever an opening has to keep passing air; mortar and hydraulic cement at masonry and at concrete; Xcluder door sweeps and fill fabric at thresholds and around services; Xcluder GEO where a barrier has to sit below grade against burrowing; and mechanical fasteners throughout, because an adhesive bond on a dusty, damp, ninety-year-old slab is a guess about a surface nobody prepared.

The sequence is not negotiable either. Reduce the population already inside, correct the water, seal the routes, then verify. Sealing a building that still holds an active population takes away the animals' route out rather than their route in, and in a structure with acre-scale plenums and open shafts that is worse than the position you started from. Autumn is the window for the below-grade and threshold work, before cooling weather moves the street population indoors; roof and terrace work belongs to the warm months, when standing water is actually standing.

## Why the building comes first here

Graduate Pest Control has been reading buildings across the five boroughs and out through Nassau and Suffolk since 1983. Arnold Katz founded the firm and holds a B.S. in Entomology from the University of Georgia; his son [Ryan Katz](/ryan-katz/) runs it now, as a certified applicator in categories 7A, 7F and 8, and teaches rodent work and exclusion to professional bodies abroad as well as speaking in the United States. Rodent exclusion is the core of what this company does. The position behind all of it is that pest problems are building problems and they need permanent structural solutions.

Dumbo makes that argument better than almost anywhere we work, because the buildings were never pretending to be houses. A 1904 concrete factory does not have a crawlspace, a sill plate or a soffit return. It has a shaft, a slab, a sleeve, a loading dock and a cellar on filled marsh inside a coastal floodplain. Every one of those is a physical feature that can be found, understood and closed, and none of them responds to a schedule of visits.

For a straight account of where the routes run in your building — which shafts are still open, what the slab has been cored for, what the cellar is doing since the water — [get in touch](/contact/). The consultation is free and is usually a phone call, and most problems can be worked out that way. A written proposal and plan carries a service fee, since the documented plan is the thing being bought; that fee comes off the project if the work goes ahead. Starting from a pest instead? The [pest control index](/pest-control/) covers each service.
