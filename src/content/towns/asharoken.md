...
**[Wildlife management](/pest-control/wildlife-management/)** covers the roofline work at the wooded north end and along the bay shore, scheduled around dependent young. The animal itself is taken out by a licensed nuisance wildlife operator Graduate brings in, and closing the building follows within the same job.
...
**Most of what tunnels into low, damp timber on the spit is a carpenter ant.** The grade line here moves without anyone touching a shovel: blown sand and winter storm wash push soil up a foundation faster than owners take it back down, so wet wood near the ground is ordinary rather than exceptional. A winged insect on a salt-stripped sill in April is far more often a carpenter ant than the other thing, and that half of the problem is [ant control](/pest-control/ant-control/) plus the trim-joint correction described above. The [eastern subterranean termite](/pest-library/eastern-subterranean-termite/) profile is there to settle the identification before anyone spends money. If the sill turns out to hold termites instead, Graduate still manages it, confirming the species, digging the storm-washed sand back off the foundation and writing the plan, with the treatment itself handed to a licensed termite operator brought in for that step.
