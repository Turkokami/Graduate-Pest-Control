...
metaDescription: >-
  ...
  pathways run inside shared party walls.
faqs:
  - question: How old is the housing stock in Brooklyn Heights, really?
    answer: >-
  ...
  - question: My neighbor treated their house and now I have mice. Why?
    answer: >-
      ...
      construction, so the wall contains a horizontal void linking the two buildings at every floor.
      Pressure applied on one side moves the population to the other.
  - question: Why does brownstone keep failing on these houses?
    answer: >-
      Because of how the veneer was set. The Landmarks Preservation Commission's rowhouse manual
      explains that stone was commonly laid with its grain running vertically, so water entering
      between the bedding layers freezes and forces the layers apart. That spalling exposes fresh
      surface to the next freeze, and the wall behind it starts holding water instead of shedding it.
  - question: Does the historic district designation limit what exclusion work you can do?
    answer: >-
      It shapes it rather than blocks it. Brooklyn Heights was designated New York City's first
  ...
  - question: Our house was converted into four apartments. Does that change our obligations?
    answer: >-
      Materially, yes. A building arranged for three or more independent households is generally a
      multiple dwelling, which brings in the Housing Maintenance Code duty to keep it free of pests,
      the Local Law 55 annual investigation and integrated pest management requirements, and the
      December bedbug annual report filing with HPD.
...
sources:
  - name: Brooklyn Heights Historic District — New York Landmarks Conservancy
    url: https://architecturaltrust.org/easements/about-the-trust/trust-protected-communities/historic-districts-in-new-york/brooklyn-heights-historic-district/
  - name: Brooklyn Heights Association — Neighborhood
    url: https://thebha.org/neighborhood/
...
## What makes pest work in Brooklyn Heights different from anywhere else?
...
## What does a shared party wall actually do to a pest problem?
...
**Cooperation between adjoining owners is worth more than any product.** Two houses that seal their shared wall and coordinate their waste storage will outperform two houses that each buy a better service independently. On a block where several buildings do it, the difference is visible within a season.
...
In the order this housing stock generates them.

**[Rodent control](/pest-control/rodent-control/)** comes first and divides in two. [Norway rats](/pest-library/norway-rat/) work the block interiors, the areaways, the waste storage and the older cellar drainage; the city Health Department is direct about the driver, noting that exposed garbage attracts rats and that owners are legally required to keep them out of buildings. [House mice](/pest-library/house-mouse/) work the party walls and the interior voids, and they are the reason a scrupulously clean house on a quiet street still gets them.
...
**Montague Street** is the commercial spine, with retail and food service at ground level under residential floors — the classic mixed-use arrangement in which a residential rodent complaint frequently has a commercial source.

**Remsen, Joralemon and Grace Court** run toward the southern and eastern edges, generally larger and later houses with deeper plans.
...
**Most exclusion work is invisible from the street anyway.** The cellar, the areaway floor and drain, the rear elevation, the party-wall pockets, the service penetrations, the roof bulkhead and the interior of a cornice return are not the protected streetscape in any meaningful sense. The overwhelming majority of a scope of works on a house like this sits in those places.
...
**Waste storage is the lever.** Hard-sided, close-fitting, rat-resistant containers at every property on the block interior will do more than any treatment. This is a collective problem, and on blocks where a residents' association takes it on, results follow.

**Your building work is still worth doing.** Sealing the cellar line, closing the service penetrations, repairing the areaway drain and fixing broken drainage is what determines whether the animals in the block interior get inside your house. You cannot control the block. You can control whether it comes indoors.

## What changes when a rowhouse holds several apartments?

The legal position changes, and so does the sensible scope of work.

A building arranged for occupancy by three or more independent households is generally a multiple dwelling, and that classification carries obligations that a single-family house does not. The Housing Maintenance Code places the duty to keep a dwelling free from rodents, insects and other pests on the owner, and requires extermination where infestation is present — the detail is at [NYC Housing Maintenance Code — extermination and rodent eradication](/compliance/nyc-housing-maintenance-code-pests/).

[Local Law 55 of 2018](/compliance/nyc-local-law-55/), the Asthma Free Housing Act, adds a scheduled duty on top of the reactive one. Owners must investigate dwelling units and common areas at least annually and whenever a complaint arises, and must remediate using integrated pest management: removing nests and debris physically, sealing openings so gaps are a quarter inch or less, and eliminating the water sources pests depend on. The law is explicit that pesticide application does not substitute for those measures. In a converted rowhouse that provision is unusually well aimed, because a quarter-inch standard applied honestly means closing the very penetrations that carry the traffic.

There is also an annual filing. Owners of multiple dwellings, co-ops and condominiums included, file a bedbug annual report with HPD each December under Housing Maintenance Code sections 27-2018.1 and 27-2018.2, covering the number of units, the number infested, the number where eradication occurred and the number reinfested, and then either give the filing receipt to occupants at lease commencement or renewal or post it prominently.

Where pesticides are applied in a multiple dwelling, notification rules apply — see [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/) and [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/). Boards should read [co-op and condo board obligations](/compliance/coop-condo-board-obligations/); owners letting units should read [landlord and tenant pest responsibilities](/compliance/landlord-tenant-pest-responsibilities/); anyone comparing bids should read [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/).

## When should the work be done through the year?

Evidence dictates urgency, but the calendar changes what is possible and what a result costs.

**Late summer to late autumn** is the rodent window. Cooling weather moves rats and mice toward buildings, and a cellar sealed in September never acquires the winter population in the first place. It is also the best time to survey block interiors, because the planting has grown enough to show which parts of it are actually being used and the ground is still workable.

**Winter** brings insects indoors and makes them findable. It is also the season when a building's heat loss reveals its openings — a cold morning shows you where warm air is escaping, and those points are frequently the same ones the animals are using.

**Spring** is the masonry season. A winter of freeze-thaw cycling leaves its record on brownstone fronts, parapets, sills and cornices, and that is the moment to correct spalling, repoint open joints and repair the flashing and cornice details that are wetting concealed timber. Doing it now removes the condition before the summer insect season exploits it.

**Summer** is for exterior and garden work: regrading a rear yard that now falls toward the house, clearing and repairing areaway drains, rebuilding waste storage, and reducing standing water in planters, roof drains and covers for [mosquito](/pest-control/mosquito-management/) control.
