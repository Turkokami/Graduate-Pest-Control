...
metaDescription: >-
  SoHo pest control for cast-iron loft buildings, vaulted sidewalks and retail-over-residential
  stacks, surveyed as one structure rather than unit by unit.
faqs:
  ...
  - question: Is the cast iron on my building structural or just a front?
    answer: >-
      ...
      rather than the frame. The E. V. Haughwout Building of 1857 at Broadway and Broome is the
      well-known exception, where the cast iron carries load. Either way, the visible face and the
      wall behind it are separate assemblies with a joint between them.
  - question: Why does a restaurant downstairs become my problem four floors up?
    answer: >-
      Because you are on the same building services. These were store-and-loft structures with
      commerce at street level, and conversion kept that arrangement while adding apartments above.
      Drainage, risers and shaft walls connect the two. A German cockroach population fed at ground
      level travels the stack, so the survey has to start at the tenancy, not at the complaint.
  - question: Does the historic district restrict what you can seal?
    answer: >-
      It governs the visible exterior. The SoHo-Cast Iron Historic District was designated in 1973
      across 26 blocks and about 500 buildings, with an extension of roughly 135 properties in May
      2010, and the Landmarks Preservation Commission reviews exterior repairs. Vault interiors,
      cellars, shaft walls, roof bulkheads and rear elevations are where most of the work sits.
  - question: Our loft was one open floor. Why does that matter for mice?
    answer: >-
      Because the partitions that made rooms out of it were added on top of the structure rather than
      into it. Loft floorplates were single undivided spaces, and later walls frequently stop at a
      dropped ceiling. Combine that with the original goods shafts running the full height of the
      building and an interior population is not confined to a floor or to a unit.
  - question: Did the 2021 SoHo rezoning change anything for building owners?
    answer: >-
      It changed what the buildings are allowed to be. The City Council replaced the M1-5A and M1-5B
      manufacturing districts across 56 blocks with paired manufacturing-residential districts and a
      Special SoHo-NoHo Mixed Use District, permitting residential, commercial, community facility
      and manufacturing uses as of right. More conversion means more retrofitted plumbing runs.
  - question: Why are the cockroaches in our cellar different from the ones upstairs?
    answer: >-
...
neighborhoods:
  ...
  - Howard Street
sources:
  - name: SoHo-Cast Iron Historic District Extension Designation Report — NYC LPC
    url: https://s-media.nyc.gov/agencies/lpc/lp/2362.pdf
  - name: SoHo Broadway Initiative — the vaulted sidewalks of SoHo Broadway
    url: https://sohobroadway.org/let-there-be-light-the-vaulted-sidewalks-of-soho-broadway/
  ...
  - name: Cornell — StopPests in Housing, IPM in multifamily housing
    url: https://news.cornell.edu/stories/2018/02/national-program-stops-pests-public-housing
...
## What is a cast-iron front actually doing, and why does the answer change the work?
...
The other consequence is procedural. When we specify sealing on a landmarked cast-iron elevation, we are working across two assemblies, not one, and the material has to be reversible and set back rather than applied across the face.
...
It puts them on the same building. That sounds obvious and is routinely forgotten when a complaint is logged from an apartment.
...
In the order the fabric produces them.

**[Rodent control](/pest-control/rodent-control/)** first. [Norway rats](/pest-library/norway-rat/) work the vault line, the service entries and the commercial waste of a major retail district; [house mice](/pest-library/house-mouse/) work the shafts, the floor cavities and the partitions that stop short of the structure.
...
**[Wildlife management](/pest-control/wildlife-management/)** is roof-level work here — parapets, bulkheads and mechanical enclosures — with the animal cleared by a licensed wildlife partner and the sealing carried out by us.

Managed buildings and boards sit under [co-op and condo pest control](/commercial/coop-condo-pest-control/); agents running multiple SoHo buildings under [property management pest control](/commercial/property-management-pest-control/).

## Which parts of SoHo do we work in?
...
**Wooster Street** and **West Broadway** run the western side; the 2010 extension took in properties on the west side of West Broadway, some running through to Thompson Street, so a single building there can have two entirely different elevations under two different conditions.

**Crosby Street**, **Lafayette Street**, **Howard Street** and **Centre Street** form the eastern side and the second half of the 2010 extension. Crosby in particular is a service street by history — loading and back-of-house rather than shopfront — which changes where the thresholds are.

**Prince Street**, **Spring Street** and **Grand Street** are the cross streets that carry most of the food service, and therefore most of the retail-over-residential stack problems.
...
It changed what these buildings are permitted to become, which over time changes how much new plumbing gets cut through them.

The City Council adopted the SoHo/NoHo plan in December 2021. It covers a 56-block area and replaces the M1-5A and M1-5B manufacturing districts — zoning that had precluded ordinary residential use and severely restricted ground-floor uses, with housing limited to joint live-work arrangements for certified artists — with six paired manufacturing-residential districts and a Special SoHo-NoHo Mixed Use District. Residential, commercial, community facility and manufacturing uses are now permitted as of right, and Mandatory Inclusionary Housing applies to most new residential development, enlargement and conversion.

The pest-relevant consequence is simple and gradual. Conversion means bathrooms and kitchens where there were none, which means new soil and supply stacks cut through nineteenth-century floor structures. Every retrofitted riser is a vertical chase with a penetration at each floor, and every penetration is either sealed properly at the time or becomes a permanent route. Buildings that are being reconfigured now are the ones where sealing is cheap, because the work happens while the ceilings are open.

There is a related legal point about the buildings that converted earlier. Under Article 7-C of the Multiple Dwelling Law a qualifying loft unit must be at least 400 square feet and cannot be in a cellar — which is precisely why the cellar and vault level of these buildings remains service space that nobody lives in and, too often, nobody inspects.

Once a building is a multiple dwelling, residential duties attach. The Housing Maintenance Code puts the obligation to keep the premises free of pests on the owner, set out at [NYC Housing Maintenance Code — extermination and rodent eradication](/compliance/nyc-housing-maintenance-code-pests/). [Local Law 55 of 2018](/compliance/nyc-local-law-55/) requires an investigation for indoor allergen hazards at least annually and more often if necessary, remediation by integrated pest management, sealing of holes, gaps and cracks with durable materials, and door sweeps bringing gaps to no more than a quarter of an inch — and it states that pesticide use does not substitute for those measures. Owners of multiple dwellings, cooperatives and condominiums included, also file a bedbug annual report with HPD each December and either give the receipt to occupants or post it prominently.

Where pesticides are applied, notification rules follow: [Local Law 36 pesticide notification](/compliance/nyc-local-law-36-pesticide-notification/) and [the New York neighbor notification law](/compliance/ny-neighbor-notification-law/). Boards should read [co-op and condo board obligations](/compliance/coop-condo-board-obligations/), landlords [landlord and tenant pest responsibilities](/compliance/landlord-tenant-pest-responsibilities/), and anyone comparing proposals [choosing a pest control contractor](/compliance/choosing-a-pest-control-contractor/).

## What materials are acceptable on a landmarked cast-iron building?
...
**Do the concealed work first, because it needs no review.** Vault interiors, cellar walls, shaft bases, floor collars, roof bulkheads and rear elevations carry the overwhelming majority of the traffic and almost none of the protected character.
...
The survey covers the whole vertical section: vault, cellar, ground-floor tenancy back-of-house, every residential floor on the affected stack, the roof bulkhead and the shaft from top to bottom. It records where the retrofitted plumbing passes through structure, where partitions stop short of the slab or timber above, where the vault meets the occupied cellar, and where the waste is actually stored rather than where the house rules say it is stored.

Monitoring comes next, because in a building of this type nobody can tell you where the population lives by looking. Passive monitors placed on a plan — chute and refuse areas, tenancy prep and dishwash, riser closets, shaft bases, vault access, and inside the units on the line rather than only the one that complained — turn an argument into a map within a couple of weeks. Cornell's work with multifamily housing makes the case for this bluntly: prevention and non-chemical control do the work that monthly spraying is expected to do and does not.
...
Graduate Pest Control has been working on New York buildings since 1983, in all five boroughs and outward through Nassau and Suffolk. Arnold Katz started the firm after reading entomology at the University of Georgia; his son [Ryan Katz](/ryan-katz/) leads it today. The whole approach fits in one line of his: we treat every job as a building problem, not a pest problem.

SoHo makes that easy to demonstrate and hard to argue with. A block here is a run of iron-fronted factories over a shared void, with shops at the bottom, apartments at the top, and a hundred and seventy years of alterations in between. Nothing about it was designed for the way it is used now, and the animals in it are simply using the original design. Find the vault, find the shaft, find the stack, and the rest follows.

For a clear read on where your own building's routes run, [get in touch](/contact/). If a specific pest is the reason you are here, the [pest control index](/pest-control/) covers each service in turn.
